...
//go:generate mockgen -source client.go --aux_files=github.com/yuminekosan/go-tdlib=auth.go,github.com/yuminekosan/go-tdlib=events.go,github.com/yuminekosan/go-tdlib=tl_methods.go -destination=./mocks/client.go
