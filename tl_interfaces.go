...
const (
	...
	AuthenticationCodeTypeSmsWordType         AuthenticationCodeTypeEnum = "authenticationCodeTypeSmsWord"
	AuthenticationCodeTypeSmsPhraseType       AuthenticationCodeTypeEnum = "authenticationCodeTypeSmsPhrase"
	...
	AuthenticationCodeTypeFragmentType        AuthenticationCodeTypeEnum = "authenticationCodeTypeFragment"
	AuthenticationCodeTypeFirebaseAndroidType AuthenticationCodeTypeEnum = "authenticationCodeTypeFirebaseAndroid"
	AuthenticationCodeTypeFirebaseIosType     AuthenticationCodeTypeEnum = "authenticationCodeTypeFirebaseIos"
)
...
func unmarshalAuthenticationCodeType(rawMsg *json.RawMessage) (AuthenticationCodeType, error) {
	...
	case AuthenticationCodeTypeSmsWordType:
		var authenticationCodeTypeSmsWord AuthenticationCodeTypeSmsWord
		err := json.Unmarshal(*rawMsg, &authenticationCodeTypeSmsWord)
		return &authenticationCodeTypeSmsWord, err

	case AuthenticationCodeTypeSmsPhraseType:
		var authenticationCodeTypeSmsPhrase AuthenticationCodeTypeSmsPhrase
		err := json.Unmarshal(*rawMsg, &authenticationCodeTypeSmsPhrase)
		return &authenticationCodeTypeSmsPhrase, err
	...
	case AuthenticationCodeTypeFragmentType:
		var authenticationCodeTypeFragment AuthenticationCodeTypeFragment
		err := json.Unmarshal(*rawMsg, &authenticationCodeTypeFragment)
		return &authenticationCodeTypeFragment, err

	case AuthenticationCodeTypeFirebaseAndroidType:
		var authenticationCodeTypeFirebaseAndroid AuthenticationCodeTypeFirebaseAndroid
		err := json.Unmarshal(*rawMsg, &authenticationCodeTypeFirebaseAndroid)
		return &authenticationCodeTypeFirebaseAndroid, err

	case AuthenticationCodeTypeFirebaseIosType:
		var authenticationCodeTypeFirebaseIos AuthenticationCodeTypeFirebaseIos
		err := json.Unmarshal(*rawMsg, &authenticationCodeTypeFirebaseIos)
		return &authenticationCodeTypeFirebaseIos, err
...
func unmarshalAuthenticationCodeTypeSlice(rawMsg *json.RawMessage) ([]AuthenticationCodeType, error) {
	...
	for _, objMap := range objsMap {
		...
		case AuthenticationCodeTypeSmsWordType:
			...
			err = json.Unmarshal(obj, &authenticationCodeTypeSmsWord)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authenticationCodeTypeSmsWord)
		case AuthenticationCodeTypeSmsPhraseType:
			var authenticationCodeTypeSmsPhrase AuthenticationCodeTypeSmsPhrase
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &authenticationCodeTypeSmsPhrase)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authenticationCodeTypeSmsPhrase)
		case AuthenticationCodeTypeCallType:
			var authenticationCodeTypeCall AuthenticationCodeTypeCall
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case AuthenticationCodeTypeFragmentType:
			...
			err = json.Unmarshal(obj, &authenticationCodeTypeFragment)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authenticationCodeTypeFragment)
		case AuthenticationCodeTypeFirebaseAndroidType:
			var authenticationCodeTypeFirebaseAndroid AuthenticationCodeTypeFirebaseAndroid
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &authenticationCodeTypeFirebaseAndroid)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authenticationCodeTypeFirebaseAndroid)
		case AuthenticationCodeTypeFirebaseIosType:
			var authenticationCodeTypeFirebaseIos AuthenticationCodeTypeFirebaseIos
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &authenticationCodeTypeFirebaseIos)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authenticationCodeTypeFirebaseIos)
...
type EmailAddressAuthentication interface {
	GetEmailAddressAuthenticationEnum() EmailAddressAuthenticationEnum
}

// EmailAddressAuthenticationEnum Alias for abstract EmailAddressAuthentication 'Sub-Classes', used as constant-enum here
type EmailAddressAuthenticationEnum string

// EmailAddressAuthentication enums
const (
	EmailAddressAuthenticationCodeType     EmailAddressAuthenticationEnum = "emailAddressAuthenticationCode"
	EmailAddressAuthenticationAppleIDType  EmailAddressAuthenticationEnum = "emailAddressAuthenticationAppleId"
	EmailAddressAuthenticationGoogleIDType EmailAddressAuthenticationEnum = "emailAddressAuthenticationGoogleId"
)

func unmarshalEmailAddressAuthentication(rawMsg *json.RawMessage) (EmailAddressAuthentication, error) {
	...
	switch EmailAddressAuthenticationEnum(objMap["@type"].(string)) {
	case EmailAddressAuthenticationCodeType:
		var emailAddressAuthenticationCode EmailAddressAuthenticationCode
		err := json.Unmarshal(*rawMsg, &emailAddressAuthenticationCode)
		return &emailAddressAuthenticationCode, err

	case EmailAddressAuthenticationAppleIDType:
		var emailAddressAuthenticationAppleID EmailAddressAuthenticationAppleID
		err := json.Unmarshal(*rawMsg, &emailAddressAuthenticationAppleID)
		return &emailAddressAuthenticationAppleID, err

	case EmailAddressAuthenticationGoogleIDType:
		var emailAddressAuthenticationGoogleID EmailAddressAuthenticationGoogleID
		err := json.Unmarshal(*rawMsg, &emailAddressAuthenticationGoogleID)
		return &emailAddressAuthenticationGoogleID, err
...
func unmarshalEmailAddressAuthenticationSlice(rawMsg *json.RawMessage) ([]EmailAddressAuthentication, error) {
	objects := make([]EmailAddressAuthentication, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case EmailAddressAuthenticationCodeType:
			...
			err = json.Unmarshal(obj, &emailAddressAuthenticationCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emailAddressAuthenticationCode)
		case EmailAddressAuthenticationAppleIDType:
			var emailAddressAuthenticationAppleID EmailAddressAuthenticationAppleID
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emailAddressAuthenticationAppleID)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emailAddressAuthenticationAppleID)
		case EmailAddressAuthenticationGoogleIDType:
			var emailAddressAuthenticationGoogleID EmailAddressAuthenticationGoogleID
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emailAddressAuthenticationGoogleID)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emailAddressAuthenticationGoogleID)
...
type EmailAddressResetState interface {
	GetEmailAddressResetStateEnum() EmailAddressResetStateEnum
}

// EmailAddressResetStateEnum Alias for abstract EmailAddressResetState 'Sub-Classes', used as constant-enum here
type EmailAddressResetStateEnum string

// EmailAddressResetState enums
const (
	EmailAddressResetStateAvailableType EmailAddressResetStateEnum = "emailAddressResetStateAvailable"
	EmailAddressResetStatePendingType   EmailAddressResetStateEnum = "emailAddressResetStatePending"
)

func unmarshalEmailAddressResetState(rawMsg *json.RawMessage) (EmailAddressResetState, error) {
	...
	switch EmailAddressResetStateEnum(objMap["@type"].(string)) {
	case EmailAddressResetStateAvailableType:
		var emailAddressResetStateAvailable EmailAddressResetStateAvailable
		err := json.Unmarshal(*rawMsg, &emailAddressResetStateAvailable)
		return &emailAddressResetStateAvailable, err

	case EmailAddressResetStatePendingType:
		var emailAddressResetStatePending EmailAddressResetStatePending
		err := json.Unmarshal(*rawMsg, &emailAddressResetStatePending)
		return &emailAddressResetStatePending, err
...
func unmarshalEmailAddressResetStateSlice(rawMsg *json.RawMessage) ([]EmailAddressResetState, error) {
	objects := make([]EmailAddressResetState, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case EmailAddressResetStateAvailableType:
			...
			err = json.Unmarshal(obj, &emailAddressResetStateAvailable)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emailAddressResetStateAvailable)
		case EmailAddressResetStatePendingType:
			var emailAddressResetStatePending EmailAddressResetStatePending
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emailAddressResetStatePending)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emailAddressResetStatePending)
...
const (
	...
	AuthorizationStateWaitEmailAddressType            AuthorizationStateEnum = "authorizationStateWaitEmailAddress"
	AuthorizationStateWaitEmailCodeType               AuthorizationStateEnum = "authorizationStateWaitEmailCode"
...
func unmarshalAuthorizationState(rawMsg *json.RawMessage) (AuthorizationState, error) {
	...
	case AuthorizationStateWaitEmailAddressType:
		var authorizationStateWaitEmailAddress AuthorizationStateWaitEmailAddress
		err := json.Unmarshal(*rawMsg, &authorizationStateWaitEmailAddress)
		return &authorizationStateWaitEmailAddress, err

	case AuthorizationStateWaitEmailCodeType:
		var authorizationStateWaitEmailCode AuthorizationStateWaitEmailCode
		err := json.Unmarshal(*rawMsg, &authorizationStateWaitEmailCode)
		return &authorizationStateWaitEmailCode, err
...
func unmarshalAuthorizationStateSlice(rawMsg *json.RawMessage) ([]AuthorizationState, error) {
	...
	for _, objMap := range objsMap {
		...
		case AuthorizationStateWaitEmailAddressType:
			...
			err = json.Unmarshal(obj, &authorizationStateWaitEmailAddress)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authorizationStateWaitEmailAddress)
		case AuthorizationStateWaitEmailCodeType:
			var authorizationStateWaitEmailCode AuthorizationStateWaitEmailCode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &authorizationStateWaitEmailCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &authorizationStateWaitEmailCode)
		case AuthorizationStateWaitCodeType:
			var authorizationStateWaitCode AuthorizationStateWaitCode
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type FirebaseDeviceVerificationParameters interface {
	GetFirebaseDeviceVerificationParametersEnum() FirebaseDeviceVerificationParametersEnum
}

// FirebaseDeviceVerificationParametersEnum Alias for abstract FirebaseDeviceVerificationParameters 'Sub-Classes', used as constant-enum here
type FirebaseDeviceVerificationParametersEnum string

// FirebaseDeviceVerificationParameters enums
const (
	FirebaseDeviceVerificationParametersSafetyNetType     FirebaseDeviceVerificationParametersEnum = "firebaseDeviceVerificationParametersSafetyNet"
	FirebaseDeviceVerificationParametersPlayIntegrityType FirebaseDeviceVerificationParametersEnum = "firebaseDeviceVerificationParametersPlayIntegrity"
)

func unmarshalFirebaseDeviceVerificationParameters(rawMsg *json.RawMessage) (FirebaseDeviceVerificationParameters, error) {
	...
	switch FirebaseDeviceVerificationParametersEnum(objMap["@type"].(string)) {
	case FirebaseDeviceVerificationParametersSafetyNetType:
		var firebaseDeviceVerificationParametersSafetyNet FirebaseDeviceVerificationParametersSafetyNet
		err := json.Unmarshal(*rawMsg, &firebaseDeviceVerificationParametersSafetyNet)
		return &firebaseDeviceVerificationParametersSafetyNet, err

	case FirebaseDeviceVerificationParametersPlayIntegrityType:
		var firebaseDeviceVerificationParametersPlayIntegrity FirebaseDeviceVerificationParametersPlayIntegrity
		err := json.Unmarshal(*rawMsg, &firebaseDeviceVerificationParametersPlayIntegrity)
		return &firebaseDeviceVerificationParametersPlayIntegrity, err
...
func unmarshalFirebaseDeviceVerificationParametersSlice(rawMsg *json.RawMessage) ([]FirebaseDeviceVerificationParameters, error) {
	objects := make([]FirebaseDeviceVerificationParameters, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case FirebaseDeviceVerificationParametersSafetyNetType:
			...
			err = json.Unmarshal(obj, &firebaseDeviceVerificationParametersSafetyNet)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &firebaseDeviceVerificationParametersSafetyNet)
		case FirebaseDeviceVerificationParametersPlayIntegrityType:
			var firebaseDeviceVerificationParametersPlayIntegrity FirebaseDeviceVerificationParametersPlayIntegrity
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &firebaseDeviceVerificationParametersPlayIntegrity)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &firebaseDeviceVerificationParametersPlayIntegrity)
...
const (
	...
	ThumbnailFormatWebmType  ThumbnailFormatEnum = "thumbnailFormatWebm"
...
func unmarshalThumbnailFormat(rawMsg *json.RawMessage) (ThumbnailFormat, error) {
	...
	case ThumbnailFormatWebmType:
		var thumbnailFormatWebm ThumbnailFormatWebm
		err := json.Unmarshal(*rawMsg, &thumbnailFormatWebm)
		return &thumbnailFormatWebm, err
...
func unmarshalThumbnailFormatSlice(rawMsg *json.RawMessage) ([]ThumbnailFormat, error) {
	...
	for _, objMap := range objsMap {
		...
		case ThumbnailFormatWebmType:
			...
			err = json.Unmarshal(obj, &thumbnailFormatWebm)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &thumbnailFormatWebm)
		case ThumbnailFormatWebpType:
			var thumbnailFormatWebp ThumbnailFormatWebp
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type StickerFormat interface {
	GetStickerFormatEnum() StickerFormatEnum
}

// StickerFormatEnum Alias for abstract StickerFormat 'Sub-Classes', used as constant-enum here
type StickerFormatEnum string

// StickerFormat enums
const (
	StickerFormatWebpType StickerFormatEnum = "stickerFormatWebp"
	StickerFormatTgsType  StickerFormatEnum = "stickerFormatTgs"
	StickerFormatWebmType StickerFormatEnum = "stickerFormatWebm"
)

func unmarshalStickerFormat(rawMsg *json.RawMessage) (StickerFormat, error) {
	...
	switch StickerFormatEnum(objMap["@type"].(string)) {
	case StickerFormatWebpType:
		var stickerFormatWebp StickerFormatWebp
		err := json.Unmarshal(*rawMsg, &stickerFormatWebp)
		return &stickerFormatWebp, err

	case StickerFormatTgsType:
		var stickerFormatTgs StickerFormatTgs
		err := json.Unmarshal(*rawMsg, &stickerFormatTgs)
		return &stickerFormatTgs, err

	case StickerFormatWebmType:
		var stickerFormatWebm StickerFormatWebm
		err := json.Unmarshal(*rawMsg, &stickerFormatWebm)
		return &stickerFormatWebm, err
...
func unmarshalStickerFormatSlice(rawMsg *json.RawMessage) ([]StickerFormat, error) {
	objects := make([]StickerFormat, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StickerFormatWebpType:
			...
			err = json.Unmarshal(obj, &stickerFormatWebp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFormatWebp)
		case StickerFormatTgsType:
			var stickerFormatTgs StickerFormatTgs
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerFormatTgs)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFormatTgs)
		case StickerFormatWebmType:
			var stickerFormatWebm StickerFormatWebm
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerFormatWebm)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFormatWebm)
...
type StickerType interface {
	GetStickerTypeEnum() StickerTypeEnum
}

// StickerTypeEnum Alias for abstract StickerType 'Sub-Classes', used as constant-enum here
type StickerTypeEnum string

// StickerType enums
const (
	StickerTypeRegularType     StickerTypeEnum = "stickerTypeRegular"
	StickerTypeMaskType        StickerTypeEnum = "stickerTypeMask"
	StickerTypeCustomEmojiType StickerTypeEnum = "stickerTypeCustomEmoji"
)

func unmarshalStickerType(rawMsg *json.RawMessage) (StickerType, error) {
	...
	switch StickerTypeEnum(objMap["@type"].(string)) {
	case StickerTypeRegularType:
		var stickerTypeRegular StickerTypeRegular
		err := json.Unmarshal(*rawMsg, &stickerTypeRegular)
		return &stickerTypeRegular, err

	case StickerTypeMaskType:
		var stickerTypeMask StickerTypeMask
		err := json.Unmarshal(*rawMsg, &stickerTypeMask)
		return &stickerTypeMask, err

	case StickerTypeCustomEmojiType:
		var stickerTypeCustomEmoji StickerTypeCustomEmoji
		err := json.Unmarshal(*rawMsg, &stickerTypeCustomEmoji)
		return &stickerTypeCustomEmoji, err
...
func unmarshalStickerTypeSlice(rawMsg *json.RawMessage) ([]StickerType, error) {
	objects := make([]StickerType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StickerTypeRegularType:
			...
			err = json.Unmarshal(obj, &stickerTypeRegular)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerTypeRegular)
		case StickerTypeMaskType:
			var stickerTypeMask StickerTypeMask
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerTypeMask)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerTypeMask)
		case StickerTypeCustomEmojiType:
			var stickerTypeCustomEmoji StickerTypeCustomEmoji
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerTypeCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerTypeCustomEmoji)
...
type StickerFullType interface {
	GetStickerFullTypeEnum() StickerFullTypeEnum
}

// StickerFullTypeEnum Alias for abstract StickerFullType 'Sub-Classes', used as constant-enum here
type StickerFullTypeEnum string

// StickerFullType enums
const (
	StickerFullTypeRegularType     StickerFullTypeEnum = "stickerFullTypeRegular"
	StickerFullTypeMaskType        StickerFullTypeEnum = "stickerFullTypeMask"
	StickerFullTypeCustomEmojiType StickerFullTypeEnum = "stickerFullTypeCustomEmoji"
)

func unmarshalStickerFullType(rawMsg *json.RawMessage) (StickerFullType, error) {
	...
	switch StickerFullTypeEnum(objMap["@type"].(string)) {
	case StickerFullTypeRegularType:
		var stickerFullTypeRegular StickerFullTypeRegular
		err := json.Unmarshal(*rawMsg, &stickerFullTypeRegular)
		return &stickerFullTypeRegular, err

	case StickerFullTypeMaskType:
		var stickerFullTypeMask StickerFullTypeMask
		err := json.Unmarshal(*rawMsg, &stickerFullTypeMask)
		return &stickerFullTypeMask, err

	case StickerFullTypeCustomEmojiType:
		var stickerFullTypeCustomEmoji StickerFullTypeCustomEmoji
		err := json.Unmarshal(*rawMsg, &stickerFullTypeCustomEmoji)
		return &stickerFullTypeCustomEmoji, err
...
func unmarshalStickerFullTypeSlice(rawMsg *json.RawMessage) ([]StickerFullType, error) {
	objects := make([]StickerFullType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StickerFullTypeRegularType:
			...
			err = json.Unmarshal(obj, &stickerFullTypeRegular)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFullTypeRegular)
		case StickerFullTypeMaskType:
			var stickerFullTypeMask StickerFullTypeMask
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerFullTypeMask)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFullTypeMask)
		case StickerFullTypeCustomEmojiType:
			var stickerFullTypeCustomEmoji StickerFullTypeCustomEmoji
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &stickerFullTypeCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &stickerFullTypeCustomEmoji)
...
type BusinessAwayMessageSchedule interface {
	GetBusinessAwayMessageScheduleEnum() BusinessAwayMessageScheduleEnum
}

// BusinessAwayMessageScheduleEnum Alias for abstract BusinessAwayMessageSchedule 'Sub-Classes', used as constant-enum here
type BusinessAwayMessageScheduleEnum string

// BusinessAwayMessageSchedule enums
const (
	BusinessAwayMessageScheduleAlwaysType                BusinessAwayMessageScheduleEnum = "businessAwayMessageScheduleAlways"
	BusinessAwayMessageScheduleOutsideOfOpeningHoursType BusinessAwayMessageScheduleEnum = "businessAwayMessageScheduleOutsideOfOpeningHours"
	BusinessAwayMessageScheduleCustomType                BusinessAwayMessageScheduleEnum = "businessAwayMessageScheduleCustom"
)

func unmarshalBusinessAwayMessageSchedule(rawMsg *json.RawMessage) (BusinessAwayMessageSchedule, error) {
	...
	switch BusinessAwayMessageScheduleEnum(objMap["@type"].(string)) {
	case BusinessAwayMessageScheduleAlwaysType:
		var businessAwayMessageScheduleAlways BusinessAwayMessageScheduleAlways
		err := json.Unmarshal(*rawMsg, &businessAwayMessageScheduleAlways)
		return &businessAwayMessageScheduleAlways, err

	case BusinessAwayMessageScheduleOutsideOfOpeningHoursType:
		var businessAwayMessageScheduleOutsideOfOpeningHours BusinessAwayMessageScheduleOutsideOfOpeningHours
		err := json.Unmarshal(*rawMsg, &businessAwayMessageScheduleOutsideOfOpeningHours)
		return &businessAwayMessageScheduleOutsideOfOpeningHours, err

	case BusinessAwayMessageScheduleCustomType:
		var businessAwayMessageScheduleCustom BusinessAwayMessageScheduleCustom
		err := json.Unmarshal(*rawMsg, &businessAwayMessageScheduleCustom)
		return &businessAwayMessageScheduleCustom, err
...
func unmarshalBusinessAwayMessageScheduleSlice(rawMsg *json.RawMessage) ([]BusinessAwayMessageSchedule, error) {
	objects := make([]BusinessAwayMessageSchedule, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case BusinessAwayMessageScheduleAlwaysType:
			...
			err = json.Unmarshal(obj, &businessAwayMessageScheduleAlways)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessAwayMessageScheduleAlways)
		case BusinessAwayMessageScheduleOutsideOfOpeningHoursType:
			var businessAwayMessageScheduleOutsideOfOpeningHours BusinessAwayMessageScheduleOutsideOfOpeningHours
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessAwayMessageScheduleOutsideOfOpeningHours)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessAwayMessageScheduleOutsideOfOpeningHours)
		case BusinessAwayMessageScheduleCustomType:
			var businessAwayMessageScheduleCustom BusinessAwayMessageScheduleCustom
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessAwayMessageScheduleCustom)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessAwayMessageScheduleCustom)
...
type ChatPhotoStickerType interface {
	GetChatPhotoStickerTypeEnum() ChatPhotoStickerTypeEnum
}

// ChatPhotoStickerTypeEnum Alias for abstract ChatPhotoStickerType 'Sub-Classes', used as constant-enum here
type ChatPhotoStickerTypeEnum string

// ChatPhotoStickerType enums
const (
	ChatPhotoStickerTypeRegularOrMaskType ChatPhotoStickerTypeEnum = "chatPhotoStickerTypeRegularOrMask"
	ChatPhotoStickerTypeCustomEmojiType   ChatPhotoStickerTypeEnum = "chatPhotoStickerTypeCustomEmoji"
)

func unmarshalChatPhotoStickerType(rawMsg *json.RawMessage) (ChatPhotoStickerType, error) {
	...
	switch ChatPhotoStickerTypeEnum(objMap["@type"].(string)) {
	case ChatPhotoStickerTypeRegularOrMaskType:
		var chatPhotoStickerTypeRegularOrMask ChatPhotoStickerTypeRegularOrMask
		err := json.Unmarshal(*rawMsg, &chatPhotoStickerTypeRegularOrMask)
		return &chatPhotoStickerTypeRegularOrMask, err

	case ChatPhotoStickerTypeCustomEmojiType:
		var chatPhotoStickerTypeCustomEmoji ChatPhotoStickerTypeCustomEmoji
		err := json.Unmarshal(*rawMsg, &chatPhotoStickerTypeCustomEmoji)
		return &chatPhotoStickerTypeCustomEmoji, err
...
func unmarshalChatPhotoStickerTypeSlice(rawMsg *json.RawMessage) ([]ChatPhotoStickerType, error) {
	objects := make([]ChatPhotoStickerType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ChatPhotoStickerTypeRegularOrMaskType:
			...
			err = json.Unmarshal(obj, &chatPhotoStickerTypeRegularOrMask)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatPhotoStickerTypeRegularOrMask)
		case ChatPhotoStickerTypeCustomEmojiType:
			var chatPhotoStickerTypeCustomEmoji ChatPhotoStickerTypeCustomEmoji
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatPhotoStickerTypeCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatPhotoStickerTypeCustomEmoji)
...
const (
	...
	InputChatPhotoStickerType   InputChatPhotoEnum = "inputChatPhotoSticker"
)
...
func unmarshalInputChatPhoto(rawMsg *json.RawMessage) (InputChatPhoto, error) {
	...
	case InputChatPhotoStickerType:
		var inputChatPhotoSticker InputChatPhotoSticker
		err := json.Unmarshal(*rawMsg, &inputChatPhotoSticker)
		return &inputChatPhotoSticker, err
...
func unmarshalInputChatPhotoSlice(rawMsg *json.RawMessage) ([]InputChatPhoto, error) {
	...
	for _, objMap := range objsMap {
		...
		case InputChatPhotoStickerType:
			...
			err = json.Unmarshal(obj, &inputChatPhotoSticker)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputChatPhotoSticker)
...
// StarTransactionDirectionEnum Alias for abstract StarTransactionDirection 'Sub-Classes', used as constant-enum here
type StarTransactionDirectionEnum string

// StarTransactionDirection enums
const (
	StarTransactionDirectionIncomingType StarTransactionDirectionEnum = "starTransactionDirectionIncoming"
	StarTransactionDirectionOutgoingType StarTransactionDirectionEnum = "starTransactionDirectionOutgoing"
)

func unmarshalStarTransactionDirection(rawMsg *json.RawMessage) (StarTransactionDirection, error) {
	...
	switch StarTransactionDirectionEnum(objMap["@type"].(string)) {
	case StarTransactionDirectionIncomingType:
		var starTransactionDirectionIncoming StarTransactionDirectionIncoming
		err := json.Unmarshal(*rawMsg, &starTransactionDirectionIncoming)
		return &starTransactionDirectionIncoming, err

	case StarTransactionDirectionOutgoingType:
		var starTransactionDirectionOutgoing StarTransactionDirectionOutgoing
		err := json.Unmarshal(*rawMsg, &starTransactionDirectionOutgoing)
		return &starTransactionDirectionOutgoing, err
...
func unmarshalStarTransactionDirectionSlice(rawMsg *json.RawMessage) ([]StarTransactionDirection, error) {
	objects := make([]StarTransactionDirection, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StarTransactionDirectionIncomingType:
			...
			err = json.Unmarshal(obj, &starTransactionDirectionIncoming)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &starTransactionDirectionIncoming)
		case StarTransactionDirectionOutgoingType:
			var starTransactionDirectionOutgoing StarTransactionDirectionOutgoing
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &starTransactionDirectionOutgoing)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &starTransactionDirectionOutgoing)
...
type GiveawayParticipantStatus interface {
	GetGiveawayParticipantStatusEnum() GiveawayParticipantStatusEnum
}

// GiveawayParticipantStatusEnum Alias for abstract GiveawayParticipantStatus 'Sub-Classes', used as constant-enum here
type GiveawayParticipantStatusEnum string

// GiveawayParticipantStatus enums
const (
	GiveawayParticipantStatusEligibleType          GiveawayParticipantStatusEnum = "giveawayParticipantStatusEligible"
	GiveawayParticipantStatusParticipatingType     GiveawayParticipantStatusEnum = "giveawayParticipantStatusParticipating"
	GiveawayParticipantStatusAlreadyWasMemberType  GiveawayParticipantStatusEnum = "giveawayParticipantStatusAlreadyWasMember"
	GiveawayParticipantStatusAdministratorType     GiveawayParticipantStatusEnum = "giveawayParticipantStatusAdministrator"
	GiveawayParticipantStatusDisallowedCountryType GiveawayParticipantStatusEnum = "giveawayParticipantStatusDisallowedCountry"
)

func unmarshalGiveawayParticipantStatus(rawMsg *json.RawMessage) (GiveawayParticipantStatus, error) {
	...
	switch GiveawayParticipantStatusEnum(objMap["@type"].(string)) {
	case GiveawayParticipantStatusEligibleType:
		var giveawayParticipantStatusEligible GiveawayParticipantStatusEligible
		err := json.Unmarshal(*rawMsg, &giveawayParticipantStatusEligible)
		return &giveawayParticipantStatusEligible, err

	case GiveawayParticipantStatusParticipatingType:
		var giveawayParticipantStatusParticipating GiveawayParticipantStatusParticipating
		err := json.Unmarshal(*rawMsg, &giveawayParticipantStatusParticipating)
		return &giveawayParticipantStatusParticipating, err

	case GiveawayParticipantStatusAlreadyWasMemberType:
		var giveawayParticipantStatusAlreadyWasMember GiveawayParticipantStatusAlreadyWasMember
		err := json.Unmarshal(*rawMsg, &giveawayParticipantStatusAlreadyWasMember)
		return &giveawayParticipantStatusAlreadyWasMember, err

	case GiveawayParticipantStatusAdministratorType:
		var giveawayParticipantStatusAdministrator GiveawayParticipantStatusAdministrator
		err := json.Unmarshal(*rawMsg, &giveawayParticipantStatusAdministrator)
		return &giveawayParticipantStatusAdministrator, err

	case GiveawayParticipantStatusDisallowedCountryType:
		var giveawayParticipantStatusDisallowedCountry GiveawayParticipantStatusDisallowedCountry
		err := json.Unmarshal(*rawMsg, &giveawayParticipantStatusDisallowedCountry)
		return &giveawayParticipantStatusDisallowedCountry, err
...
func unmarshalGiveawayParticipantStatusSlice(rawMsg *json.RawMessage) ([]GiveawayParticipantStatus, error) {
	objects := make([]GiveawayParticipantStatus, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case GiveawayParticipantStatusEligibleType:
			...
			err = json.Unmarshal(obj, &giveawayParticipantStatusEligible)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayParticipantStatusEligible)
		case GiveawayParticipantStatusParticipatingType:
			var giveawayParticipantStatusParticipating GiveawayParticipantStatusParticipating
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayParticipantStatusParticipating)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayParticipantStatusParticipating)
		case GiveawayParticipantStatusAlreadyWasMemberType:
			var giveawayParticipantStatusAlreadyWasMember GiveawayParticipantStatusAlreadyWasMember
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayParticipantStatusAlreadyWasMember)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayParticipantStatusAlreadyWasMember)
		case GiveawayParticipantStatusAdministratorType:
			var giveawayParticipantStatusAdministrator GiveawayParticipantStatusAdministrator
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayParticipantStatusAdministrator)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayParticipantStatusAdministrator)
		case GiveawayParticipantStatusDisallowedCountryType:
			var giveawayParticipantStatusDisallowedCountry GiveawayParticipantStatusDisallowedCountry
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayParticipantStatusDisallowedCountry)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayParticipantStatusDisallowedCountry)
...
type GiveawayInfo interface {
	GetGiveawayInfoEnum() GiveawayInfoEnum
}

// GiveawayInfoEnum Alias for abstract GiveawayInfo 'Sub-Classes', used as constant-enum here
type GiveawayInfoEnum string

// GiveawayInfo enums
const (
	GiveawayInfoOngoingType   GiveawayInfoEnum = "giveawayInfoOngoing"
	GiveawayInfoCompletedType GiveawayInfoEnum = "giveawayInfoCompleted"
)

func unmarshalGiveawayInfo(rawMsg *json.RawMessage) (GiveawayInfo, error) {
	...
	switch GiveawayInfoEnum(objMap["@type"].(string)) {
	case GiveawayInfoOngoingType:
		var giveawayInfoOngoing GiveawayInfoOngoing
		err := json.Unmarshal(*rawMsg, &giveawayInfoOngoing)
		return &giveawayInfoOngoing, err

	case GiveawayInfoCompletedType:
		var giveawayInfoCompleted GiveawayInfoCompleted
		err := json.Unmarshal(*rawMsg, &giveawayInfoCompleted)
		return &giveawayInfoCompleted, err
...
func unmarshalGiveawayInfoSlice(rawMsg *json.RawMessage) ([]GiveawayInfo, error) {
	objects := make([]GiveawayInfo, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case GiveawayInfoOngoingType:
			...
			err = json.Unmarshal(obj, &giveawayInfoOngoing)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayInfoOngoing)
		case GiveawayInfoCompletedType:
			var giveawayInfoCompleted GiveawayInfoCompleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayInfoCompleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayInfoCompleted)
...
type GiveawayPrize interface {
	GetGiveawayPrizeEnum() GiveawayPrizeEnum
}

// GiveawayPrizeEnum Alias for abstract GiveawayPrize 'Sub-Classes', used as constant-enum here
type GiveawayPrizeEnum string

// GiveawayPrize enums
const (
	GiveawayPrizePremiumType GiveawayPrizeEnum = "giveawayPrizePremium"
	GiveawayPrizeStarsType   GiveawayPrizeEnum = "giveawayPrizeStars"
)

func unmarshalGiveawayPrize(rawMsg *json.RawMessage) (GiveawayPrize, error) {
	...
	switch GiveawayPrizeEnum(objMap["@type"].(string)) {
	case GiveawayPrizePremiumType:
		var giveawayPrizePremium GiveawayPrizePremium
		err := json.Unmarshal(*rawMsg, &giveawayPrizePremium)
		return &giveawayPrizePremium, err

	case GiveawayPrizeStarsType:
		var giveawayPrizeStars GiveawayPrizeStars
		err := json.Unmarshal(*rawMsg, &giveawayPrizeStars)
		return &giveawayPrizeStars, err
...
func unmarshalGiveawayPrizeSlice(rawMsg *json.RawMessage) ([]GiveawayPrize, error) {
	objects := make([]GiveawayPrize, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case GiveawayPrizePremiumType:
			...
			err = json.Unmarshal(obj, &giveawayPrizePremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &giveawayPrizePremium)
		case GiveawayPrizeStarsType:
			var giveawayPrizeStars GiveawayPrizeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &giveawayPrizeStars)
			if err != nil {
				return nil, err
			}
...
type InviteLinkChatType interface {
	GetInviteLinkChatTypeEnum() InviteLinkChatTypeEnum
}

// InviteLinkChatTypeEnum Alias for abstract InviteLinkChatType 'Sub-Classes', used as constant-enum here
type InviteLinkChatTypeEnum string

// InviteLinkChatType enums
const (
	InviteLinkChatTypeBasicGroupType InviteLinkChatTypeEnum = "inviteLinkChatTypeBasicGroup"
	InviteLinkChatTypeSupergroupType InviteLinkChatTypeEnum = "inviteLinkChatTypeSupergroup"
	InviteLinkChatTypeChannelType    InviteLinkChatTypeEnum = "inviteLinkChatTypeChannel"
)

func unmarshalInviteLinkChatType(rawMsg *json.RawMessage) (InviteLinkChatType, error) {
	...
	switch InviteLinkChatTypeEnum(objMap["@type"].(string)) {
	case InviteLinkChatTypeBasicGroupType:
		var inviteLinkChatTypeBasicGroup InviteLinkChatTypeBasicGroup
		err := json.Unmarshal(*rawMsg, &inviteLinkChatTypeBasicGroup)
		return &inviteLinkChatTypeBasicGroup, err

	case InviteLinkChatTypeSupergroupType:
		var inviteLinkChatTypeSupergroup InviteLinkChatTypeSupergroup
		err := json.Unmarshal(*rawMsg, &inviteLinkChatTypeSupergroup)
		return &inviteLinkChatTypeSupergroup, err

	case InviteLinkChatTypeChannelType:
		var inviteLinkChatTypeChannel InviteLinkChatTypeChannel
		err := json.Unmarshal(*rawMsg, &inviteLinkChatTypeChannel)
		return &inviteLinkChatTypeChannel, err
...
func unmarshalInviteLinkChatTypeSlice(rawMsg *json.RawMessage) ([]InviteLinkChatType, error) {
	objects := make([]InviteLinkChatType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InviteLinkChatTypeBasicGroupType:
			...
			err = json.Unmarshal(obj, &inviteLinkChatTypeBasicGroup)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inviteLinkChatTypeBasicGroup)
		case InviteLinkChatTypeSupergroupType:
			var inviteLinkChatTypeSupergroup InviteLinkChatTypeSupergroup
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inviteLinkChatTypeSupergroup)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inviteLinkChatTypeSupergroup)
		case InviteLinkChatTypeChannelType:
			var inviteLinkChatTypeChannel InviteLinkChatTypeChannel
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inviteLinkChatTypeChannel)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inviteLinkChatTypeChannel)
...
type MessageReadDate interface {
	GetMessageReadDateEnum() MessageReadDateEnum
}

// MessageReadDateEnum Alias for abstract MessageReadDate 'Sub-Classes', used as constant-enum here
type MessageReadDateEnum string

// MessageReadDate enums
const (
	MessageReadDateReadType                  MessageReadDateEnum = "messageReadDateRead"
	MessageReadDateUnreadType                MessageReadDateEnum = "messageReadDateUnread"
	MessageReadDateTooOldType                MessageReadDateEnum = "messageReadDateTooOld"
	MessageReadDateUserPrivacyRestrictedType MessageReadDateEnum = "messageReadDateUserPrivacyRestricted"
	MessageReadDateMyPrivacyRestrictedType   MessageReadDateEnum = "messageReadDateMyPrivacyRestricted"
)

func unmarshalMessageReadDate(rawMsg *json.RawMessage) (MessageReadDate, error) {
	...
	switch MessageReadDateEnum(objMap["@type"].(string)) {
	case MessageReadDateReadType:
		var messageReadDateRead MessageReadDateRead
		err := json.Unmarshal(*rawMsg, &messageReadDateRead)
		return &messageReadDateRead, err

	case MessageReadDateUnreadType:
		var messageReadDateUnread MessageReadDateUnread
		err := json.Unmarshal(*rawMsg, &messageReadDateUnread)
		return &messageReadDateUnread, err

	case MessageReadDateTooOldType:
		var messageReadDateTooOld MessageReadDateTooOld
		err := json.Unmarshal(*rawMsg, &messageReadDateTooOld)
		return &messageReadDateTooOld, err

	case MessageReadDateUserPrivacyRestrictedType:
		var messageReadDateUserPrivacyRestricted MessageReadDateUserPrivacyRestricted
		err := json.Unmarshal(*rawMsg, &messageReadDateUserPrivacyRestricted)
		return &messageReadDateUserPrivacyRestricted, err

	case MessageReadDateMyPrivacyRestrictedType:
		var messageReadDateMyPrivacyRestricted MessageReadDateMyPrivacyRestricted
		err := json.Unmarshal(*rawMsg, &messageReadDateMyPrivacyRestricted)
		return &messageReadDateMyPrivacyRestricted, err
...
func unmarshalMessageReadDateSlice(rawMsg *json.RawMessage) ([]MessageReadDate, error) {
	objects := make([]MessageReadDate, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageReadDateReadType:
			...
			err = json.Unmarshal(obj, &messageReadDateRead)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReadDateRead)
		case MessageReadDateUnreadType:
			var messageReadDateUnread MessageReadDateUnread
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageReadDateUnread)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReadDateUnread)
		case MessageReadDateTooOldType:
			var messageReadDateTooOld MessageReadDateTooOld
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageReadDateTooOld)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReadDateTooOld)
		case MessageReadDateUserPrivacyRestrictedType:
			var messageReadDateUserPrivacyRestricted MessageReadDateUserPrivacyRestricted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageReadDateUserPrivacyRestricted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReadDateUserPrivacyRestricted)
		case MessageReadDateMyPrivacyRestrictedType:
			var messageReadDateMyPrivacyRestricted MessageReadDateMyPrivacyRestricted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageReadDateMyPrivacyRestricted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReadDateMyPrivacyRestricted)
...
type MessageOrigin interface {
	GetMessageOriginEnum() MessageOriginEnum
}

// MessageOriginEnum Alias for abstract MessageOrigin 'Sub-Classes', used as constant-enum here
type MessageOriginEnum string

// MessageOrigin enums
const (
	MessageOriginUserType       MessageOriginEnum = "messageOriginUser"
	MessageOriginHiddenUserType MessageOriginEnum = "messageOriginHiddenUser"
	MessageOriginChatType       MessageOriginEnum = "messageOriginChat"
	MessageOriginChannelType    MessageOriginEnum = "messageOriginChannel"
)

func unmarshalMessageOrigin(rawMsg *json.RawMessage) (MessageOrigin, error) {
	...
	switch MessageOriginEnum(objMap["@type"].(string)) {
	case MessageOriginUserType:
		var messageOriginUser MessageOriginUser
		err := json.Unmarshal(*rawMsg, &messageOriginUser)
		return &messageOriginUser, err

	case MessageOriginHiddenUserType:
		var messageOriginHiddenUser MessageOriginHiddenUser
		err := json.Unmarshal(*rawMsg, &messageOriginHiddenUser)
		return &messageOriginHiddenUser, err

	case MessageOriginChatType:
		var messageOriginChat MessageOriginChat
		err := json.Unmarshal(*rawMsg, &messageOriginChat)
		return &messageOriginChat, err

	case MessageOriginChannelType:
		var messageOriginChannel MessageOriginChannel
		err := json.Unmarshal(*rawMsg, &messageOriginChannel)
		return &messageOriginChannel, err
...
func unmarshalMessageOriginSlice(rawMsg *json.RawMessage) ([]MessageOrigin, error) {
	objects := make([]MessageOrigin, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageOriginUserType:
			...
			err = json.Unmarshal(obj, &messageOriginUser)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageOriginUser)
		case MessageOriginHiddenUserType:
			var messageOriginHiddenUser MessageOriginHiddenUser
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageOriginHiddenUser)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageOriginHiddenUser)
		case MessageOriginChatType:
			var messageOriginChat MessageOriginChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageOriginChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageOriginChat)
		case MessageOriginChannelType:
			var messageOriginChannel MessageOriginChannel
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageOriginChannel)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageOriginChannel)
...
type ReactionType interface {
	GetReactionTypeEnum() ReactionTypeEnum
}

// ReactionTypeEnum Alias for abstract ReactionType 'Sub-Classes', used as constant-enum here
type ReactionTypeEnum string

// ReactionType enums
const (
	ReactionTypeEmojiType       ReactionTypeEnum = "reactionTypeEmoji"
	ReactionTypeCustomEmojiType ReactionTypeEnum = "reactionTypeCustomEmoji"
	ReactionTypePaidType        ReactionTypeEnum = "reactionTypePaid"
)

func unmarshalReactionType(rawMsg *json.RawMessage) (ReactionType, error) {
	...
	switch ReactionTypeEnum(objMap["@type"].(string)) {
	case ReactionTypeEmojiType:
		var reactionTypeEmoji ReactionTypeEmoji
		err := json.Unmarshal(*rawMsg, &reactionTypeEmoji)
		return &reactionTypeEmoji, err

	case ReactionTypeCustomEmojiType:
		var reactionTypeCustomEmoji ReactionTypeCustomEmoji
		err := json.Unmarshal(*rawMsg, &reactionTypeCustomEmoji)
		return &reactionTypeCustomEmoji, err

	case ReactionTypePaidType:
		var reactionTypePaid ReactionTypePaid
		err := json.Unmarshal(*rawMsg, &reactionTypePaid)
		return &reactionTypePaid, err
...
func unmarshalReactionTypeSlice(rawMsg *json.RawMessage) ([]ReactionType, error) {
	objects := make([]ReactionType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ReactionTypeEmojiType:
			...
			err = json.Unmarshal(obj, &reactionTypeEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionTypeEmoji)
		case ReactionTypeCustomEmojiType:
			var reactionTypeCustomEmoji ReactionTypeCustomEmoji
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reactionTypeCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionTypeCustomEmoji)
		case ReactionTypePaidType:
			var reactionTypePaid ReactionTypePaid
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reactionTypePaid)
			if err != nil {
				return nil, err
			}
...
type MessageEffectType interface {
	GetMessageEffectTypeEnum() MessageEffectTypeEnum
}

// MessageEffectTypeEnum Alias for abstract MessageEffectType 'Sub-Classes', used as constant-enum here
type MessageEffectTypeEnum string

// MessageEffectType enums
const (
	MessageEffectTypeEmojiReactionType  MessageEffectTypeEnum = "messageEffectTypeEmojiReaction"
	MessageEffectTypePremiumStickerType MessageEffectTypeEnum = "messageEffectTypePremiumSticker"
)

func unmarshalMessageEffectType(rawMsg *json.RawMessage) (MessageEffectType, error) {
	...
	switch MessageEffectTypeEnum(objMap["@type"].(string)) {
	case MessageEffectTypeEmojiReactionType:
		var messageEffectTypeEmojiReaction MessageEffectTypeEmojiReaction
		err := json.Unmarshal(*rawMsg, &messageEffectTypeEmojiReaction)
		return &messageEffectTypeEmojiReaction, err

	case MessageEffectTypePremiumStickerType:
		var messageEffectTypePremiumSticker MessageEffectTypePremiumSticker
		err := json.Unmarshal(*rawMsg, &messageEffectTypePremiumSticker)
		return &messageEffectTypePremiumSticker, err
...
func unmarshalMessageEffectTypeSlice(rawMsg *json.RawMessage) ([]MessageEffectType, error) {
	objects := make([]MessageEffectType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageEffectTypeEmojiReactionType:
			...
			err = json.Unmarshal(obj, &messageEffectTypeEmojiReaction)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageEffectTypeEmojiReaction)
		case MessageEffectTypePremiumStickerType:
			var messageEffectTypePremiumSticker MessageEffectTypePremiumSticker
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageEffectTypePremiumSticker)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageEffectTypePremiumSticker)
...
type MessageReplyTo interface {
	GetMessageReplyToEnum() MessageReplyToEnum
}

// MessageReplyToEnum Alias for abstract MessageReplyTo 'Sub-Classes', used as constant-enum here
type MessageReplyToEnum string

// MessageReplyTo enums
const (
	MessageReplyToMessageType MessageReplyToEnum = "messageReplyToMessage"
	MessageReplyToStoryType   MessageReplyToEnum = "messageReplyToStory"
)

func unmarshalMessageReplyTo(rawMsg *json.RawMessage) (MessageReplyTo, error) {
	...
	switch MessageReplyToEnum(objMap["@type"].(string)) {
	case MessageReplyToMessageType:
		var messageReplyToMessage MessageReplyToMessage
		err := json.Unmarshal(*rawMsg, &messageReplyToMessage)
		return &messageReplyToMessage, err

	case MessageReplyToStoryType:
		var messageReplyToStory MessageReplyToStory
		err := json.Unmarshal(*rawMsg, &messageReplyToStory)
		return &messageReplyToStory, err
...
func unmarshalMessageReplyToSlice(rawMsg *json.RawMessage) ([]MessageReplyTo, error) {
	objects := make([]MessageReplyTo, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageReplyToMessageType:
			...
			err = json.Unmarshal(obj, &messageReplyToMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReplyToMessage)
		case MessageReplyToStoryType:
			var messageReplyToStory MessageReplyToStory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageReplyToStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageReplyToStory)
...
type InputMessageReplyTo interface {
	GetInputMessageReplyToEnum() InputMessageReplyToEnum
}

// InputMessageReplyToEnum Alias for abstract InputMessageReplyTo 'Sub-Classes', used as constant-enum here
type InputMessageReplyToEnum string

// InputMessageReplyTo enums
const (
	InputMessageReplyToMessageType         InputMessageReplyToEnum = "inputMessageReplyToMessage"
	InputMessageReplyToExternalMessageType InputMessageReplyToEnum = "inputMessageReplyToExternalMessage"
	InputMessageReplyToStoryType           InputMessageReplyToEnum = "inputMessageReplyToStory"
)

func unmarshalInputMessageReplyTo(rawMsg *json.RawMessage) (InputMessageReplyTo, error) {
	...
	switch InputMessageReplyToEnum(objMap["@type"].(string)) {
	case InputMessageReplyToMessageType:
		var inputMessageReplyToMessage InputMessageReplyToMessage
		err := json.Unmarshal(*rawMsg, &inputMessageReplyToMessage)
		return &inputMessageReplyToMessage, err

	case InputMessageReplyToExternalMessageType:
		var inputMessageReplyToExternalMessage InputMessageReplyToExternalMessage
		err := json.Unmarshal(*rawMsg, &inputMessageReplyToExternalMessage)
		return &inputMessageReplyToExternalMessage, err

	case InputMessageReplyToStoryType:
		var inputMessageReplyToStory InputMessageReplyToStory
		err := json.Unmarshal(*rawMsg, &inputMessageReplyToStory)
		return &inputMessageReplyToStory, err
...
func unmarshalInputMessageReplyToSlice(rawMsg *json.RawMessage) ([]InputMessageReplyTo, error) {
	objects := make([]InputMessageReplyTo, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InputMessageReplyToMessageType:
			...
			err = json.Unmarshal(obj, &inputMessageReplyToMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputMessageReplyToMessage)
		case InputMessageReplyToExternalMessageType:
			var inputMessageReplyToExternalMessage InputMessageReplyToExternalMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputMessageReplyToExternalMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputMessageReplyToExternalMessage)
		case InputMessageReplyToStoryType:
			var inputMessageReplyToStory InputMessageReplyToStory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputMessageReplyToStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputMessageReplyToStory)
...
type MessageSource interface {
	GetMessageSourceEnum() MessageSourceEnum
}

// MessageSourceEnum Alias for abstract MessageSource 'Sub-Classes', used as constant-enum here
type MessageSourceEnum string

// MessageSource enums
const (
	MessageSourceChatHistoryType          MessageSourceEnum = "messageSourceChatHistory"
	MessageSourceMessageThreadHistoryType MessageSourceEnum = "messageSourceMessageThreadHistory"
	MessageSourceForumTopicHistoryType    MessageSourceEnum = "messageSourceForumTopicHistory"
	MessageSourceHistoryPreviewType       MessageSourceEnum = "messageSourceHistoryPreview"
	MessageSourceChatListType             MessageSourceEnum = "messageSourceChatList"
	MessageSourceSearchType               MessageSourceEnum = "messageSourceSearch"
	MessageSourceChatEventLogType         MessageSourceEnum = "messageSourceChatEventLog"
	MessageSourceNotificationType         MessageSourceEnum = "messageSourceNotification"
	MessageSourceScreenshotType           MessageSourceEnum = "messageSourceScreenshot"
	MessageSourceOtherType                MessageSourceEnum = "messageSourceOther"
)

func unmarshalMessageSource(rawMsg *json.RawMessage) (MessageSource, error) {
	...
	switch MessageSourceEnum(objMap["@type"].(string)) {
	case MessageSourceChatHistoryType:
		var messageSourceChatHistory MessageSourceChatHistory
		err := json.Unmarshal(*rawMsg, &messageSourceChatHistory)
		return &messageSourceChatHistory, err

	case MessageSourceMessageThreadHistoryType:
		var messageSourceMessageThreadHistory MessageSourceMessageThreadHistory
		err := json.Unmarshal(*rawMsg, &messageSourceMessageThreadHistory)
		return &messageSourceMessageThreadHistory, err

	case MessageSourceForumTopicHistoryType:
		var messageSourceForumTopicHistory MessageSourceForumTopicHistory
		err := json.Unmarshal(*rawMsg, &messageSourceForumTopicHistory)
		return &messageSourceForumTopicHistory, err

	case MessageSourceHistoryPreviewType:
		var messageSourceHistoryPreview MessageSourceHistoryPreview
		err := json.Unmarshal(*rawMsg, &messageSourceHistoryPreview)
		return &messageSourceHistoryPreview, err

	case MessageSourceChatListType:
		var messageSourceChatList MessageSourceChatList
		err := json.Unmarshal(*rawMsg, &messageSourceChatList)
		return &messageSourceChatList, err

	case MessageSourceSearchType:
		var messageSourceSearch MessageSourceSearch
		err := json.Unmarshal(*rawMsg, &messageSourceSearch)
		return &messageSourceSearch, err

	case MessageSourceChatEventLogType:
		var messageSourceChatEventLog MessageSourceChatEventLog
		err := json.Unmarshal(*rawMsg, &messageSourceChatEventLog)
		return &messageSourceChatEventLog, err

	case MessageSourceNotificationType:
		var messageSourceNotification MessageSourceNotification
		err := json.Unmarshal(*rawMsg, &messageSourceNotification)
		return &messageSourceNotification, err

	case MessageSourceScreenshotType:
		var messageSourceScreenshot MessageSourceScreenshot
		err := json.Unmarshal(*rawMsg, &messageSourceScreenshot)
		return &messageSourceScreenshot, err

	case MessageSourceOtherType:
		var messageSourceOther MessageSourceOther
		err := json.Unmarshal(*rawMsg, &messageSourceOther)
		return &messageSourceOther, err
...
func unmarshalMessageSourceSlice(rawMsg *json.RawMessage) ([]MessageSource, error) {
	objects := make([]MessageSource, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageSourceChatHistoryType:
			...
			err = json.Unmarshal(obj, &messageSourceChatHistory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceChatHistory)
		case MessageSourceMessageThreadHistoryType:
			var messageSourceMessageThreadHistory MessageSourceMessageThreadHistory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceMessageThreadHistory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceMessageThreadHistory)
		case MessageSourceForumTopicHistoryType:
			var messageSourceForumTopicHistory MessageSourceForumTopicHistory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceForumTopicHistory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceForumTopicHistory)
		case MessageSourceHistoryPreviewType:
			var messageSourceHistoryPreview MessageSourceHistoryPreview
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceHistoryPreview)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceHistoryPreview)
		case MessageSourceChatListType:
			var messageSourceChatList MessageSourceChatList
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceChatList)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceChatList)
		case MessageSourceSearchType:
			var messageSourceSearch MessageSourceSearch
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceSearch)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceSearch)
		case MessageSourceChatEventLogType:
			var messageSourceChatEventLog MessageSourceChatEventLog
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceChatEventLog)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceChatEventLog)
		case MessageSourceNotificationType:
			var messageSourceNotification MessageSourceNotification
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceNotification)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceNotification)
		case MessageSourceScreenshotType:
			var messageSourceScreenshot MessageSourceScreenshot
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceScreenshot)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceScreenshot)
		case MessageSourceOtherType:
			var messageSourceOther MessageSourceOther
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSourceOther)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSourceOther)
...
// ReportChatSponsoredMessageResult Describes result of sponsored message report
type ReportChatSponsoredMessageResult interface {
	GetReportChatSponsoredMessageResultEnum() ReportChatSponsoredMessageResultEnum
}

// ReportChatSponsoredMessageResultEnum Alias for abstract ReportChatSponsoredMessageResult 'Sub-Classes', used as constant-enum here
type ReportChatSponsoredMessageResultEnum string

// ReportChatSponsoredMessageResult enums
const (
	ReportChatSponsoredMessageResultOkType              ReportChatSponsoredMessageResultEnum = "reportChatSponsoredMessageResultOk"
	ReportChatSponsoredMessageResultFailedType          ReportChatSponsoredMessageResultEnum = "reportChatSponsoredMessageResultFailed"
	ReportChatSponsoredMessageResultOptionRequiredType  ReportChatSponsoredMessageResultEnum = "reportChatSponsoredMessageResultOptionRequired"
	ReportChatSponsoredMessageResultAdsHiddenType       ReportChatSponsoredMessageResultEnum = "reportChatSponsoredMessageResultAdsHidden"
	ReportChatSponsoredMessageResultPremiumRequiredType ReportChatSponsoredMessageResultEnum = "reportChatSponsoredMessageResultPremiumRequired"
)

func unmarshalReportChatSponsoredMessageResult(rawMsg *json.RawMessage) (ReportChatSponsoredMessageResult, error) {
	...
	switch ReportChatSponsoredMessageResultEnum(objMap["@type"].(string)) {
	case ReportChatSponsoredMessageResultOkType:
		var reportChatSponsoredMessageResultOk ReportChatSponsoredMessageResultOk
		err := json.Unmarshal(*rawMsg, &reportChatSponsoredMessageResultOk)
		return &reportChatSponsoredMessageResultOk, err

	case ReportChatSponsoredMessageResultFailedType:
		var reportChatSponsoredMessageResultFailed ReportChatSponsoredMessageResultFailed
		err := json.Unmarshal(*rawMsg, &reportChatSponsoredMessageResultFailed)
		return &reportChatSponsoredMessageResultFailed, err

	case ReportChatSponsoredMessageResultOptionRequiredType:
		var reportChatSponsoredMessageResultOptionRequired ReportChatSponsoredMessageResultOptionRequired
		err := json.Unmarshal(*rawMsg, &reportChatSponsoredMessageResultOptionRequired)
		return &reportChatSponsoredMessageResultOptionRequired, err

	case ReportChatSponsoredMessageResultAdsHiddenType:
		var reportChatSponsoredMessageResultAdsHidden ReportChatSponsoredMessageResultAdsHidden
		err := json.Unmarshal(*rawMsg, &reportChatSponsoredMessageResultAdsHidden)
		return &reportChatSponsoredMessageResultAdsHidden, err

	case ReportChatSponsoredMessageResultPremiumRequiredType:
		var reportChatSponsoredMessageResultPremiumRequired ReportChatSponsoredMessageResultPremiumRequired
		err := json.Unmarshal(*rawMsg, &reportChatSponsoredMessageResultPremiumRequired)
		return &reportChatSponsoredMessageResultPremiumRequired, err
...
func unmarshalReportChatSponsoredMessageResultSlice(rawMsg *json.RawMessage) ([]ReportChatSponsoredMessageResult, error) {
	objects := make([]ReportChatSponsoredMessageResult, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ReportChatSponsoredMessageResultOkType:
			...
			err = json.Unmarshal(obj, &reportChatSponsoredMessageResultOk)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportChatSponsoredMessageResultOk)
		case ReportChatSponsoredMessageResultFailedType:
			var reportChatSponsoredMessageResultFailed ReportChatSponsoredMessageResultFailed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportChatSponsoredMessageResultFailed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportChatSponsoredMessageResultFailed)
		case ReportChatSponsoredMessageResultOptionRequiredType:
			var reportChatSponsoredMessageResultOptionRequired ReportChatSponsoredMessageResultOptionRequired
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportChatSponsoredMessageResultOptionRequired)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportChatSponsoredMessageResultOptionRequired)
		case ReportChatSponsoredMessageResultAdsHiddenType:
			var reportChatSponsoredMessageResultAdsHidden ReportChatSponsoredMessageResultAdsHidden
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportChatSponsoredMessageResultAdsHidden)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportChatSponsoredMessageResultAdsHidden)
		case ReportChatSponsoredMessageResultPremiumRequiredType:
			var reportChatSponsoredMessageResultPremiumRequired ReportChatSponsoredMessageResultPremiumRequired
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportChatSponsoredMessageResultPremiumRequired)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportChatSponsoredMessageResultPremiumRequired)
...
type ReactionNotificationSource interface {
	GetReactionNotificationSourceEnum() ReactionNotificationSourceEnum
}

// ReactionNotificationSourceEnum Alias for abstract ReactionNotificationSource 'Sub-Classes', used as constant-enum here
type ReactionNotificationSourceEnum string

// ReactionNotificationSource enums
const (
	ReactionNotificationSourceNoneType     ReactionNotificationSourceEnum = "reactionNotificationSourceNone"
	ReactionNotificationSourceContactsType ReactionNotificationSourceEnum = "reactionNotificationSourceContacts"
	ReactionNotificationSourceAllType      ReactionNotificationSourceEnum = "reactionNotificationSourceAll"
)

func unmarshalReactionNotificationSource(rawMsg *json.RawMessage) (ReactionNotificationSource, error) {
	...
	switch ReactionNotificationSourceEnum(objMap["@type"].(string)) {
	case ReactionNotificationSourceNoneType:
		var reactionNotificationSourceNone ReactionNotificationSourceNone
		err := json.Unmarshal(*rawMsg, &reactionNotificationSourceNone)
		return &reactionNotificationSourceNone, err

	case ReactionNotificationSourceContactsType:
		var reactionNotificationSourceContacts ReactionNotificationSourceContacts
		err := json.Unmarshal(*rawMsg, &reactionNotificationSourceContacts)
		return &reactionNotificationSourceContacts, err

	case ReactionNotificationSourceAllType:
		var reactionNotificationSourceAll ReactionNotificationSourceAll
		err := json.Unmarshal(*rawMsg, &reactionNotificationSourceAll)
		return &reactionNotificationSourceAll, err
...
func unmarshalReactionNotificationSourceSlice(rawMsg *json.RawMessage) ([]ReactionNotificationSource, error) {
	objects := make([]ReactionNotificationSource, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ReactionNotificationSourceNoneType:
			...
			err = json.Unmarshal(obj, &reactionNotificationSourceNone)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionNotificationSourceNone)
		case ReactionNotificationSourceContactsType:
			var reactionNotificationSourceContacts ReactionNotificationSourceContacts
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reactionNotificationSourceContacts)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionNotificationSourceContacts)
		case ReactionNotificationSourceAllType:
			var reactionNotificationSourceAll ReactionNotificationSourceAll
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reactionNotificationSourceAll)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionNotificationSourceAll)
...
const (
	...
	ChatListFolderType  ChatListEnum = "chatListFolder"
)
...
func unmarshalChatList(rawMsg *json.RawMessage) (ChatList, error) {
	...
	case ChatListFolderType:
		var chatListFolder ChatListFolder
		err := json.Unmarshal(*rawMsg, &chatListFolder)
		return &chatListFolder, err
...
func unmarshalChatListSlice(rawMsg *json.RawMessage) ([]ChatList, error) {
	...
	for _, objMap := range objsMap {
		...
		case ChatListFolderType:
			...
			err = json.Unmarshal(obj, &chatListFolder)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatListFolder)
...
type ChatAvailableReactions interface {
	GetChatAvailableReactionsEnum() ChatAvailableReactionsEnum
}

// ChatAvailableReactionsEnum Alias for abstract ChatAvailableReactions 'Sub-Classes', used as constant-enum here
type ChatAvailableReactionsEnum string

// ChatAvailableReactions enums
const (
	ChatAvailableReactionsAllType  ChatAvailableReactionsEnum = "chatAvailableReactionsAll"
	ChatAvailableReactionsSomeType ChatAvailableReactionsEnum = "chatAvailableReactionsSome"
)

func unmarshalChatAvailableReactions(rawMsg *json.RawMessage) (ChatAvailableReactions, error) {
	...
	switch ChatAvailableReactionsEnum(objMap["@type"].(string)) {
	case ChatAvailableReactionsAllType:
		var chatAvailableReactionsAll ChatAvailableReactionsAll
		err := json.Unmarshal(*rawMsg, &chatAvailableReactionsAll)
		return &chatAvailableReactionsAll, err

	case ChatAvailableReactionsSomeType:
		var chatAvailableReactionsSome ChatAvailableReactionsSome
		err := json.Unmarshal(*rawMsg, &chatAvailableReactionsSome)
		return &chatAvailableReactionsSome, err
...
func unmarshalChatAvailableReactionsSlice(rawMsg *json.RawMessage) ([]ChatAvailableReactions, error) {
	objects := make([]ChatAvailableReactions, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ChatAvailableReactionsAllType:
			...
			err = json.Unmarshal(obj, &chatAvailableReactionsAll)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatAvailableReactionsAll)
		case ChatAvailableReactionsSomeType:
			var chatAvailableReactionsSome ChatAvailableReactionsSome
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatAvailableReactionsSome)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatAvailableReactionsSome)
...
const (
	...
	KeyboardButtonTypeRequestUsersType       KeyboardButtonTypeEnum = "keyboardButtonTypeRequestUsers"
	KeyboardButtonTypeRequestChatType        KeyboardButtonTypeEnum = "keyboardButtonTypeRequestChat"
	KeyboardButtonTypeWebAppType             KeyboardButtonTypeEnum = "keyboardButtonTypeWebApp"
)
...
func unmarshalKeyboardButtonType(rawMsg *json.RawMessage) (KeyboardButtonType, error) {
	...
	case KeyboardButtonTypeRequestUsersType:
		var keyboardButtonTypeRequestUsers KeyboardButtonTypeRequestUsers
		err := json.Unmarshal(*rawMsg, &keyboardButtonTypeRequestUsers)
		return &keyboardButtonTypeRequestUsers, err

	case KeyboardButtonTypeRequestChatType:
		var keyboardButtonTypeRequestChat KeyboardButtonTypeRequestChat
		err := json.Unmarshal(*rawMsg, &keyboardButtonTypeRequestChat)
		return &keyboardButtonTypeRequestChat, err

	case KeyboardButtonTypeWebAppType:
		var keyboardButtonTypeWebApp KeyboardButtonTypeWebApp
		err := json.Unmarshal(*rawMsg, &keyboardButtonTypeWebApp)
		return &keyboardButtonTypeWebApp, err
...
func unmarshalKeyboardButtonTypeSlice(rawMsg *json.RawMessage) ([]KeyboardButtonType, error) {
	...
	for _, objMap := range objsMap {
		...
		case KeyboardButtonTypeRequestUsersType:
			...
			err = json.Unmarshal(obj, &keyboardButtonTypeRequestUsers)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &keyboardButtonTypeRequestUsers)
		case KeyboardButtonTypeRequestChatType:
			var keyboardButtonTypeRequestChat KeyboardButtonTypeRequestChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &keyboardButtonTypeRequestChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &keyboardButtonTypeRequestChat)
		case KeyboardButtonTypeWebAppType:
			var keyboardButtonTypeWebApp KeyboardButtonTypeWebApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &keyboardButtonTypeWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &keyboardButtonTypeWebApp)
...
const (
	...
	InlineKeyboardButtonTypeWebAppType               InlineKeyboardButtonTypeEnum = "inlineKeyboardButtonTypeWebApp"
...
func unmarshalInlineKeyboardButtonType(rawMsg *json.RawMessage) (InlineKeyboardButtonType, error) {
	...
	case InlineKeyboardButtonTypeWebAppType:
		var inlineKeyboardButtonTypeWebApp InlineKeyboardButtonTypeWebApp
		err := json.Unmarshal(*rawMsg, &inlineKeyboardButtonTypeWebApp)
		return &inlineKeyboardButtonTypeWebApp, err
...
func unmarshalInlineKeyboardButtonTypeSlice(rawMsg *json.RawMessage) ([]InlineKeyboardButtonType, error) {
	...
	for _, objMap := range objsMap {
		...
		case InlineKeyboardButtonTypeWebAppType:
			...
			err = json.Unmarshal(obj, &inlineKeyboardButtonTypeWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inlineKeyboardButtonTypeWebApp)
		case InlineKeyboardButtonTypeCallbackType:
			var inlineKeyboardButtonTypeCallback InlineKeyboardButtonTypeCallback
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type SavedMessagesTopicType interface {
	GetSavedMessagesTopicTypeEnum() SavedMessagesTopicTypeEnum
}

// SavedMessagesTopicTypeEnum Alias for abstract SavedMessagesTopicType 'Sub-Classes', used as constant-enum here
type SavedMessagesTopicTypeEnum string

// SavedMessagesTopicType enums
const (
	SavedMessagesTopicTypeMyNotesType       SavedMessagesTopicTypeEnum = "savedMessagesTopicTypeMyNotes"
	SavedMessagesTopicTypeAuthorHiddenType  SavedMessagesTopicTypeEnum = "savedMessagesTopicTypeAuthorHidden"
	SavedMessagesTopicTypeSavedFromChatType SavedMessagesTopicTypeEnum = "savedMessagesTopicTypeSavedFromChat"
)

func unmarshalSavedMessagesTopicType(rawMsg *json.RawMessage) (SavedMessagesTopicType, error) {
	...
	switch SavedMessagesTopicTypeEnum(objMap["@type"].(string)) {
	case SavedMessagesTopicTypeMyNotesType:
		var savedMessagesTopicTypeMyNotes SavedMessagesTopicTypeMyNotes
		err := json.Unmarshal(*rawMsg, &savedMessagesTopicTypeMyNotes)
		return &savedMessagesTopicTypeMyNotes, err

	case SavedMessagesTopicTypeAuthorHiddenType:
		var savedMessagesTopicTypeAuthorHidden SavedMessagesTopicTypeAuthorHidden
		err := json.Unmarshal(*rawMsg, &savedMessagesTopicTypeAuthorHidden)
		return &savedMessagesTopicTypeAuthorHidden, err

	case SavedMessagesTopicTypeSavedFromChatType:
		var savedMessagesTopicTypeSavedFromChat SavedMessagesTopicTypeSavedFromChat
		err := json.Unmarshal(*rawMsg, &savedMessagesTopicTypeSavedFromChat)
		return &savedMessagesTopicTypeSavedFromChat, err
...
func unmarshalSavedMessagesTopicTypeSlice(rawMsg *json.RawMessage) ([]SavedMessagesTopicType, error) {
	objects := make([]SavedMessagesTopicType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case SavedMessagesTopicTypeMyNotesType:
			...
			err = json.Unmarshal(obj, &savedMessagesTopicTypeMyNotes)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &savedMessagesTopicTypeMyNotes)
		case SavedMessagesTopicTypeAuthorHiddenType:
			var savedMessagesTopicTypeAuthorHidden SavedMessagesTopicTypeAuthorHidden
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &savedMessagesTopicTypeAuthorHidden)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &savedMessagesTopicTypeAuthorHidden)
		case SavedMessagesTopicTypeSavedFromChatType:
			var savedMessagesTopicTypeSavedFromChat SavedMessagesTopicTypeSavedFromChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &savedMessagesTopicTypeSavedFromChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &savedMessagesTopicTypeSavedFromChat)
...
type LinkPreviewAlbumMedia interface {
	GetLinkPreviewAlbumMediaEnum() LinkPreviewAlbumMediaEnum
}

// LinkPreviewAlbumMediaEnum Alias for abstract LinkPreviewAlbumMedia 'Sub-Classes', used as constant-enum here
type LinkPreviewAlbumMediaEnum string

// LinkPreviewAlbumMedia enums
const (
	LinkPreviewAlbumMediaPhotoType LinkPreviewAlbumMediaEnum = "linkPreviewAlbumMediaPhoto"
	LinkPreviewAlbumMediaVideoType LinkPreviewAlbumMediaEnum = "linkPreviewAlbumMediaVideo"
)

func unmarshalLinkPreviewAlbumMedia(rawMsg *json.RawMessage) (LinkPreviewAlbumMedia, error) {
	...
	switch LinkPreviewAlbumMediaEnum(objMap["@type"].(string)) {
	case LinkPreviewAlbumMediaPhotoType:
		var linkPreviewAlbumMediaPhoto LinkPreviewAlbumMediaPhoto
		err := json.Unmarshal(*rawMsg, &linkPreviewAlbumMediaPhoto)
		return &linkPreviewAlbumMediaPhoto, err

	case LinkPreviewAlbumMediaVideoType:
		var linkPreviewAlbumMediaVideo LinkPreviewAlbumMediaVideo
		err := json.Unmarshal(*rawMsg, &linkPreviewAlbumMediaVideo)
		return &linkPreviewAlbumMediaVideo, err
...
func unmarshalLinkPreviewAlbumMediaSlice(rawMsg *json.RawMessage) ([]LinkPreviewAlbumMedia, error) {
	objects := make([]LinkPreviewAlbumMedia, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case LinkPreviewAlbumMediaPhotoType:
			...
			err = json.Unmarshal(obj, &linkPreviewAlbumMediaPhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewAlbumMediaPhoto)
		case LinkPreviewAlbumMediaVideoType:
			var linkPreviewAlbumMediaVideo LinkPreviewAlbumMediaVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewAlbumMediaVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewAlbumMediaVideo)
...
type LinkPreviewType interface {
	GetLinkPreviewTypeEnum() LinkPreviewTypeEnum
}

// LinkPreviewTypeEnum Alias for abstract LinkPreviewType 'Sub-Classes', used as constant-enum here
type LinkPreviewTypeEnum string

// LinkPreviewType enums
const (
	LinkPreviewTypeAlbumType                   LinkPreviewTypeEnum = "linkPreviewTypeAlbum"
	LinkPreviewTypeAnimationType               LinkPreviewTypeEnum = "linkPreviewTypeAnimation"
	LinkPreviewTypeAppType                     LinkPreviewTypeEnum = "linkPreviewTypeApp"
	LinkPreviewTypeArticleType                 LinkPreviewTypeEnum = "linkPreviewTypeArticle"
	LinkPreviewTypeAudioType                   LinkPreviewTypeEnum = "linkPreviewTypeAudio"
	LinkPreviewTypeBackgroundType              LinkPreviewTypeEnum = "linkPreviewTypeBackground"
	LinkPreviewTypeChannelBoostType            LinkPreviewTypeEnum = "linkPreviewTypeChannelBoost"
	LinkPreviewTypeChatType                    LinkPreviewTypeEnum = "linkPreviewTypeChat"
	LinkPreviewTypeDocumentType                LinkPreviewTypeEnum = "linkPreviewTypeDocument"
	LinkPreviewTypeEmbeddedAnimationPlayerType LinkPreviewTypeEnum = "linkPreviewTypeEmbeddedAnimationPlayer"
	LinkPreviewTypeEmbeddedAudioPlayerType     LinkPreviewTypeEnum = "linkPreviewTypeEmbeddedAudioPlayer"
	LinkPreviewTypeEmbeddedVideoPlayerType     LinkPreviewTypeEnum = "linkPreviewTypeEmbeddedVideoPlayer"
	LinkPreviewTypeExternalAudioType           LinkPreviewTypeEnum = "linkPreviewTypeExternalAudio"
	LinkPreviewTypeExternalVideoType           LinkPreviewTypeEnum = "linkPreviewTypeExternalVideo"
	LinkPreviewTypeInvoiceType                 LinkPreviewTypeEnum = "linkPreviewTypeInvoice"
	LinkPreviewTypeMessageType                 LinkPreviewTypeEnum = "linkPreviewTypeMessage"
	LinkPreviewTypePhotoType                   LinkPreviewTypeEnum = "linkPreviewTypePhoto"
	LinkPreviewTypePremiumGiftCodeType         LinkPreviewTypeEnum = "linkPreviewTypePremiumGiftCode"
	LinkPreviewTypeShareableChatFolderType     LinkPreviewTypeEnum = "linkPreviewTypeShareableChatFolder"
	LinkPreviewTypeStickerType                 LinkPreviewTypeEnum = "linkPreviewTypeSticker"
	LinkPreviewTypeStickerSetType              LinkPreviewTypeEnum = "linkPreviewTypeStickerSet"
	LinkPreviewTypeStoryType                   LinkPreviewTypeEnum = "linkPreviewTypeStory"
	...
	LinkPreviewTypeVideoNoteType               LinkPreviewTypeEnum = "linkPreviewTypeVideoNote"
	LinkPreviewTypeVoiceNoteType               LinkPreviewTypeEnum = "linkPreviewTypeVoiceNote"
	LinkPreviewTypeWebAppType                  LinkPreviewTypeEnum = "linkPreviewTypeWebApp"
)

func unmarshalLinkPreviewType(rawMsg *json.RawMessage) (LinkPreviewType, error) {
	...
	switch LinkPreviewTypeEnum(objMap["@type"].(string)) {
	case LinkPreviewTypeAlbumType:
		var linkPreviewTypeAlbum LinkPreviewTypeAlbum
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeAlbum)
		return &linkPreviewTypeAlbum, err

	case LinkPreviewTypeAnimationType:
		var linkPreviewTypeAnimation LinkPreviewTypeAnimation
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeAnimation)
		return &linkPreviewTypeAnimation, err

	case LinkPreviewTypeAppType:
		var linkPreviewTypeApp LinkPreviewTypeApp
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeApp)
		return &linkPreviewTypeApp, err

	case LinkPreviewTypeArticleType:
		var linkPreviewTypeArticle LinkPreviewTypeArticle
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeArticle)
		return &linkPreviewTypeArticle, err

	case LinkPreviewTypeAudioType:
		var linkPreviewTypeAudio LinkPreviewTypeAudio
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeAudio)
		return &linkPreviewTypeAudio, err

	case LinkPreviewTypeBackgroundType:
		var linkPreviewTypeBackground LinkPreviewTypeBackground
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeBackground)
		return &linkPreviewTypeBackground, err

	case LinkPreviewTypeChannelBoostType:
		var linkPreviewTypeChannelBoost LinkPreviewTypeChannelBoost
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeChannelBoost)
		return &linkPreviewTypeChannelBoost, err

	case LinkPreviewTypeChatType:
		var linkPreviewTypeChat LinkPreviewTypeChat
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeChat)
		return &linkPreviewTypeChat, err

	case LinkPreviewTypeDocumentType:
		var linkPreviewTypeDocument LinkPreviewTypeDocument
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeDocument)
		return &linkPreviewTypeDocument, err

	case LinkPreviewTypeEmbeddedAnimationPlayerType:
		var linkPreviewTypeEmbeddedAnimationPlayer LinkPreviewTypeEmbeddedAnimationPlayer
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeEmbeddedAnimationPlayer)
		return &linkPreviewTypeEmbeddedAnimationPlayer, err

	case LinkPreviewTypeEmbeddedAudioPlayerType:
		var linkPreviewTypeEmbeddedAudioPlayer LinkPreviewTypeEmbeddedAudioPlayer
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeEmbeddedAudioPlayer)
		return &linkPreviewTypeEmbeddedAudioPlayer, err

	case LinkPreviewTypeEmbeddedVideoPlayerType:
		var linkPreviewTypeEmbeddedVideoPlayer LinkPreviewTypeEmbeddedVideoPlayer
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeEmbeddedVideoPlayer)
		return &linkPreviewTypeEmbeddedVideoPlayer, err

	case LinkPreviewTypeExternalAudioType:
		var linkPreviewTypeExternalAudio LinkPreviewTypeExternalAudio
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeExternalAudio)
		return &linkPreviewTypeExternalAudio, err

	case LinkPreviewTypeExternalVideoType:
		var linkPreviewTypeExternalVideo LinkPreviewTypeExternalVideo
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeExternalVideo)
		return &linkPreviewTypeExternalVideo, err

	case LinkPreviewTypeInvoiceType:
		var linkPreviewTypeInvoice LinkPreviewTypeInvoice
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeInvoice)
		return &linkPreviewTypeInvoice, err

	case LinkPreviewTypeMessageType:
		var linkPreviewTypeMessage LinkPreviewTypeMessage
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeMessage)
		return &linkPreviewTypeMessage, err

	case LinkPreviewTypePhotoType:
		var linkPreviewTypePhoto LinkPreviewTypePhoto
		err := json.Unmarshal(*rawMsg, &linkPreviewTypePhoto)
		return &linkPreviewTypePhoto, err

	case LinkPreviewTypePremiumGiftCodeType:
		var linkPreviewTypePremiumGiftCode LinkPreviewTypePremiumGiftCode
		err := json.Unmarshal(*rawMsg, &linkPreviewTypePremiumGiftCode)
		return &linkPreviewTypePremiumGiftCode, err

	case LinkPreviewTypeShareableChatFolderType:
		var linkPreviewTypeShareableChatFolder LinkPreviewTypeShareableChatFolder
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeShareableChatFolder)
		return &linkPreviewTypeShareableChatFolder, err

	case LinkPreviewTypeStickerType:
		var linkPreviewTypeSticker LinkPreviewTypeSticker
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeSticker)
		return &linkPreviewTypeSticker, err

	case LinkPreviewTypeStickerSetType:
		var linkPreviewTypeStickerSet LinkPreviewTypeStickerSet
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeStickerSet)
		return &linkPreviewTypeStickerSet, err

	case LinkPreviewTypeStoryType:
		var linkPreviewTypeStory LinkPreviewTypeStory
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeStory)
		return &linkPreviewTypeStory, err

	case LinkPreviewTypeSupergroupBoostType:
		var linkPreviewTypeSupergroupBoost LinkPreviewTypeSupergroupBoost
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeSupergroupBoost)
		return &linkPreviewTypeSupergroupBoost, err

	case LinkPreviewTypeThemeType:
		var linkPreviewTypeTheme LinkPreviewTypeTheme
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeTheme)
		return &linkPreviewTypeTheme, err

	case LinkPreviewTypeUnsupportedType:
	...
	case LinkPreviewTypeUserType:
		...
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeUser)
		return &linkPreviewTypeUser, err

	case LinkPreviewTypeVideoType:
		var linkPreviewTypeVideo LinkPreviewTypeVideo
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeVideo)
		return &linkPreviewTypeVideo, err

	case LinkPreviewTypeVideoChatType:
		var linkPreviewTypeVideoChat LinkPreviewTypeVideoChat
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeVideoChat)
		return &linkPreviewTypeVideoChat, err

	case LinkPreviewTypeVideoNoteType:
		var linkPreviewTypeVideoNote LinkPreviewTypeVideoNote
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeVideoNote)
		return &linkPreviewTypeVideoNote, err

	case LinkPreviewTypeVoiceNoteType:
		var linkPreviewTypeVoiceNote LinkPreviewTypeVoiceNote
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeVoiceNote)
		return &linkPreviewTypeVoiceNote, err

	case LinkPreviewTypeWebAppType:
		var linkPreviewTypeWebApp LinkPreviewTypeWebApp
		err := json.Unmarshal(*rawMsg, &linkPreviewTypeWebApp)
		return &linkPreviewTypeWebApp, err
...
func unmarshalLinkPreviewTypeSlice(rawMsg *json.RawMessage) ([]LinkPreviewType, error) {
	objects := make([]LinkPreviewType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case LinkPreviewTypeAlbumType:
			...
			err = json.Unmarshal(obj, &linkPreviewTypeAlbum)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeAlbum)
		case LinkPreviewTypeAnimationType:
			var linkPreviewTypeAnimation LinkPreviewTypeAnimation
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeAnimation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeAnimation)
		case LinkPreviewTypeAppType:
			var linkPreviewTypeApp LinkPreviewTypeApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeApp)
		case LinkPreviewTypeArticleType:
			var linkPreviewTypeArticle LinkPreviewTypeArticle
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeArticle)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeArticle)
		case LinkPreviewTypeAudioType:
			var linkPreviewTypeAudio LinkPreviewTypeAudio
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeAudio)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeAudio)
		case LinkPreviewTypeBackgroundType:
			var linkPreviewTypeBackground LinkPreviewTypeBackground
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeBackground)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeBackground)
		case LinkPreviewTypeChannelBoostType:
			var linkPreviewTypeChannelBoost LinkPreviewTypeChannelBoost
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeChannelBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeChannelBoost)
		case LinkPreviewTypeChatType:
			var linkPreviewTypeChat LinkPreviewTypeChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeChat)
		case LinkPreviewTypeDocumentType:
			var linkPreviewTypeDocument LinkPreviewTypeDocument
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeDocument)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeDocument)
		case LinkPreviewTypeEmbeddedAnimationPlayerType:
			var linkPreviewTypeEmbeddedAnimationPlayer LinkPreviewTypeEmbeddedAnimationPlayer
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeEmbeddedAnimationPlayer)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeEmbeddedAnimationPlayer)
		case LinkPreviewTypeEmbeddedAudioPlayerType:
			var linkPreviewTypeEmbeddedAudioPlayer LinkPreviewTypeEmbeddedAudioPlayer
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeEmbeddedAudioPlayer)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeEmbeddedAudioPlayer)
		case LinkPreviewTypeEmbeddedVideoPlayerType:
			var linkPreviewTypeEmbeddedVideoPlayer LinkPreviewTypeEmbeddedVideoPlayer
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeEmbeddedVideoPlayer)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeEmbeddedVideoPlayer)
		case LinkPreviewTypeExternalAudioType:
			var linkPreviewTypeExternalAudio LinkPreviewTypeExternalAudio
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeExternalAudio)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeExternalAudio)
		case LinkPreviewTypeExternalVideoType:
			var linkPreviewTypeExternalVideo LinkPreviewTypeExternalVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeExternalVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeExternalVideo)
		case LinkPreviewTypeInvoiceType:
			var linkPreviewTypeInvoice LinkPreviewTypeInvoice
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeInvoice)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeInvoice)
		case LinkPreviewTypeMessageType:
			var linkPreviewTypeMessage LinkPreviewTypeMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeMessage)
		case LinkPreviewTypePhotoType:
			var linkPreviewTypePhoto LinkPreviewTypePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypePhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypePhoto)
		case LinkPreviewTypePremiumGiftCodeType:
			var linkPreviewTypePremiumGiftCode LinkPreviewTypePremiumGiftCode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypePremiumGiftCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypePremiumGiftCode)
		case LinkPreviewTypeShareableChatFolderType:
			var linkPreviewTypeShareableChatFolder LinkPreviewTypeShareableChatFolder
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeShareableChatFolder)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeShareableChatFolder)
		case LinkPreviewTypeStickerType:
			var linkPreviewTypeSticker LinkPreviewTypeSticker
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeSticker)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeSticker)
		case LinkPreviewTypeStickerSetType:
			var linkPreviewTypeStickerSet LinkPreviewTypeStickerSet
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeStickerSet)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeStickerSet)
		case LinkPreviewTypeStoryType:
			var linkPreviewTypeStory LinkPreviewTypeStory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeStory)
		case LinkPreviewTypeSupergroupBoostType:
			var linkPreviewTypeSupergroupBoost LinkPreviewTypeSupergroupBoost
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeSupergroupBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeSupergroupBoost)
		case LinkPreviewTypeThemeType:
			var linkPreviewTypeTheme LinkPreviewTypeTheme
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeTheme)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeTheme)
		case LinkPreviewTypeUnsupportedType:
			var linkPreviewTypeUnsupported LinkPreviewTypeUnsupported
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeUnsupported)
			if err != nil {
				return nil, err
			}
		...
		case LinkPreviewTypeUserType:
			...
			err = json.Unmarshal(obj, &linkPreviewTypeUser)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeUser)
		case LinkPreviewTypeVideoType:
			var linkPreviewTypeVideo LinkPreviewTypeVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeVideo)
		case LinkPreviewTypeVideoChatType:
			var linkPreviewTypeVideoChat LinkPreviewTypeVideoChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeVideoChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeVideoChat)
		case LinkPreviewTypeVideoNoteType:
			var linkPreviewTypeVideoNote LinkPreviewTypeVideoNote
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeVideoNote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeVideoNote)
		case LinkPreviewTypeVoiceNoteType:
			var linkPreviewTypeVoiceNote LinkPreviewTypeVoiceNote
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeVoiceNote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeVoiceNote)
		case LinkPreviewTypeWebAppType:
			var linkPreviewTypeWebApp LinkPreviewTypeWebApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &linkPreviewTypeWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &linkPreviewTypeWebApp)
...
type CollectibleItemType interface {
	GetCollectibleItemTypeEnum() CollectibleItemTypeEnum
}

// CollectibleItemTypeEnum Alias for abstract CollectibleItemType 'Sub-Classes', used as constant-enum here
type CollectibleItemTypeEnum string

// CollectibleItemType enums
const (
	CollectibleItemTypeUsernameType    CollectibleItemTypeEnum = "collectibleItemTypeUsername"
	CollectibleItemTypePhoneNumberType CollectibleItemTypeEnum = "collectibleItemTypePhoneNumber"
)

func unmarshalCollectibleItemType(rawMsg *json.RawMessage) (CollectibleItemType, error) {
	...
	switch CollectibleItemTypeEnum(objMap["@type"].(string)) {
	case CollectibleItemTypeUsernameType:
		var collectibleItemTypeUsername CollectibleItemTypeUsername
		err := json.Unmarshal(*rawMsg, &collectibleItemTypeUsername)
		return &collectibleItemTypeUsername, err

	case CollectibleItemTypePhoneNumberType:
		var collectibleItemTypePhoneNumber CollectibleItemTypePhoneNumber
		err := json.Unmarshal(*rawMsg, &collectibleItemTypePhoneNumber)
		return &collectibleItemTypePhoneNumber, err
...
func unmarshalCollectibleItemTypeSlice(rawMsg *json.RawMessage) ([]CollectibleItemType, error) {
	objects := make([]CollectibleItemType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case CollectibleItemTypeUsernameType:
			...
			err = json.Unmarshal(obj, &collectibleItemTypeUsername)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &collectibleItemTypeUsername)
		case CollectibleItemTypePhoneNumberType:
			var collectibleItemTypePhoneNumber CollectibleItemTypePhoneNumber
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &collectibleItemTypePhoneNumber)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &collectibleItemTypePhoneNumber)
...
// PaymentProviderEnum Alias for abstract PaymentProvider 'Sub-Classes', used as constant-enum here
type PaymentProviderEnum string

// PaymentProvider enums
const (
	PaymentProviderSmartGlocalType PaymentProviderEnum = "paymentProviderSmartGlocal"
	PaymentProviderStripeType      PaymentProviderEnum = "paymentProviderStripe"
	PaymentProviderOtherType       PaymentProviderEnum = "paymentProviderOther"
)

func unmarshalPaymentProvider(rawMsg *json.RawMessage) (PaymentProvider, error) {
	...
	switch PaymentProviderEnum(objMap["@type"].(string)) {
	case PaymentProviderSmartGlocalType:
		var paymentProviderSmartGlocal PaymentProviderSmartGlocal
		err := json.Unmarshal(*rawMsg, &paymentProviderSmartGlocal)
		return &paymentProviderSmartGlocal, err

	case PaymentProviderStripeType:
		var paymentProviderStripe PaymentProviderStripe
		err := json.Unmarshal(*rawMsg, &paymentProviderStripe)
		return &paymentProviderStripe, err

	case PaymentProviderOtherType:
		var paymentProviderOther PaymentProviderOther
		err := json.Unmarshal(*rawMsg, &paymentProviderOther)
		return &paymentProviderOther, err
...
func unmarshalPaymentProviderSlice(rawMsg *json.RawMessage) ([]PaymentProvider, error) {
	objects := make([]PaymentProvider, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PaymentProviderSmartGlocalType:
			...
			err = json.Unmarshal(obj, &paymentProviderSmartGlocal)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentProviderSmartGlocal)
		case PaymentProviderStripeType:
			var paymentProviderStripe PaymentProviderStripe
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paymentProviderStripe)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentProviderStripe)
		case PaymentProviderOtherType:
			var paymentProviderOther PaymentProviderOther
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paymentProviderOther)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentProviderOther)
...
type PaymentFormType interface {
	GetPaymentFormTypeEnum() PaymentFormTypeEnum
}

// PaymentFormTypeEnum Alias for abstract PaymentFormType 'Sub-Classes', used as constant-enum here
type PaymentFormTypeEnum string
...
func unmarshalPaymentFormType(rawMsg *json.RawMessage) (PaymentFormType, error) {
	...
	switch PaymentFormTypeEnum(objMap["@type"].(string)) {
	case PaymentFormTypeRegularType:
		var paymentFormTypeRegular PaymentFormTypeRegular
		err := json.Unmarshal(*rawMsg, &paymentFormTypeRegular)
		return &paymentFormTypeRegular, err

	case PaymentFormTypeStarsType:
...
func unmarshalPaymentFormTypeSlice(rawMsg *json.RawMessage) ([]PaymentFormType, error) {
	objects := make([]PaymentFormType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PaymentFormTypeRegularType:
			...
			err = json.Unmarshal(obj, &paymentFormTypeRegular)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentFormTypeRegular)
		case PaymentFormTypeStarsType:
			var paymentFormTypeStars PaymentFormTypeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paymentFormTypeStars)
			if err != nil {
				return nil, err
			}
...
type PaymentReceiptType interface {
	GetPaymentReceiptTypeEnum() PaymentReceiptTypeEnum
}

// PaymentReceiptTypeEnum Alias for abstract PaymentReceiptType 'Sub-Classes', used as constant-enum here
type PaymentReceiptTypeEnum string

// PaymentReceiptType enums
const (
	PaymentReceiptTypeRegularType PaymentReceiptTypeEnum = "paymentReceiptTypeRegular"
	PaymentReceiptTypeStarsType   PaymentReceiptTypeEnum = "paymentReceiptTypeStars"
)

func unmarshalPaymentReceiptType(rawMsg *json.RawMessage) (PaymentReceiptType, error) {
	...
	switch PaymentReceiptTypeEnum(objMap["@type"].(string)) {
	case PaymentReceiptTypeRegularType:
		var paymentReceiptTypeRegular PaymentReceiptTypeRegular
		err := json.Unmarshal(*rawMsg, &paymentReceiptTypeRegular)
		return &paymentReceiptTypeRegular, err

	case PaymentReceiptTypeStarsType:
		var paymentReceiptTypeStars PaymentReceiptTypeStars
		err := json.Unmarshal(*rawMsg, &paymentReceiptTypeStars)
		return &paymentReceiptTypeStars, err
...
func unmarshalPaymentReceiptTypeSlice(rawMsg *json.RawMessage) ([]PaymentReceiptType, error) {
	objects := make([]PaymentReceiptType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PaymentReceiptTypeRegularType:
			...
			err = json.Unmarshal(obj, &paymentReceiptTypeRegular)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentReceiptTypeRegular)
		case PaymentReceiptTypeStarsType:
			var paymentReceiptTypeStars PaymentReceiptTypeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paymentReceiptTypeStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paymentReceiptTypeStars)
...
type InputInvoice interface {
	GetInputInvoiceEnum() InputInvoiceEnum
}

// InputInvoiceEnum Alias for abstract InputInvoice 'Sub-Classes', used as constant-enum here
type InputInvoiceEnum string

// InputInvoice enums
const (
	InputInvoiceMessageType  InputInvoiceEnum = "inputInvoiceMessage"
	InputInvoiceNameType     InputInvoiceEnum = "inputInvoiceName"
	InputInvoiceTelegramType InputInvoiceEnum = "inputInvoiceTelegram"
)

func unmarshalInputInvoice(rawMsg *json.RawMessage) (InputInvoice, error) {
	...
	switch InputInvoiceEnum(objMap["@type"].(string)) {
	case InputInvoiceMessageType:
		var inputInvoiceMessage InputInvoiceMessage
		err := json.Unmarshal(*rawMsg, &inputInvoiceMessage)
		return &inputInvoiceMessage, err

	case InputInvoiceNameType:
		var inputInvoiceName InputInvoiceName
		err := json.Unmarshal(*rawMsg, &inputInvoiceName)
		return &inputInvoiceName, err

	case InputInvoiceTelegramType:
		var inputInvoiceTelegram InputInvoiceTelegram
		err := json.Unmarshal(*rawMsg, &inputInvoiceTelegram)
		return &inputInvoiceTelegram, err
...
func unmarshalInputInvoiceSlice(rawMsg *json.RawMessage) ([]InputInvoice, error) {
	objects := make([]InputInvoice, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InputInvoiceMessageType:
			...
			err = json.Unmarshal(obj, &inputInvoiceMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputInvoiceMessage)
		case InputInvoiceNameType:
			var inputInvoiceName InputInvoiceName
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputInvoiceName)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputInvoiceName)
		case InputInvoiceTelegramType:
			var inputInvoiceTelegram InputInvoiceTelegram
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputInvoiceTelegram)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputInvoiceTelegram)
...
type PaidMedia interface {
	GetPaidMediaEnum() PaidMediaEnum
}

// PaidMediaEnum Alias for abstract PaidMedia 'Sub-Classes', used as constant-enum here
type PaidMediaEnum string

// PaidMedia enums
const (
	PaidMediaPreviewType     PaidMediaEnum = "paidMediaPreview"
	PaidMediaPhotoType       PaidMediaEnum = "paidMediaPhoto"
	PaidMediaVideoType       PaidMediaEnum = "paidMediaVideo"
	PaidMediaUnsupportedType PaidMediaEnum = "paidMediaUnsupported"
)

func unmarshalPaidMedia(rawMsg *json.RawMessage) (PaidMedia, error) {
	...
	switch PaidMediaEnum(objMap["@type"].(string)) {
	case PaidMediaPreviewType:
		var paidMediaPreview PaidMediaPreview
		err := json.Unmarshal(*rawMsg, &paidMediaPreview)
		return &paidMediaPreview, err

	case PaidMediaPhotoType:
		var paidMediaPhoto PaidMediaPhoto
		err := json.Unmarshal(*rawMsg, &paidMediaPhoto)
		return &paidMediaPhoto, err

	case PaidMediaVideoType:
		var paidMediaVideo PaidMediaVideo
		err := json.Unmarshal(*rawMsg, &paidMediaVideo)
		return &paidMediaVideo, err

	case PaidMediaUnsupportedType:
		var paidMediaUnsupported PaidMediaUnsupported
		err := json.Unmarshal(*rawMsg, &paidMediaUnsupported)
		return &paidMediaUnsupported, err
...
func unmarshalPaidMediaSlice(rawMsg *json.RawMessage) ([]PaidMedia, error) {
	objects := make([]PaidMedia, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PaidMediaPreviewType:
			...
			err = json.Unmarshal(obj, &paidMediaPreview)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paidMediaPreview)
		case PaidMediaPhotoType:
			var paidMediaPhoto PaidMediaPhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paidMediaPhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paidMediaPhoto)
		case PaidMediaVideoType:
			var paidMediaVideo PaidMediaVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paidMediaVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paidMediaVideo)
		case PaidMediaUnsupportedType:
			var paidMediaUnsupported PaidMediaUnsupported
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &paidMediaUnsupported)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &paidMediaUnsupported)
...
const (
	...
	MessagePaidMediaType                    MessageContentEnum = "messagePaidMedia"
	...
	MessageExpiredVideoNoteType             MessageContentEnum = "messageExpiredVideoNote"
	MessageExpiredVoiceNoteType             MessageContentEnum = "messageExpiredVoiceNote"
	...
	MessageStoryType                        MessageContentEnum = "messageStory"
	...
	MessageChatSetBackgroundType            MessageContentEnum = "messageChatSetBackground"
	MessageChatSetThemeType                 MessageContentEnum = "messageChatSetTheme"
	MessageChatSetMessageAutoDeleteTimeType MessageContentEnum = "messageChatSetMessageAutoDeleteTime"
	MessageChatBoostType                    MessageContentEnum = "messageChatBoost"
	MessageForumTopicCreatedType            MessageContentEnum = "messageForumTopicCreated"
	MessageForumTopicEditedType             MessageContentEnum = "messageForumTopicEdited"
	MessageForumTopicIsClosedToggledType    MessageContentEnum = "messageForumTopicIsClosedToggled"
	MessageForumTopicIsHiddenToggledType    MessageContentEnum = "messageForumTopicIsHiddenToggled"
	MessageSuggestProfilePhotoType          MessageContentEnum = "messageSuggestProfilePhoto"
	...
	MessagePaymentRefundedType              MessageContentEnum = "messagePaymentRefunded"
	MessageGiftedPremiumType                MessageContentEnum = "messageGiftedPremium"
	MessagePremiumGiftCodeType              MessageContentEnum = "messagePremiumGiftCode"
	MessageGiveawayCreatedType              MessageContentEnum = "messageGiveawayCreated"
	MessageGiveawayType                     MessageContentEnum = "messageGiveaway"
	MessageGiveawayCompletedType            MessageContentEnum = "messageGiveawayCompleted"
	...
	MessageBotWriteAccessAllowedType        MessageContentEnum = "messageBotWriteAccessAllowed"
	MessageWebAppDataSentType               MessageContentEnum = "messageWebAppDataSent"
	MessageWebAppDataReceivedType           MessageContentEnum = "messageWebAppDataReceived"
...
func unmarshalMessageContent(rawMsg *json.RawMessage) (MessageContent, error) {
	...
	case MessagePaidMediaType:
		var messagePaidMedia MessagePaidMedia
		err := json.Unmarshal(*rawMsg, &messagePaidMedia)
		return &messagePaidMedia, err
	...
	case MessageExpiredVideoNoteType:
		var messageExpiredVideoNote MessageExpiredVideoNote
		err := json.Unmarshal(*rawMsg, &messageExpiredVideoNote)
		return &messageExpiredVideoNote, err

	case MessageExpiredVoiceNoteType:
		var messageExpiredVoiceNote MessageExpiredVoiceNote
		err := json.Unmarshal(*rawMsg, &messageExpiredVoiceNote)
		return &messageExpiredVoiceNote, err
	...
	case MessageStoryType:
		var messageStory MessageStory
		err := json.Unmarshal(*rawMsg, &messageStory)
		return &messageStory, err
	...
	case MessageChatSetBackgroundType:
		var messageChatSetBackground MessageChatSetBackground
		err := json.Unmarshal(*rawMsg, &messageChatSetBackground)
		return &messageChatSetBackground, err
	...
	case MessageChatSetMessageAutoDeleteTimeType:
		var messageChatSetMessageAutoDeleteTime MessageChatSetMessageAutoDeleteTime
		err := json.Unmarshal(*rawMsg, &messageChatSetMessageAutoDeleteTime)
		return &messageChatSetMessageAutoDeleteTime, err

	case MessageChatBoostType:
		var messageChatBoost MessageChatBoost
		err := json.Unmarshal(*rawMsg, &messageChatBoost)
		return &messageChatBoost, err

	case MessageForumTopicCreatedType:
		var messageForumTopicCreated MessageForumTopicCreated
		err := json.Unmarshal(*rawMsg, &messageForumTopicCreated)
		return &messageForumTopicCreated, err

	case MessageForumTopicEditedType:
		var messageForumTopicEdited MessageForumTopicEdited
		err := json.Unmarshal(*rawMsg, &messageForumTopicEdited)
		return &messageForumTopicEdited, err

	case MessageForumTopicIsClosedToggledType:
		var messageForumTopicIsClosedToggled MessageForumTopicIsClosedToggled
		err := json.Unmarshal(*rawMsg, &messageForumTopicIsClosedToggled)
		return &messageForumTopicIsClosedToggled, err

	case MessageForumTopicIsHiddenToggledType:
		var messageForumTopicIsHiddenToggled MessageForumTopicIsHiddenToggled
		err := json.Unmarshal(*rawMsg, &messageForumTopicIsHiddenToggled)
		return &messageForumTopicIsHiddenToggled, err

	case MessageSuggestProfilePhotoType:
		var messageSuggestProfilePhoto MessageSuggestProfilePhoto
		err := json.Unmarshal(*rawMsg, &messageSuggestProfilePhoto)
		return &messageSuggestProfilePhoto, err
	...
	case MessagePaymentRefundedType:
		var messagePaymentRefunded MessagePaymentRefunded
		err := json.Unmarshal(*rawMsg, &messagePaymentRefunded)
		return &messagePaymentRefunded, err

	case MessageGiftedPremiumType:
		var messageGiftedPremium MessageGiftedPremium
		err := json.Unmarshal(*rawMsg, &messageGiftedPremium)
		return &messageGiftedPremium, err

	case MessagePremiumGiftCodeType:
		var messagePremiumGiftCode MessagePremiumGiftCode
		err := json.Unmarshal(*rawMsg, &messagePremiumGiftCode)
		return &messagePremiumGiftCode, err

	case MessageGiveawayCreatedType:
		var messageGiveawayCreated MessageGiveawayCreated
		err := json.Unmarshal(*rawMsg, &messageGiveawayCreated)
		return &messageGiveawayCreated, err

	case MessageGiveawayType:
		var messageGiveaway MessageGiveaway
		err := json.Unmarshal(*rawMsg, &messageGiveaway)
		return &messageGiveaway, err

	case MessageGiveawayCompletedType:
		var messageGiveawayCompleted MessageGiveawayCompleted
		err := json.Unmarshal(*rawMsg, &messageGiveawayCompleted)
		return &messageGiveawayCompleted, err

	case MessageGiveawayWinnersType:
		var messageGiveawayWinners MessageGiveawayWinners
		err := json.Unmarshal(*rawMsg, &messageGiveawayWinners)
		return &messageGiveawayWinners, err

	case MessageGiftedStarsType:
		var messageGiftedStars MessageGiftedStars
		err := json.Unmarshal(*rawMsg, &messageGiftedStars)
		return &messageGiftedStars, err

	case MessageGiveawayPrizeStarsType:
	...
	case MessageUsersSharedType:
		var messageUsersShared MessageUsersShared
		err := json.Unmarshal(*rawMsg, &messageUsersShared)
		return &messageUsersShared, err

	case MessageChatSharedType:
		var messageChatShared MessageChatShared
		err := json.Unmarshal(*rawMsg, &messageChatShared)
		return &messageChatShared, err

	case MessageBotWriteAccessAllowedType:
		var messageBotWriteAccessAllowed MessageBotWriteAccessAllowed
		err := json.Unmarshal(*rawMsg, &messageBotWriteAccessAllowed)
		return &messageBotWriteAccessAllowed, err

	case MessageWebAppDataSentType:
		var messageWebAppDataSent MessageWebAppDataSent
		err := json.Unmarshal(*rawMsg, &messageWebAppDataSent)
		return &messageWebAppDataSent, err

	case MessageWebAppDataReceivedType:
		var messageWebAppDataReceived MessageWebAppDataReceived
		err := json.Unmarshal(*rawMsg, &messageWebAppDataReceived)
		return &messageWebAppDataReceived, err
...
func unmarshalMessageContentSlice(rawMsg *json.RawMessage) ([]MessageContent, error) {
	...
	for _, objMap := range objsMap {
		...
		case MessagePaidMediaType:
			...
			err = json.Unmarshal(obj, &messagePaidMedia)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messagePaidMedia)
		case MessagePhotoType:
			var messagePhoto MessagePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case MessageExpiredVideoNoteType:
			...
			err = json.Unmarshal(obj, &messageExpiredVideoNote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageExpiredVideoNote)
		case MessageExpiredVoiceNoteType:
			var messageExpiredVoiceNote MessageExpiredVoiceNote
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageExpiredVoiceNote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageExpiredVoiceNote)
		case MessageLocationType:
			var messageLocation MessageLocation
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case MessageStoryType:
			...
			err = json.Unmarshal(obj, &messageStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageStory)
		case MessageInvoiceType:
			var messageInvoice MessageInvoice
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case MessageChatSetBackgroundType:
			...
			err = json.Unmarshal(obj, &messageChatSetBackground)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageChatSetBackground)
		case MessageChatSetThemeType:
			var messageChatSetTheme MessageChatSetTheme
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case MessageChatSetMessageAutoDeleteTimeType:
			...
			err = json.Unmarshal(obj, &messageChatSetMessageAutoDeleteTime)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageChatSetMessageAutoDeleteTime)
		case MessageChatBoostType:
			var messageChatBoost MessageChatBoost
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageChatBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageChatBoost)
		case MessageForumTopicCreatedType:
			var messageForumTopicCreated MessageForumTopicCreated
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageForumTopicCreated)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageForumTopicCreated)
		case MessageForumTopicEditedType:
			var messageForumTopicEdited MessageForumTopicEdited
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageForumTopicEdited)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageForumTopicEdited)
		case MessageForumTopicIsClosedToggledType:
			var messageForumTopicIsClosedToggled MessageForumTopicIsClosedToggled
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageForumTopicIsClosedToggled)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageForumTopicIsClosedToggled)
		case MessageForumTopicIsHiddenToggledType:
			var messageForumTopicIsHiddenToggled MessageForumTopicIsHiddenToggled
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageForumTopicIsHiddenToggled)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageForumTopicIsHiddenToggled)
		case MessageSuggestProfilePhotoType:
			var messageSuggestProfilePhoto MessageSuggestProfilePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSuggestProfilePhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSuggestProfilePhoto)
		case MessageCustomServiceActionType:
			var messageCustomServiceAction MessageCustomServiceAction
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case MessagePaymentRefundedType:
			...
			err = json.Unmarshal(obj, &messagePaymentRefunded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messagePaymentRefunded)
		case MessageGiftedPremiumType:
			var messageGiftedPremium MessageGiftedPremium
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiftedPremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiftedPremium)
		case MessagePremiumGiftCodeType:
			var messagePremiumGiftCode MessagePremiumGiftCode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messagePremiumGiftCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messagePremiumGiftCode)
		case MessageGiveawayCreatedType:
			var messageGiveawayCreated MessageGiveawayCreated
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiveawayCreated)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiveawayCreated)
		case MessageGiveawayType:
			var messageGiveaway MessageGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiveaway)
		case MessageGiveawayCompletedType:
			var messageGiveawayCompleted MessageGiveawayCompleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiveawayCompleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiveawayCompleted)
		case MessageGiveawayWinnersType:
			var messageGiveawayWinners MessageGiveawayWinners
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiveawayWinners)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiveawayWinners)
		case MessageGiftedStarsType:
			var messageGiftedStars MessageGiftedStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiftedStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageGiftedStars)
		case MessageGiveawayPrizeStarsType:
			var messageGiveawayPrizeStars MessageGiveawayPrizeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageGiveawayPrizeStars)
			if err != nil {
				return nil, err
			}
		...
		case MessageUsersSharedType:
			...
			err = json.Unmarshal(obj, &messageUsersShared)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageUsersShared)
		case MessageChatSharedType:
			var messageChatShared MessageChatShared
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageChatShared)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageChatShared)
		case MessageBotWriteAccessAllowedType:
			var messageBotWriteAccessAllowed MessageBotWriteAccessAllowed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageBotWriteAccessAllowed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageBotWriteAccessAllowed)
		case MessageWebAppDataSentType:
			var messageWebAppDataSent MessageWebAppDataSent
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageWebAppDataSent)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageWebAppDataSent)
		case MessageWebAppDataReceivedType:
			var messageWebAppDataReceived MessageWebAppDataReceived
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageWebAppDataReceived)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageWebAppDataReceived)
		case MessagePassportDataSentType:
			var messagePassportDataSent MessagePassportDataSent
			obj, err := json.Marshal(objMap)
			if err != nil {
...
const (
	...
	TextEntityTypeBlockQuoteType           TextEntityTypeEnum = "textEntityTypeBlockQuote"
	TextEntityTypeExpandableBlockQuoteType TextEntityTypeEnum = "textEntityTypeExpandableBlockQuote"
	...
	TextEntityTypeCustomEmojiType          TextEntityTypeEnum = "textEntityTypeCustomEmoji"
...
func unmarshalTextEntityType(rawMsg *json.RawMessage) (TextEntityType, error) {
	...
	case TextEntityTypeBlockQuoteType:
		var textEntityTypeBlockQuote TextEntityTypeBlockQuote
		err := json.Unmarshal(*rawMsg, &textEntityTypeBlockQuote)
		return &textEntityTypeBlockQuote, err

	case TextEntityTypeExpandableBlockQuoteType:
		var textEntityTypeExpandableBlockQuote TextEntityTypeExpandableBlockQuote
		err := json.Unmarshal(*rawMsg, &textEntityTypeExpandableBlockQuote)
		return &textEntityTypeExpandableBlockQuote, err
	...
	case TextEntityTypeCustomEmojiType:
		var textEntityTypeCustomEmoji TextEntityTypeCustomEmoji
		err := json.Unmarshal(*rawMsg, &textEntityTypeCustomEmoji)
		return &textEntityTypeCustomEmoji, err
...
func unmarshalTextEntityTypeSlice(rawMsg *json.RawMessage) ([]TextEntityType, error) {
	...
	for _, objMap := range objsMap {
		...
		case TextEntityTypeSpoilerType:
			...
			err = json.Unmarshal(obj, &textEntityTypeSpoiler)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &textEntityTypeSpoiler)
		case TextEntityTypeCodeType:
			var textEntityTypeCode TextEntityTypeCode
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case TextEntityTypeBlockQuoteType:
			...
			err = json.Unmarshal(obj, &textEntityTypeBlockQuote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &textEntityTypeBlockQuote)
		case TextEntityTypeExpandableBlockQuoteType:
			var textEntityTypeExpandableBlockQuote TextEntityTypeExpandableBlockQuote
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &textEntityTypeExpandableBlockQuote)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &textEntityTypeExpandableBlockQuote)
		case TextEntityTypeTextURLType:
			var textEntityTypeTextURL TextEntityTypeTextURL
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case TextEntityTypeCustomEmojiType:
			...
			err = json.Unmarshal(obj, &textEntityTypeCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &textEntityTypeCustomEmoji)
		case TextEntityTypeMediaTimestampType:
			var textEntityTypeMediaTimestamp TextEntityTypeMediaTimestamp
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type InputPaidMediaType interface {
	GetInputPaidMediaTypeEnum() InputPaidMediaTypeEnum
}

// InputPaidMediaTypeEnum Alias for abstract InputPaidMediaType 'Sub-Classes', used as constant-enum here
type InputPaidMediaTypeEnum string

// InputPaidMediaType enums
const (
	InputPaidMediaTypePhotoType InputPaidMediaTypeEnum = "inputPaidMediaTypePhoto"
	InputPaidMediaTypeVideoType InputPaidMediaTypeEnum = "inputPaidMediaTypeVideo"
)

func unmarshalInputPaidMediaType(rawMsg *json.RawMessage) (InputPaidMediaType, error) {
	...
	switch InputPaidMediaTypeEnum(objMap["@type"].(string)) {
	case InputPaidMediaTypePhotoType:
		var inputPaidMediaTypePhoto InputPaidMediaTypePhoto
		err := json.Unmarshal(*rawMsg, &inputPaidMediaTypePhoto)
		return &inputPaidMediaTypePhoto, err

	case InputPaidMediaTypeVideoType:
		var inputPaidMediaTypeVideo InputPaidMediaTypeVideo
		err := json.Unmarshal(*rawMsg, &inputPaidMediaTypeVideo)
		return &inputPaidMediaTypeVideo, err
...
func unmarshalInputPaidMediaTypeSlice(rawMsg *json.RawMessage) ([]InputPaidMediaType, error) {
	objects := make([]InputPaidMediaType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InputPaidMediaTypePhotoType:
			...
			err = json.Unmarshal(obj, &inputPaidMediaTypePhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputPaidMediaTypePhoto)
		case InputPaidMediaTypeVideoType:
			var inputPaidMediaTypeVideo InputPaidMediaTypeVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputPaidMediaTypeVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputPaidMediaTypeVideo)
...
type MessageSelfDestructType interface {
	GetMessageSelfDestructTypeEnum() MessageSelfDestructTypeEnum
}

// MessageSelfDestructTypeEnum Alias for abstract MessageSelfDestructType 'Sub-Classes', used as constant-enum here
type MessageSelfDestructTypeEnum string

// MessageSelfDestructType enums
const (
	MessageSelfDestructTypeTimerType       MessageSelfDestructTypeEnum = "messageSelfDestructTypeTimer"
	MessageSelfDestructTypeImmediatelyType MessageSelfDestructTypeEnum = "messageSelfDestructTypeImmediately"
)

func unmarshalMessageSelfDestructType(rawMsg *json.RawMessage) (MessageSelfDestructType, error) {
	...
	switch MessageSelfDestructTypeEnum(objMap["@type"].(string)) {
	case MessageSelfDestructTypeTimerType:
		var messageSelfDestructTypeTimer MessageSelfDestructTypeTimer
		err := json.Unmarshal(*rawMsg, &messageSelfDestructTypeTimer)
		return &messageSelfDestructTypeTimer, err

	case MessageSelfDestructTypeImmediatelyType:
		var messageSelfDestructTypeImmediately MessageSelfDestructTypeImmediately
		err := json.Unmarshal(*rawMsg, &messageSelfDestructTypeImmediately)
		return &messageSelfDestructTypeImmediately, err
...
func unmarshalMessageSelfDestructTypeSlice(rawMsg *json.RawMessage) ([]MessageSelfDestructType, error) {
	objects := make([]MessageSelfDestructType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case MessageSelfDestructTypeTimerType:
			...
			err = json.Unmarshal(obj, &messageSelfDestructTypeTimer)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSelfDestructTypeTimer)
		case MessageSelfDestructTypeImmediatelyType:
			var messageSelfDestructTypeImmediately MessageSelfDestructTypeImmediately
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &messageSelfDestructTypeImmediately)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &messageSelfDestructTypeImmediately)
...
const (
	...
	InputMessagePaidMediaType InputMessageContentEnum = "inputMessagePaidMedia"
	...
	InputMessageStoryType     InputMessageContentEnum = "inputMessageStory"
...
func unmarshalInputMessageContent(rawMsg *json.RawMessage) (InputMessageContent, error) {
	...
	case InputMessagePaidMediaType:
		var inputMessagePaidMedia InputMessagePaidMedia
		err := json.Unmarshal(*rawMsg, &inputMessagePaidMedia)
		return &inputMessagePaidMedia, err
	...
	case InputMessageStoryType:
		var inputMessageStory InputMessageStory
		err := json.Unmarshal(*rawMsg, &inputMessageStory)
		return &inputMessageStory, err
...
func unmarshalInputMessageContentSlice(rawMsg *json.RawMessage) ([]InputMessageContent, error) {
	...
	for _, objMap := range objsMap {
		...
		case InputMessagePaidMediaType:
			...
			err = json.Unmarshal(obj, &inputMessagePaidMedia)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputMessagePaidMedia)
		case InputMessagePhotoType:
			var inputMessagePhoto InputMessagePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InputMessageStoryType:
			...
			err = json.Unmarshal(obj, &inputMessageStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputMessageStory)
		case InputMessageForwardedType:
			var inputMessageForwarded InputMessageForwarded
			obj, err := json.Marshal(objMap)
			if err != nil {
...
const (
	...
	SearchMessagesFilterUnreadReactionType    SearchMessagesFilterEnum = "searchMessagesFilterUnreadReaction"
...
func unmarshalSearchMessagesFilter(rawMsg *json.RawMessage) (SearchMessagesFilter, error) {
	...
	case SearchMessagesFilterUnreadReactionType:
		var searchMessagesFilterUnreadReaction SearchMessagesFilterUnreadReaction
		err := json.Unmarshal(*rawMsg, &searchMessagesFilterUnreadReaction)
		return &searchMessagesFilterUnreadReaction, err
...
func unmarshalSearchMessagesFilterSlice(rawMsg *json.RawMessage) ([]SearchMessagesFilter, error) {
	...
	for _, objMap := range objsMap {
		...
		case SearchMessagesFilterUnreadReactionType:
			...
			err = json.Unmarshal(obj, &searchMessagesFilterUnreadReaction)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &searchMessagesFilterUnreadReaction)
		case SearchMessagesFilterFailedToSendType:
			var searchMessagesFilterFailedToSend SearchMessagesFilterFailedToSend
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type EmojiCategorySource interface {
	GetEmojiCategorySourceEnum() EmojiCategorySourceEnum
}

// EmojiCategorySourceEnum Alias for abstract EmojiCategorySource 'Sub-Classes', used as constant-enum here
type EmojiCategorySourceEnum string

// EmojiCategorySource enums
const (
	EmojiCategorySourceSearchType  EmojiCategorySourceEnum = "emojiCategorySourceSearch"
	EmojiCategorySourcePremiumType EmojiCategorySourceEnum = "emojiCategorySourcePremium"
)

func unmarshalEmojiCategorySource(rawMsg *json.RawMessage) (EmojiCategorySource, error) {
	...
	switch EmojiCategorySourceEnum(objMap["@type"].(string)) {
	case EmojiCategorySourceSearchType:
		var emojiCategorySourceSearch EmojiCategorySourceSearch
		err := json.Unmarshal(*rawMsg, &emojiCategorySourceSearch)
		return &emojiCategorySourceSearch, err

	case EmojiCategorySourcePremiumType:
		var emojiCategorySourcePremium EmojiCategorySourcePremium
		err := json.Unmarshal(*rawMsg, &emojiCategorySourcePremium)
		return &emojiCategorySourcePremium, err
...
func unmarshalEmojiCategorySourceSlice(rawMsg *json.RawMessage) ([]EmojiCategorySource, error) {
	objects := make([]EmojiCategorySource, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case EmojiCategorySourceSearchType:
			...
			err = json.Unmarshal(obj, &emojiCategorySourceSearch)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategorySourceSearch)
		case EmojiCategorySourcePremiumType:
			var emojiCategorySourcePremium EmojiCategorySourcePremium
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emojiCategorySourcePremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategorySourcePremium)
...
type EmojiCategoryType interface {
	GetEmojiCategoryTypeEnum() EmojiCategoryTypeEnum
}

// EmojiCategoryTypeEnum Alias for abstract EmojiCategoryType 'Sub-Classes', used as constant-enum here
type EmojiCategoryTypeEnum string

// EmojiCategoryType enums
const (
	EmojiCategoryTypeDefaultType         EmojiCategoryTypeEnum = "emojiCategoryTypeDefault"
	EmojiCategoryTypeRegularStickersType EmojiCategoryTypeEnum = "emojiCategoryTypeRegularStickers"
	EmojiCategoryTypeEmojiStatusType     EmojiCategoryTypeEnum = "emojiCategoryTypeEmojiStatus"
	EmojiCategoryTypeChatPhotoType       EmojiCategoryTypeEnum = "emojiCategoryTypeChatPhoto"
)

func unmarshalEmojiCategoryType(rawMsg *json.RawMessage) (EmojiCategoryType, error) {
	...
	switch EmojiCategoryTypeEnum(objMap["@type"].(string)) {
	case EmojiCategoryTypeDefaultType:
		var emojiCategoryTypeDefault EmojiCategoryTypeDefault
		err := json.Unmarshal(*rawMsg, &emojiCategoryTypeDefault)
		return &emojiCategoryTypeDefault, err

	case EmojiCategoryTypeRegularStickersType:
		var emojiCategoryTypeRegularStickers EmojiCategoryTypeRegularStickers
		err := json.Unmarshal(*rawMsg, &emojiCategoryTypeRegularStickers)
		return &emojiCategoryTypeRegularStickers, err

	case EmojiCategoryTypeEmojiStatusType:
		var emojiCategoryTypeEmojiStatus EmojiCategoryTypeEmojiStatus
		err := json.Unmarshal(*rawMsg, &emojiCategoryTypeEmojiStatus)
		return &emojiCategoryTypeEmojiStatus, err

	case EmojiCategoryTypeChatPhotoType:
		var emojiCategoryTypeChatPhoto EmojiCategoryTypeChatPhoto
		err := json.Unmarshal(*rawMsg, &emojiCategoryTypeChatPhoto)
		return &emojiCategoryTypeChatPhoto, err
...
func unmarshalEmojiCategoryTypeSlice(rawMsg *json.RawMessage) ([]EmojiCategoryType, error) {
	objects := make([]EmojiCategoryType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case EmojiCategoryTypeDefaultType:
			...
			err = json.Unmarshal(obj, &emojiCategoryTypeDefault)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategoryTypeDefault)
		case EmojiCategoryTypeRegularStickersType:
			var emojiCategoryTypeRegularStickers EmojiCategoryTypeRegularStickers
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emojiCategoryTypeRegularStickers)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategoryTypeRegularStickers)
		case EmojiCategoryTypeEmojiStatusType:
			var emojiCategoryTypeEmojiStatus EmojiCategoryTypeEmojiStatus
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emojiCategoryTypeEmojiStatus)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategoryTypeEmojiStatus)
		case EmojiCategoryTypeChatPhotoType:
			var emojiCategoryTypeChatPhoto EmojiCategoryTypeChatPhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &emojiCategoryTypeChatPhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &emojiCategoryTypeChatPhoto)
...
type StoryAreaType interface {
	GetStoryAreaTypeEnum() StoryAreaTypeEnum
}

// StoryAreaTypeEnum Alias for abstract StoryAreaType 'Sub-Classes', used as constant-enum here
type StoryAreaTypeEnum string

// StoryAreaType enums
const (
	StoryAreaTypeLocationType          StoryAreaTypeEnum = "storyAreaTypeLocation"
	StoryAreaTypeVenueType             StoryAreaTypeEnum = "storyAreaTypeVenue"
	StoryAreaTypeSuggestedReactionType StoryAreaTypeEnum = "storyAreaTypeSuggestedReaction"
...
func unmarshalStoryAreaType(rawMsg *json.RawMessage) (StoryAreaType, error) {
	...
	switch StoryAreaTypeEnum(objMap["@type"].(string)) {
	case StoryAreaTypeLocationType:
		var storyAreaTypeLocation StoryAreaTypeLocation
		err := json.Unmarshal(*rawMsg, &storyAreaTypeLocation)
		return &storyAreaTypeLocation, err

	case StoryAreaTypeVenueType:
		var storyAreaTypeVenue StoryAreaTypeVenue
		err := json.Unmarshal(*rawMsg, &storyAreaTypeVenue)
		return &storyAreaTypeVenue, err

	case StoryAreaTypeSuggestedReactionType:
		var storyAreaTypeSuggestedReaction StoryAreaTypeSuggestedReaction
		err := json.Unmarshal(*rawMsg, &storyAreaTypeSuggestedReaction)
		return &storyAreaTypeSuggestedReaction, err

	case StoryAreaTypeMessageType:
		var storyAreaTypeMessage StoryAreaTypeMessage
		err := json.Unmarshal(*rawMsg, &storyAreaTypeMessage)
		return &storyAreaTypeMessage, err

	case StoryAreaTypeLinkType:
		var storyAreaTypeLink StoryAreaTypeLink
		err := json.Unmarshal(*rawMsg, &storyAreaTypeLink)
		return &storyAreaTypeLink, err

	case StoryAreaTypeWeatherType:
...
func unmarshalStoryAreaTypeSlice(rawMsg *json.RawMessage) ([]StoryAreaType, error) {
	objects := make([]StoryAreaType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryAreaTypeLocationType:
			...
			err = json.Unmarshal(obj, &storyAreaTypeLocation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyAreaTypeLocation)
		case StoryAreaTypeVenueType:
			var storyAreaTypeVenue StoryAreaTypeVenue
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyAreaTypeVenue)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyAreaTypeVenue)
		case StoryAreaTypeSuggestedReactionType:
			var storyAreaTypeSuggestedReaction StoryAreaTypeSuggestedReaction
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyAreaTypeSuggestedReaction)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyAreaTypeSuggestedReaction)
		case StoryAreaTypeMessageType:
			var storyAreaTypeMessage StoryAreaTypeMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyAreaTypeMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyAreaTypeMessage)
		case StoryAreaTypeLinkType:
			var storyAreaTypeLink StoryAreaTypeLink
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyAreaTypeLink)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyAreaTypeLink)
		case StoryAreaTypeWeatherType:
			var storyAreaTypeWeather StoryAreaTypeWeather
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyAreaTypeWeather)
			if err != nil {
				return nil, err
			}
...
type InputStoryAreaType interface {
	GetInputStoryAreaTypeEnum() InputStoryAreaTypeEnum
}

// InputStoryAreaTypeEnum Alias for abstract InputStoryAreaType 'Sub-Classes', used as constant-enum here
type InputStoryAreaTypeEnum string

// InputStoryAreaType enums
const (
	InputStoryAreaTypeLocationType          InputStoryAreaTypeEnum = "inputStoryAreaTypeLocation"
	InputStoryAreaTypeFoundVenueType        InputStoryAreaTypeEnum = "inputStoryAreaTypeFoundVenue"
	InputStoryAreaTypePreviousVenueType     InputStoryAreaTypeEnum = "inputStoryAreaTypePreviousVenue"
	InputStoryAreaTypeSuggestedReactionType InputStoryAreaTypeEnum = "inputStoryAreaTypeSuggestedReaction"
...
func unmarshalInputStoryAreaType(rawMsg *json.RawMessage) (InputStoryAreaType, error) {
	...
	switch InputStoryAreaTypeEnum(objMap["@type"].(string)) {
	case InputStoryAreaTypeLocationType:
		var inputStoryAreaTypeLocation InputStoryAreaTypeLocation
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypeLocation)
		return &inputStoryAreaTypeLocation, err

	case InputStoryAreaTypeFoundVenueType:
		var inputStoryAreaTypeFoundVenue InputStoryAreaTypeFoundVenue
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypeFoundVenue)
		return &inputStoryAreaTypeFoundVenue, err

	case InputStoryAreaTypePreviousVenueType:
		var inputStoryAreaTypePreviousVenue InputStoryAreaTypePreviousVenue
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypePreviousVenue)
		return &inputStoryAreaTypePreviousVenue, err

	case InputStoryAreaTypeSuggestedReactionType:
		var inputStoryAreaTypeSuggestedReaction InputStoryAreaTypeSuggestedReaction
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypeSuggestedReaction)
		return &inputStoryAreaTypeSuggestedReaction, err

	case InputStoryAreaTypeMessageType:
		var inputStoryAreaTypeMessage InputStoryAreaTypeMessage
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypeMessage)
		return &inputStoryAreaTypeMessage, err

	case InputStoryAreaTypeLinkType:
		var inputStoryAreaTypeLink InputStoryAreaTypeLink
		err := json.Unmarshal(*rawMsg, &inputStoryAreaTypeLink)
		return &inputStoryAreaTypeLink, err

	case InputStoryAreaTypeWeatherType:
...
func unmarshalInputStoryAreaTypeSlice(rawMsg *json.RawMessage) ([]InputStoryAreaType, error) {
	objects := make([]InputStoryAreaType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InputStoryAreaTypeLocationType:
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeLocation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypeLocation)
		case InputStoryAreaTypeFoundVenueType:
			var inputStoryAreaTypeFoundVenue InputStoryAreaTypeFoundVenue
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeFoundVenue)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypeFoundVenue)
		case InputStoryAreaTypePreviousVenueType:
			var inputStoryAreaTypePreviousVenue InputStoryAreaTypePreviousVenue
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypePreviousVenue)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypePreviousVenue)
		case InputStoryAreaTypeSuggestedReactionType:
			var inputStoryAreaTypeSuggestedReaction InputStoryAreaTypeSuggestedReaction
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeSuggestedReaction)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypeSuggestedReaction)
		case InputStoryAreaTypeMessageType:
			var inputStoryAreaTypeMessage InputStoryAreaTypeMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypeMessage)
		case InputStoryAreaTypeLinkType:
			var inputStoryAreaTypeLink InputStoryAreaTypeLink
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeLink)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryAreaTypeLink)
		case InputStoryAreaTypeWeatherType:
			var inputStoryAreaTypeWeather InputStoryAreaTypeWeather
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryAreaTypeWeather)
			if err != nil {
				return nil, err
			}
...
type StoryContent interface {
	GetStoryContentEnum() StoryContentEnum
}

// StoryContentEnum Alias for abstract StoryContent 'Sub-Classes', used as constant-enum here
type StoryContentEnum string

// StoryContent enums
const (
	StoryContentPhotoType       StoryContentEnum = "storyContentPhoto"
	StoryContentVideoType       StoryContentEnum = "storyContentVideo"
	StoryContentUnsupportedType StoryContentEnum = "storyContentUnsupported"
)

func unmarshalStoryContent(rawMsg *json.RawMessage) (StoryContent, error) {
	...
	switch StoryContentEnum(objMap["@type"].(string)) {
	case StoryContentPhotoType:
		var storyContentPhoto StoryContentPhoto
		err := json.Unmarshal(*rawMsg, &storyContentPhoto)
		return &storyContentPhoto, err

	case StoryContentVideoType:
		var storyContentVideo StoryContentVideo
		err := json.Unmarshal(*rawMsg, &storyContentVideo)
		return &storyContentVideo, err

	case StoryContentUnsupportedType:
		var storyContentUnsupported StoryContentUnsupported
		err := json.Unmarshal(*rawMsg, &storyContentUnsupported)
		return &storyContentUnsupported, err
...
func unmarshalStoryContentSlice(rawMsg *json.RawMessage) ([]StoryContent, error) {
	objects := make([]StoryContent, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryContentPhotoType:
			...
			err = json.Unmarshal(obj, &storyContentPhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyContentPhoto)
		case StoryContentVideoType:
			var storyContentVideo StoryContentVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyContentVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyContentVideo)
		case StoryContentUnsupportedType:
			var storyContentUnsupported StoryContentUnsupported
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyContentUnsupported)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyContentUnsupported)
...
// InputStoryContent The content of a story to send
type InputStoryContent interface {
	GetInputStoryContentEnum() InputStoryContentEnum
}

// InputStoryContentEnum Alias for abstract InputStoryContent 'Sub-Classes', used as constant-enum here
type InputStoryContentEnum string

// InputStoryContent enums
const (
	InputStoryContentPhotoType InputStoryContentEnum = "inputStoryContentPhoto"
	InputStoryContentVideoType InputStoryContentEnum = "inputStoryContentVideo"
)

func unmarshalInputStoryContent(rawMsg *json.RawMessage) (InputStoryContent, error) {
	...
	switch InputStoryContentEnum(objMap["@type"].(string)) {
	case InputStoryContentPhotoType:
		var inputStoryContentPhoto InputStoryContentPhoto
		err := json.Unmarshal(*rawMsg, &inputStoryContentPhoto)
		return &inputStoryContentPhoto, err

	case InputStoryContentVideoType:
		var inputStoryContentVideo InputStoryContentVideo
		err := json.Unmarshal(*rawMsg, &inputStoryContentVideo)
		return &inputStoryContentVideo, err
...
func unmarshalInputStoryContentSlice(rawMsg *json.RawMessage) ([]InputStoryContent, error) {
	objects := make([]InputStoryContent, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InputStoryContentPhotoType:
			...
			err = json.Unmarshal(obj, &inputStoryContentPhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryContentPhoto)
		case InputStoryContentVideoType:
			var inputStoryContentVideo InputStoryContentVideo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inputStoryContentVideo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputStoryContentVideo)
...
type StoryList interface {
	GetStoryListEnum() StoryListEnum
}

// StoryListEnum Alias for abstract StoryList 'Sub-Classes', used as constant-enum here
type StoryListEnum string

// StoryList enums
const (
	StoryListMainType    StoryListEnum = "storyListMain"
	StoryListArchiveType StoryListEnum = "storyListArchive"
)

func unmarshalStoryList(rawMsg *json.RawMessage) (StoryList, error) {
	...
	switch StoryListEnum(objMap["@type"].(string)) {
	case StoryListMainType:
		var storyListMain StoryListMain
		err := json.Unmarshal(*rawMsg, &storyListMain)
		return &storyListMain, err

	case StoryListArchiveType:
		var storyListArchive StoryListArchive
		err := json.Unmarshal(*rawMsg, &storyListArchive)
		return &storyListArchive, err
...
func unmarshalStoryListSlice(rawMsg *json.RawMessage) ([]StoryList, error) {
	objects := make([]StoryList, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryListMainType:
			...
			err = json.Unmarshal(obj, &storyListMain)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyListMain)
		case StoryListArchiveType:
			var storyListArchive StoryListArchive
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyListArchive)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyListArchive)
...
type StoryOrigin interface {
	GetStoryOriginEnum() StoryOriginEnum
}

// StoryOriginEnum Alias for abstract StoryOrigin 'Sub-Classes', used as constant-enum here
type StoryOriginEnum string

// StoryOrigin enums
const (
	StoryOriginPublicStoryType StoryOriginEnum = "storyOriginPublicStory"
	StoryOriginHiddenUserType  StoryOriginEnum = "storyOriginHiddenUser"
)

func unmarshalStoryOrigin(rawMsg *json.RawMessage) (StoryOrigin, error) {
	...
	switch StoryOriginEnum(objMap["@type"].(string)) {
	case StoryOriginPublicStoryType:
		var storyOriginPublicStory StoryOriginPublicStory
		err := json.Unmarshal(*rawMsg, &storyOriginPublicStory)
		return &storyOriginPublicStory, err

	case StoryOriginHiddenUserType:
		var storyOriginHiddenUser StoryOriginHiddenUser
		err := json.Unmarshal(*rawMsg, &storyOriginHiddenUser)
		return &storyOriginHiddenUser, err
...
func unmarshalStoryOriginSlice(rawMsg *json.RawMessage) ([]StoryOrigin, error) {
	objects := make([]StoryOrigin, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryOriginPublicStoryType:
			...
			err = json.Unmarshal(obj, &storyOriginPublicStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyOriginPublicStory)
		case StoryOriginHiddenUserType:
			var storyOriginHiddenUser StoryOriginHiddenUser
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyOriginHiddenUser)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyOriginHiddenUser)
...
type StoryInteractionType interface {
	GetStoryInteractionTypeEnum() StoryInteractionTypeEnum
}

// StoryInteractionTypeEnum Alias for abstract StoryInteractionType 'Sub-Classes', used as constant-enum here
type StoryInteractionTypeEnum string

// StoryInteractionType enums
const (
	StoryInteractionTypeViewType    StoryInteractionTypeEnum = "storyInteractionTypeView"
	StoryInteractionTypeForwardType StoryInteractionTypeEnum = "storyInteractionTypeForward"
	StoryInteractionTypeRepostType  StoryInteractionTypeEnum = "storyInteractionTypeRepost"
)

func unmarshalStoryInteractionType(rawMsg *json.RawMessage) (StoryInteractionType, error) {
	...
	switch StoryInteractionTypeEnum(objMap["@type"].(string)) {
	case StoryInteractionTypeViewType:
		var storyInteractionTypeView StoryInteractionTypeView
		err := json.Unmarshal(*rawMsg, &storyInteractionTypeView)
		return &storyInteractionTypeView, err

	case StoryInteractionTypeForwardType:
		var storyInteractionTypeForward StoryInteractionTypeForward
		err := json.Unmarshal(*rawMsg, &storyInteractionTypeForward)
		return &storyInteractionTypeForward, err

	case StoryInteractionTypeRepostType:
		var storyInteractionTypeRepost StoryInteractionTypeRepost
		err := json.Unmarshal(*rawMsg, &storyInteractionTypeRepost)
		return &storyInteractionTypeRepost, err
...
func unmarshalStoryInteractionTypeSlice(rawMsg *json.RawMessage) ([]StoryInteractionType, error) {
	objects := make([]StoryInteractionType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryInteractionTypeViewType:
			...
			err = json.Unmarshal(obj, &storyInteractionTypeView)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyInteractionTypeView)
		case StoryInteractionTypeForwardType:
			var storyInteractionTypeForward StoryInteractionTypeForward
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyInteractionTypeForward)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyInteractionTypeForward)
		case StoryInteractionTypeRepostType:
			var storyInteractionTypeRepost StoryInteractionTypeRepost
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyInteractionTypeRepost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyInteractionTypeRepost)
...
type PublicForward interface {
	GetPublicForwardEnum() PublicForwardEnum
}

// PublicForwardEnum Alias for abstract PublicForward 'Sub-Classes', used as constant-enum here
type PublicForwardEnum string

// PublicForward enums
const (
	PublicForwardMessageType PublicForwardEnum = "publicForwardMessage"
	PublicForwardStoryType   PublicForwardEnum = "publicForwardStory"
)

func unmarshalPublicForward(rawMsg *json.RawMessage) (PublicForward, error) {
	...
	switch PublicForwardEnum(objMap["@type"].(string)) {
	case PublicForwardMessageType:
		var publicForwardMessage PublicForwardMessage
		err := json.Unmarshal(*rawMsg, &publicForwardMessage)
		return &publicForwardMessage, err

	case PublicForwardStoryType:
		var publicForwardStory PublicForwardStory
		err := json.Unmarshal(*rawMsg, &publicForwardStory)
		return &publicForwardStory, err
...
func unmarshalPublicForwardSlice(rawMsg *json.RawMessage) ([]PublicForward, error) {
	objects := make([]PublicForward, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PublicForwardMessageType:
			...
			err = json.Unmarshal(obj, &publicForwardMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &publicForwardMessage)
		case PublicForwardStoryType:
			var publicForwardStory PublicForwardStory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &publicForwardStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &publicForwardStory)
...
type ChatBoostSource interface {
	GetChatBoostSourceEnum() ChatBoostSourceEnum
}

// ChatBoostSourceEnum Alias for abstract ChatBoostSource 'Sub-Classes', used as constant-enum here
type ChatBoostSourceEnum string

// ChatBoostSource enums
const (
	ChatBoostSourceGiftCodeType ChatBoostSourceEnum = "chatBoostSourceGiftCode"
	ChatBoostSourceGiveawayType ChatBoostSourceEnum = "chatBoostSourceGiveaway"
	ChatBoostSourcePremiumType  ChatBoostSourceEnum = "chatBoostSourcePremium"
)

func unmarshalChatBoostSource(rawMsg *json.RawMessage) (ChatBoostSource, error) {
	...
	switch ChatBoostSourceEnum(objMap["@type"].(string)) {
	case ChatBoostSourceGiftCodeType:
		var chatBoostSourceGiftCode ChatBoostSourceGiftCode
		err := json.Unmarshal(*rawMsg, &chatBoostSourceGiftCode)
		return &chatBoostSourceGiftCode, err

	case ChatBoostSourceGiveawayType:
		var chatBoostSourceGiveaway ChatBoostSourceGiveaway
		err := json.Unmarshal(*rawMsg, &chatBoostSourceGiveaway)
		return &chatBoostSourceGiveaway, err

	case ChatBoostSourcePremiumType:
		var chatBoostSourcePremium ChatBoostSourcePremium
		err := json.Unmarshal(*rawMsg, &chatBoostSourcePremium)
		return &chatBoostSourcePremium, err
...
func unmarshalChatBoostSourceSlice(rawMsg *json.RawMessage) ([]ChatBoostSource, error) {
	objects := make([]ChatBoostSource, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ChatBoostSourceGiftCodeType:
			...
			err = json.Unmarshal(obj, &chatBoostSourceGiftCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatBoostSourceGiftCode)
		case ChatBoostSourceGiveawayType:
			var chatBoostSourceGiveaway ChatBoostSourceGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatBoostSourceGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatBoostSourceGiveaway)
		case ChatBoostSourcePremiumType:
			var chatBoostSourcePremium ChatBoostSourcePremium
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatBoostSourcePremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatBoostSourcePremium)
...
type ResendCodeReason interface {
	GetResendCodeReasonEnum() ResendCodeReasonEnum
}

// ResendCodeReasonEnum Alias for abstract ResendCodeReason 'Sub-Classes', used as constant-enum here
type ResendCodeReasonEnum string

// ResendCodeReason enums
const (
	ResendCodeReasonUserRequestType        ResendCodeReasonEnum = "resendCodeReasonUserRequest"
	ResendCodeReasonVerificationFailedType ResendCodeReasonEnum = "resendCodeReasonVerificationFailed"
)

func unmarshalResendCodeReason(rawMsg *json.RawMessage) (ResendCodeReason, error) {
	...
	switch ResendCodeReasonEnum(objMap["@type"].(string)) {
	case ResendCodeReasonUserRequestType:
		var resendCodeReasonUserRequest ResendCodeReasonUserRequest
		err := json.Unmarshal(*rawMsg, &resendCodeReasonUserRequest)
		return &resendCodeReasonUserRequest, err

	case ResendCodeReasonVerificationFailedType:
		var resendCodeReasonVerificationFailed ResendCodeReasonVerificationFailed
		err := json.Unmarshal(*rawMsg, &resendCodeReasonVerificationFailed)
		return &resendCodeReasonVerificationFailed, err
...
func unmarshalResendCodeReasonSlice(rawMsg *json.RawMessage) ([]ResendCodeReason, error) {
	objects := make([]ResendCodeReason, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ResendCodeReasonUserRequestType:
			...
			err = json.Unmarshal(obj, &resendCodeReasonUserRequest)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &resendCodeReasonUserRequest)
		case ResendCodeReasonVerificationFailedType:
			var resendCodeReasonVerificationFailed ResendCodeReasonVerificationFailed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &resendCodeReasonVerificationFailed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &resendCodeReasonVerificationFailed)
...
type FirebaseAuthenticationSettings interface {
	GetFirebaseAuthenticationSettingsEnum() FirebaseAuthenticationSettingsEnum
}

// FirebaseAuthenticationSettingsEnum Alias for abstract FirebaseAuthenticationSettings 'Sub-Classes', used as constant-enum here
type FirebaseAuthenticationSettingsEnum string

// FirebaseAuthenticationSettings enums
const (
	FirebaseAuthenticationSettingsAndroidType FirebaseAuthenticationSettingsEnum = "firebaseAuthenticationSettingsAndroid"
	FirebaseAuthenticationSettingsIosType     FirebaseAuthenticationSettingsEnum = "firebaseAuthenticationSettingsIos"
)

func unmarshalFirebaseAuthenticationSettings(rawMsg *json.RawMessage) (FirebaseAuthenticationSettings, error) {
	...
	switch FirebaseAuthenticationSettingsEnum(objMap["@type"].(string)) {
	case FirebaseAuthenticationSettingsAndroidType:
		var firebaseAuthenticationSettingsAndroid FirebaseAuthenticationSettingsAndroid
		err := json.Unmarshal(*rawMsg, &firebaseAuthenticationSettingsAndroid)
		return &firebaseAuthenticationSettingsAndroid, err

	case FirebaseAuthenticationSettingsIosType:
		var firebaseAuthenticationSettingsIos FirebaseAuthenticationSettingsIos
		err := json.Unmarshal(*rawMsg, &firebaseAuthenticationSettingsIos)
		return &firebaseAuthenticationSettingsIos, err
...
func unmarshalFirebaseAuthenticationSettingsSlice(rawMsg *json.RawMessage) ([]FirebaseAuthenticationSettings, error) {
	objects := make([]FirebaseAuthenticationSettings, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case FirebaseAuthenticationSettingsAndroidType:
			...
			err = json.Unmarshal(obj, &firebaseAuthenticationSettingsAndroid)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &firebaseAuthenticationSettingsAndroid)
		case FirebaseAuthenticationSettingsIosType:
			var firebaseAuthenticationSettingsIos FirebaseAuthenticationSettingsIos
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &firebaseAuthenticationSettingsIos)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &firebaseAuthenticationSettingsIos)
...
type ReactionUnavailabilityReason interface {
	GetReactionUnavailabilityReasonEnum() ReactionUnavailabilityReasonEnum
}

// ReactionUnavailabilityReasonEnum Alias for abstract ReactionUnavailabilityReason 'Sub-Classes', used as constant-enum here
type ReactionUnavailabilityReasonEnum string

// ReactionUnavailabilityReason enums
const (
	ReactionUnavailabilityReasonAnonymousAdministratorType ReactionUnavailabilityReasonEnum = "reactionUnavailabilityReasonAnonymousAdministrator"
	ReactionUnavailabilityReasonGuestType                  ReactionUnavailabilityReasonEnum = "reactionUnavailabilityReasonGuest"
)

func unmarshalReactionUnavailabilityReason(rawMsg *json.RawMessage) (ReactionUnavailabilityReason, error) {
	...
	switch ReactionUnavailabilityReasonEnum(objMap["@type"].(string)) {
	case ReactionUnavailabilityReasonAnonymousAdministratorType:
		var reactionUnavailabilityReasonAnonymousAdministrator ReactionUnavailabilityReasonAnonymousAdministrator
		err := json.Unmarshal(*rawMsg, &reactionUnavailabilityReasonAnonymousAdministrator)
		return &reactionUnavailabilityReasonAnonymousAdministrator, err

	case ReactionUnavailabilityReasonGuestType:
		var reactionUnavailabilityReasonGuest ReactionUnavailabilityReasonGuest
		err := json.Unmarshal(*rawMsg, &reactionUnavailabilityReasonGuest)
		return &reactionUnavailabilityReasonGuest, err
...
func unmarshalReactionUnavailabilityReasonSlice(rawMsg *json.RawMessage) ([]ReactionUnavailabilityReason, error) {
	objects := make([]ReactionUnavailabilityReason, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ReactionUnavailabilityReasonAnonymousAdministratorType:
			...
			err = json.Unmarshal(obj, &reactionUnavailabilityReasonAnonymousAdministrator)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionUnavailabilityReasonAnonymousAdministrator)
		case ReactionUnavailabilityReasonGuestType:
			var reactionUnavailabilityReasonGuest ReactionUnavailabilityReasonGuest
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reactionUnavailabilityReasonGuest)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reactionUnavailabilityReasonGuest)
...
type SpeechRecognitionResult interface {
	GetSpeechRecognitionResultEnum() SpeechRecognitionResultEnum
}

// SpeechRecognitionResultEnum Alias for abstract SpeechRecognitionResult 'Sub-Classes', used as constant-enum here
type SpeechRecognitionResultEnum string

// SpeechRecognitionResult enums
const (
	SpeechRecognitionResultPendingType SpeechRecognitionResultEnum = "speechRecognitionResultPending"
	SpeechRecognitionResultTextType    SpeechRecognitionResultEnum = "speechRecognitionResultText"
	SpeechRecognitionResultErrorType   SpeechRecognitionResultEnum = "speechRecognitionResultError"
)

func unmarshalSpeechRecognitionResult(rawMsg *json.RawMessage) (SpeechRecognitionResult, error) {
	...
	switch SpeechRecognitionResultEnum(objMap["@type"].(string)) {
	case SpeechRecognitionResultPendingType:
		var speechRecognitionResultPending SpeechRecognitionResultPending
		err := json.Unmarshal(*rawMsg, &speechRecognitionResultPending)
		return &speechRecognitionResultPending, err

	case SpeechRecognitionResultTextType:
		var speechRecognitionResultText SpeechRecognitionResultText
		err := json.Unmarshal(*rawMsg, &speechRecognitionResultText)
		return &speechRecognitionResultText, err

	case SpeechRecognitionResultErrorType:
		var speechRecognitionResultError SpeechRecognitionResultError
		err := json.Unmarshal(*rawMsg, &speechRecognitionResultError)
		return &speechRecognitionResultError, err
...
func unmarshalSpeechRecognitionResultSlice(rawMsg *json.RawMessage) ([]SpeechRecognitionResult, error) {
	objects := make([]SpeechRecognitionResult, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case SpeechRecognitionResultPendingType:
			...
			err = json.Unmarshal(obj, &speechRecognitionResultPending)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &speechRecognitionResultPending)
		case SpeechRecognitionResultTextType:
			var speechRecognitionResultText SpeechRecognitionResultText
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &speechRecognitionResultText)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &speechRecognitionResultText)
		case SpeechRecognitionResultErrorType:
			var speechRecognitionResultError SpeechRecognitionResultError
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &speechRecognitionResultError)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &speechRecognitionResultError)
...
type BotWriteAccessAllowReason interface {
	GetBotWriteAccessAllowReasonEnum() BotWriteAccessAllowReasonEnum
}

// BotWriteAccessAllowReasonEnum Alias for abstract BotWriteAccessAllowReason 'Sub-Classes', used as constant-enum here
type BotWriteAccessAllowReasonEnum string

// BotWriteAccessAllowReason enums
const (
	BotWriteAccessAllowReasonConnectedWebsiteType      BotWriteAccessAllowReasonEnum = "botWriteAccessAllowReasonConnectedWebsite"
	BotWriteAccessAllowReasonAddedToAttachmentMenuType BotWriteAccessAllowReasonEnum = "botWriteAccessAllowReasonAddedToAttachmentMenu"
	BotWriteAccessAllowReasonLaunchedWebAppType        BotWriteAccessAllowReasonEnum = "botWriteAccessAllowReasonLaunchedWebApp"
	BotWriteAccessAllowReasonAcceptedRequestType       BotWriteAccessAllowReasonEnum = "botWriteAccessAllowReasonAcceptedRequest"
)

func unmarshalBotWriteAccessAllowReason(rawMsg *json.RawMessage) (BotWriteAccessAllowReason, error) {
	...
	switch BotWriteAccessAllowReasonEnum(objMap["@type"].(string)) {
	case BotWriteAccessAllowReasonConnectedWebsiteType:
		var botWriteAccessAllowReasonConnectedWebsite BotWriteAccessAllowReasonConnectedWebsite
		err := json.Unmarshal(*rawMsg, &botWriteAccessAllowReasonConnectedWebsite)
		return &botWriteAccessAllowReasonConnectedWebsite, err

	case BotWriteAccessAllowReasonAddedToAttachmentMenuType:
		var botWriteAccessAllowReasonAddedToAttachmentMenu BotWriteAccessAllowReasonAddedToAttachmentMenu
		err := json.Unmarshal(*rawMsg, &botWriteAccessAllowReasonAddedToAttachmentMenu)
		return &botWriteAccessAllowReasonAddedToAttachmentMenu, err

	case BotWriteAccessAllowReasonLaunchedWebAppType:
		var botWriteAccessAllowReasonLaunchedWebApp BotWriteAccessAllowReasonLaunchedWebApp
		err := json.Unmarshal(*rawMsg, &botWriteAccessAllowReasonLaunchedWebApp)
		return &botWriteAccessAllowReasonLaunchedWebApp, err

	case BotWriteAccessAllowReasonAcceptedRequestType:
		var botWriteAccessAllowReasonAcceptedRequest BotWriteAccessAllowReasonAcceptedRequest
		err := json.Unmarshal(*rawMsg, &botWriteAccessAllowReasonAcceptedRequest)
		return &botWriteAccessAllowReasonAcceptedRequest, err
...
func unmarshalBotWriteAccessAllowReasonSlice(rawMsg *json.RawMessage) ([]BotWriteAccessAllowReason, error) {
	objects := make([]BotWriteAccessAllowReason, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case BotWriteAccessAllowReasonConnectedWebsiteType:
			...
			err = json.Unmarshal(obj, &botWriteAccessAllowReasonConnectedWebsite)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &botWriteAccessAllowReasonConnectedWebsite)
		case BotWriteAccessAllowReasonAddedToAttachmentMenuType:
			var botWriteAccessAllowReasonAddedToAttachmentMenu BotWriteAccessAllowReasonAddedToAttachmentMenu
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &botWriteAccessAllowReasonAddedToAttachmentMenu)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &botWriteAccessAllowReasonAddedToAttachmentMenu)
		case BotWriteAccessAllowReasonLaunchedWebAppType:
			var botWriteAccessAllowReasonLaunchedWebApp BotWriteAccessAllowReasonLaunchedWebApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &botWriteAccessAllowReasonLaunchedWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &botWriteAccessAllowReasonLaunchedWebApp)
		case BotWriteAccessAllowReasonAcceptedRequestType:
			var botWriteAccessAllowReasonAcceptedRequest BotWriteAccessAllowReasonAcceptedRequest
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &botWriteAccessAllowReasonAcceptedRequest)
			if err != nil {
				return nil, err
			}
...
type InlineQueryResultsButtonType interface {
	GetInlineQueryResultsButtonTypeEnum() InlineQueryResultsButtonTypeEnum
}

// InlineQueryResultsButtonTypeEnum Alias for abstract InlineQueryResultsButtonType 'Sub-Classes', used as constant-enum here
type InlineQueryResultsButtonTypeEnum string

// InlineQueryResultsButtonType enums
const (
	InlineQueryResultsButtonTypeStartBotType InlineQueryResultsButtonTypeEnum = "inlineQueryResultsButtonTypeStartBot"
	InlineQueryResultsButtonTypeWebAppType   InlineQueryResultsButtonTypeEnum = "inlineQueryResultsButtonTypeWebApp"
)

func unmarshalInlineQueryResultsButtonType(rawMsg *json.RawMessage) (InlineQueryResultsButtonType, error) {
	...
	switch InlineQueryResultsButtonTypeEnum(objMap["@type"].(string)) {
	case InlineQueryResultsButtonTypeStartBotType:
		var inlineQueryResultsButtonTypeStartBot InlineQueryResultsButtonTypeStartBot
		err := json.Unmarshal(*rawMsg, &inlineQueryResultsButtonTypeStartBot)
		return &inlineQueryResultsButtonTypeStartBot, err

	case InlineQueryResultsButtonTypeWebAppType:
		var inlineQueryResultsButtonTypeWebApp InlineQueryResultsButtonTypeWebApp
		err := json.Unmarshal(*rawMsg, &inlineQueryResultsButtonTypeWebApp)
		return &inlineQueryResultsButtonTypeWebApp, err
...
func unmarshalInlineQueryResultsButtonTypeSlice(rawMsg *json.RawMessage) ([]InlineQueryResultsButtonType, error) {
	objects := make([]InlineQueryResultsButtonType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case InlineQueryResultsButtonTypeStartBotType:
			...
			err = json.Unmarshal(obj, &inlineQueryResultsButtonTypeStartBot)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inlineQueryResultsButtonTypeStartBot)
		case InlineQueryResultsButtonTypeWebAppType:
			var inlineQueryResultsButtonTypeWebApp InlineQueryResultsButtonTypeWebApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &inlineQueryResultsButtonTypeWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inlineQueryResultsButtonTypeWebApp)
...
const (
	...
	ChatEventMemberSubscriptionExtendedType             ChatEventActionEnum = "chatEventMemberSubscriptionExtended"
	ChatEventAvailableReactionsChangedType              ChatEventActionEnum = "chatEventAvailableReactionsChanged"
	ChatEventBackgroundChangedType                      ChatEventActionEnum = "chatEventBackgroundChanged"
	ChatEventDescriptionChangedType                     ChatEventActionEnum = "chatEventDescriptionChanged"
	ChatEventEmojiStatusChangedType                     ChatEventActionEnum = "chatEventEmojiStatusChanged"
	...
	ChatEventMessageAutoDeleteTimeChangedType           ChatEventActionEnum = "chatEventMessageAutoDeleteTimeChanged"
	...
	ChatEventCustomEmojiStickerSetChangedType           ChatEventActionEnum = "chatEventCustomEmojiStickerSetChanged"
	...
	ChatEventActiveUsernamesChangedType                 ChatEventActionEnum = "chatEventActiveUsernamesChanged"
	ChatEventAccentColorChangedType                     ChatEventActionEnum = "chatEventAccentColorChanged"
	ChatEventProfileAccentColorChangedType              ChatEventActionEnum = "chatEventProfileAccentColorChanged"
	...
	ChatEventHasAggressiveAntiSpamEnabledToggledType    ChatEventActionEnum = "chatEventHasAggressiveAntiSpamEnabledToggled"
	ChatEventSignMessagesToggledType                    ChatEventActionEnum = "chatEventSignMessagesToggled"
	ChatEventShowMessageSenderToggledType               ChatEventActionEnum = "chatEventShowMessageSenderToggled"
	...
	ChatEventIsForumToggledType                         ChatEventActionEnum = "chatEventIsForumToggled"
	ChatEventForumTopicCreatedType                      ChatEventActionEnum = "chatEventForumTopicCreated"
	ChatEventForumTopicEditedType                       ChatEventActionEnum = "chatEventForumTopicEdited"
	ChatEventForumTopicToggleIsClosedType               ChatEventActionEnum = "chatEventForumTopicToggleIsClosed"
	ChatEventForumTopicToggleIsHiddenType               ChatEventActionEnum = "chatEventForumTopicToggleIsHidden"
	ChatEventForumTopicDeletedType                      ChatEventActionEnum = "chatEventForumTopicDeleted"
	ChatEventForumTopicPinnedType                       ChatEventActionEnum = "chatEventForumTopicPinned"
)
...
func unmarshalChatEventAction(rawMsg *json.RawMessage) (ChatEventAction, error) {
	...
	case ChatEventMemberSubscriptionExtendedType:
		var chatEventMemberSubscriptionExtended ChatEventMemberSubscriptionExtended
		err := json.Unmarshal(*rawMsg, &chatEventMemberSubscriptionExtended)
		return &chatEventMemberSubscriptionExtended, err

	case ChatEventAvailableReactionsChangedType:
		var chatEventAvailableReactionsChanged ChatEventAvailableReactionsChanged
		err := json.Unmarshal(*rawMsg, &chatEventAvailableReactionsChanged)
		return &chatEventAvailableReactionsChanged, err

	case ChatEventBackgroundChangedType:
		var chatEventBackgroundChanged ChatEventBackgroundChanged
		err := json.Unmarshal(*rawMsg, &chatEventBackgroundChanged)
		return &chatEventBackgroundChanged, err
	...
	case ChatEventEmojiStatusChangedType:
		var chatEventEmojiStatusChanged ChatEventEmojiStatusChanged
		err := json.Unmarshal(*rawMsg, &chatEventEmojiStatusChanged)
		return &chatEventEmojiStatusChanged, err
	...
	case ChatEventMessageAutoDeleteTimeChangedType:
		var chatEventMessageAutoDeleteTimeChanged ChatEventMessageAutoDeleteTimeChanged
		err := json.Unmarshal(*rawMsg, &chatEventMessageAutoDeleteTimeChanged)
		return &chatEventMessageAutoDeleteTimeChanged, err
	...
	case ChatEventCustomEmojiStickerSetChangedType:
		var chatEventCustomEmojiStickerSetChanged ChatEventCustomEmojiStickerSetChanged
		err := json.Unmarshal(*rawMsg, &chatEventCustomEmojiStickerSetChanged)
		return &chatEventCustomEmojiStickerSetChanged, err
	...
	case ChatEventActiveUsernamesChangedType:
		var chatEventActiveUsernamesChanged ChatEventActiveUsernamesChanged
		err := json.Unmarshal(*rawMsg, &chatEventActiveUsernamesChanged)
		return &chatEventActiveUsernamesChanged, err

	case ChatEventAccentColorChangedType:
		var chatEventAccentColorChanged ChatEventAccentColorChanged
		err := json.Unmarshal(*rawMsg, &chatEventAccentColorChanged)
		return &chatEventAccentColorChanged, err

	case ChatEventProfileAccentColorChangedType:
		var chatEventProfileAccentColorChanged ChatEventProfileAccentColorChanged
		err := json.Unmarshal(*rawMsg, &chatEventProfileAccentColorChanged)
		return &chatEventProfileAccentColorChanged, err
	...
	case ChatEventHasAggressiveAntiSpamEnabledToggledType:
		var chatEventHasAggressiveAntiSpamEnabledToggled ChatEventHasAggressiveAntiSpamEnabledToggled
		err := json.Unmarshal(*rawMsg, &chatEventHasAggressiveAntiSpamEnabledToggled)
		return &chatEventHasAggressiveAntiSpamEnabledToggled, err
	...
	case ChatEventShowMessageSenderToggledType:
		var chatEventShowMessageSenderToggled ChatEventShowMessageSenderToggled
		err := json.Unmarshal(*rawMsg, &chatEventShowMessageSenderToggled)
		return &chatEventShowMessageSenderToggled, err
	...
	case ChatEventIsForumToggledType:
		var chatEventIsForumToggled ChatEventIsForumToggled
		err := json.Unmarshal(*rawMsg, &chatEventIsForumToggled)
		return &chatEventIsForumToggled, err

	case ChatEventForumTopicCreatedType:
		var chatEventForumTopicCreated ChatEventForumTopicCreated
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicCreated)
		return &chatEventForumTopicCreated, err

	case ChatEventForumTopicEditedType:
		var chatEventForumTopicEdited ChatEventForumTopicEdited
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicEdited)
		return &chatEventForumTopicEdited, err

	case ChatEventForumTopicToggleIsClosedType:
		var chatEventForumTopicToggleIsClosed ChatEventForumTopicToggleIsClosed
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicToggleIsClosed)
		return &chatEventForumTopicToggleIsClosed, err

	case ChatEventForumTopicToggleIsHiddenType:
		var chatEventForumTopicToggleIsHidden ChatEventForumTopicToggleIsHidden
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicToggleIsHidden)
		return &chatEventForumTopicToggleIsHidden, err

	case ChatEventForumTopicDeletedType:
		var chatEventForumTopicDeleted ChatEventForumTopicDeleted
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicDeleted)
		return &chatEventForumTopicDeleted, err

	case ChatEventForumTopicPinnedType:
		var chatEventForumTopicPinned ChatEventForumTopicPinned
		err := json.Unmarshal(*rawMsg, &chatEventForumTopicPinned)
		return &chatEventForumTopicPinned, err
...
func unmarshalChatEventActionSlice(rawMsg *json.RawMessage) ([]ChatEventAction, error) {
	...
	for _, objMap := range objsMap {
		...
		case ChatEventMemberSubscriptionExtendedType:
			...
			err = json.Unmarshal(obj, &chatEventMemberSubscriptionExtended)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventMemberSubscriptionExtended)
		case ChatEventAvailableReactionsChangedType:
			var chatEventAvailableReactionsChanged ChatEventAvailableReactionsChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventAvailableReactionsChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventAvailableReactionsChanged)
		case ChatEventBackgroundChangedType:
			var chatEventBackgroundChanged ChatEventBackgroundChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventBackgroundChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventBackgroundChanged)
		case ChatEventDescriptionChangedType:
			var chatEventDescriptionChanged ChatEventDescriptionChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventEmojiStatusChangedType:
			...
			err = json.Unmarshal(obj, &chatEventEmojiStatusChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventEmojiStatusChanged)
		case ChatEventLinkedChatChangedType:
			var chatEventLinkedChatChanged ChatEventLinkedChatChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventMessageAutoDeleteTimeChangedType:
			...
			err = json.Unmarshal(obj, &chatEventMessageAutoDeleteTimeChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventMessageAutoDeleteTimeChanged)
		case ChatEventPermissionsChangedType:
			var chatEventPermissionsChanged ChatEventPermissionsChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventCustomEmojiStickerSetChangedType:
			...
			err = json.Unmarshal(obj, &chatEventCustomEmojiStickerSetChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventCustomEmojiStickerSetChanged)
		case ChatEventTitleChangedType:
			var chatEventTitleChanged ChatEventTitleChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventActiveUsernamesChangedType:
			...
			err = json.Unmarshal(obj, &chatEventActiveUsernamesChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventActiveUsernamesChanged)
		case ChatEventAccentColorChangedType:
			var chatEventAccentColorChanged ChatEventAccentColorChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventAccentColorChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventAccentColorChanged)
		case ChatEventProfileAccentColorChangedType:
			var chatEventProfileAccentColorChanged ChatEventProfileAccentColorChanged
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventProfileAccentColorChanged)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventProfileAccentColorChanged)
		case ChatEventHasProtectedContentToggledType:
			var chatEventHasProtectedContentToggled ChatEventHasProtectedContentToggled
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventHasAggressiveAntiSpamEnabledToggledType:
			...
			err = json.Unmarshal(obj, &chatEventHasAggressiveAntiSpamEnabledToggled)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventHasAggressiveAntiSpamEnabledToggled)
		case ChatEventSignMessagesToggledType:
			var chatEventSignMessagesToggled ChatEventSignMessagesToggled
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventShowMessageSenderToggledType:
			...
			err = json.Unmarshal(obj, &chatEventShowMessageSenderToggled)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventShowMessageSenderToggled)
		case ChatEventInviteLinkEditedType:
			var chatEventInviteLinkEdited ChatEventInviteLinkEdited
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case ChatEventIsForumToggledType:
			...
			err = json.Unmarshal(obj, &chatEventIsForumToggled)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventIsForumToggled)
		case ChatEventForumTopicCreatedType:
			var chatEventForumTopicCreated ChatEventForumTopicCreated
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicCreated)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicCreated)
		case ChatEventForumTopicEditedType:
			var chatEventForumTopicEdited ChatEventForumTopicEdited
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicEdited)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicEdited)
		case ChatEventForumTopicToggleIsClosedType:
			var chatEventForumTopicToggleIsClosed ChatEventForumTopicToggleIsClosed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicToggleIsClosed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicToggleIsClosed)
		case ChatEventForumTopicToggleIsHiddenType:
			var chatEventForumTopicToggleIsHidden ChatEventForumTopicToggleIsHidden
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicToggleIsHidden)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicToggleIsHidden)
		case ChatEventForumTopicDeletedType:
			var chatEventForumTopicDeleted ChatEventForumTopicDeleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicDeleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicDeleted)
		case ChatEventForumTopicPinnedType:
			var chatEventForumTopicPinned ChatEventForumTopicPinned
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatEventForumTopicPinned)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatEventForumTopicPinned)
...
type PremiumLimitType interface {
	GetPremiumLimitTypeEnum() PremiumLimitTypeEnum
}

// PremiumLimitTypeEnum Alias for abstract PremiumLimitType 'Sub-Classes', used as constant-enum here
type PremiumLimitTypeEnum string

// PremiumLimitType enums
const (
	PremiumLimitTypeSupergroupCountType                 PremiumLimitTypeEnum = "premiumLimitTypeSupergroupCount"
	PremiumLimitTypePinnedChatCountType                 PremiumLimitTypeEnum = "premiumLimitTypePinnedChatCount"
	PremiumLimitTypeCreatedPublicChatCountType          PremiumLimitTypeEnum = "premiumLimitTypeCreatedPublicChatCount"
	PremiumLimitTypeSavedAnimationCountType             PremiumLimitTypeEnum = "premiumLimitTypeSavedAnimationCount"
	PremiumLimitTypeFavoriteStickerCountType            PremiumLimitTypeEnum = "premiumLimitTypeFavoriteStickerCount"
	PremiumLimitTypeChatFolderCountType                 PremiumLimitTypeEnum = "premiumLimitTypeChatFolderCount"
	PremiumLimitTypeChatFolderChosenChatCountType       PremiumLimitTypeEnum = "premiumLimitTypeChatFolderChosenChatCount"
	PremiumLimitTypePinnedArchivedChatCountType         PremiumLimitTypeEnum = "premiumLimitTypePinnedArchivedChatCount"
	PremiumLimitTypePinnedSavedMessagesTopicCountType   PremiumLimitTypeEnum = "premiumLimitTypePinnedSavedMessagesTopicCount"
	PremiumLimitTypeCaptionLengthType                   PremiumLimitTypeEnum = "premiumLimitTypeCaptionLength"
	PremiumLimitTypeBioLengthType                       PremiumLimitTypeEnum = "premiumLimitTypeBioLength"
	PremiumLimitTypeChatFolderInviteLinkCountType       PremiumLimitTypeEnum = "premiumLimitTypeChatFolderInviteLinkCount"
	PremiumLimitTypeShareableChatFolderCountType        PremiumLimitTypeEnum = "premiumLimitTypeShareableChatFolderCount"
	PremiumLimitTypeActiveStoryCountType                PremiumLimitTypeEnum = "premiumLimitTypeActiveStoryCount"
	PremiumLimitTypeWeeklySentStoryCountType            PremiumLimitTypeEnum = "premiumLimitTypeWeeklySentStoryCount"
	PremiumLimitTypeMonthlySentStoryCountType           PremiumLimitTypeEnum = "premiumLimitTypeMonthlySentStoryCount"
	PremiumLimitTypeStoryCaptionLengthType              PremiumLimitTypeEnum = "premiumLimitTypeStoryCaptionLength"
	PremiumLimitTypeStorySuggestedReactionAreaCountType PremiumLimitTypeEnum = "premiumLimitTypeStorySuggestedReactionAreaCount"
	PremiumLimitTypeSimilarChatCountType                PremiumLimitTypeEnum = "premiumLimitTypeSimilarChatCount"
)

func unmarshalPremiumLimitType(rawMsg *json.RawMessage) (PremiumLimitType, error) {
	...
	switch PremiumLimitTypeEnum(objMap["@type"].(string)) {
	case PremiumLimitTypeSupergroupCountType:
		var premiumLimitTypeSupergroupCount PremiumLimitTypeSupergroupCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeSupergroupCount)
		return &premiumLimitTypeSupergroupCount, err

	case PremiumLimitTypePinnedChatCountType:
		var premiumLimitTypePinnedChatCount PremiumLimitTypePinnedChatCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypePinnedChatCount)
		return &premiumLimitTypePinnedChatCount, err

	case PremiumLimitTypeCreatedPublicChatCountType:
		var premiumLimitTypeCreatedPublicChatCount PremiumLimitTypeCreatedPublicChatCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeCreatedPublicChatCount)
		return &premiumLimitTypeCreatedPublicChatCount, err

	case PremiumLimitTypeSavedAnimationCountType:
		var premiumLimitTypeSavedAnimationCount PremiumLimitTypeSavedAnimationCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeSavedAnimationCount)
		return &premiumLimitTypeSavedAnimationCount, err

	case PremiumLimitTypeFavoriteStickerCountType:
		var premiumLimitTypeFavoriteStickerCount PremiumLimitTypeFavoriteStickerCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeFavoriteStickerCount)
		return &premiumLimitTypeFavoriteStickerCount, err

	case PremiumLimitTypeChatFolderCountType:
		var premiumLimitTypeChatFolderCount PremiumLimitTypeChatFolderCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeChatFolderCount)
		return &premiumLimitTypeChatFolderCount, err

	case PremiumLimitTypeChatFolderChosenChatCountType:
		var premiumLimitTypeChatFolderChosenChatCount PremiumLimitTypeChatFolderChosenChatCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeChatFolderChosenChatCount)
		return &premiumLimitTypeChatFolderChosenChatCount, err

	case PremiumLimitTypePinnedArchivedChatCountType:
		var premiumLimitTypePinnedArchivedChatCount PremiumLimitTypePinnedArchivedChatCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypePinnedArchivedChatCount)
		return &premiumLimitTypePinnedArchivedChatCount, err

	case PremiumLimitTypePinnedSavedMessagesTopicCountType:
		var premiumLimitTypePinnedSavedMessagesTopicCount PremiumLimitTypePinnedSavedMessagesTopicCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypePinnedSavedMessagesTopicCount)
		return &premiumLimitTypePinnedSavedMessagesTopicCount, err

	case PremiumLimitTypeCaptionLengthType:
		var premiumLimitTypeCaptionLength PremiumLimitTypeCaptionLength
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeCaptionLength)
		return &premiumLimitTypeCaptionLength, err

	case PremiumLimitTypeBioLengthType:
		var premiumLimitTypeBioLength PremiumLimitTypeBioLength
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeBioLength)
		return &premiumLimitTypeBioLength, err

	case PremiumLimitTypeChatFolderInviteLinkCountType:
		var premiumLimitTypeChatFolderInviteLinkCount PremiumLimitTypeChatFolderInviteLinkCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeChatFolderInviteLinkCount)
		return &premiumLimitTypeChatFolderInviteLinkCount, err

	case PremiumLimitTypeShareableChatFolderCountType:
		var premiumLimitTypeShareableChatFolderCount PremiumLimitTypeShareableChatFolderCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeShareableChatFolderCount)
		return &premiumLimitTypeShareableChatFolderCount, err

	case PremiumLimitTypeActiveStoryCountType:
		var premiumLimitTypeActiveStoryCount PremiumLimitTypeActiveStoryCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeActiveStoryCount)
		return &premiumLimitTypeActiveStoryCount, err

	case PremiumLimitTypeWeeklySentStoryCountType:
		var premiumLimitTypeWeeklySentStoryCount PremiumLimitTypeWeeklySentStoryCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeWeeklySentStoryCount)
		return &premiumLimitTypeWeeklySentStoryCount, err

	case PremiumLimitTypeMonthlySentStoryCountType:
		var premiumLimitTypeMonthlySentStoryCount PremiumLimitTypeMonthlySentStoryCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeMonthlySentStoryCount)
		return &premiumLimitTypeMonthlySentStoryCount, err

	case PremiumLimitTypeStoryCaptionLengthType:
		var premiumLimitTypeStoryCaptionLength PremiumLimitTypeStoryCaptionLength
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeStoryCaptionLength)
		return &premiumLimitTypeStoryCaptionLength, err

	case PremiumLimitTypeStorySuggestedReactionAreaCountType:
		var premiumLimitTypeStorySuggestedReactionAreaCount PremiumLimitTypeStorySuggestedReactionAreaCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeStorySuggestedReactionAreaCount)
		return &premiumLimitTypeStorySuggestedReactionAreaCount, err

	case PremiumLimitTypeSimilarChatCountType:
		var premiumLimitTypeSimilarChatCount PremiumLimitTypeSimilarChatCount
		err := json.Unmarshal(*rawMsg, &premiumLimitTypeSimilarChatCount)
		return &premiumLimitTypeSimilarChatCount, err
...
func unmarshalPremiumLimitTypeSlice(rawMsg *json.RawMessage) ([]PremiumLimitType, error) {
	objects := make([]PremiumLimitType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PremiumLimitTypeSupergroupCountType:
			...
			err = json.Unmarshal(obj, &premiumLimitTypeSupergroupCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeSupergroupCount)
		case PremiumLimitTypePinnedChatCountType:
			var premiumLimitTypePinnedChatCount PremiumLimitTypePinnedChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypePinnedChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypePinnedChatCount)
		case PremiumLimitTypeCreatedPublicChatCountType:
			var premiumLimitTypeCreatedPublicChatCount PremiumLimitTypeCreatedPublicChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeCreatedPublicChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeCreatedPublicChatCount)
		case PremiumLimitTypeSavedAnimationCountType:
			var premiumLimitTypeSavedAnimationCount PremiumLimitTypeSavedAnimationCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeSavedAnimationCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeSavedAnimationCount)
		case PremiumLimitTypeFavoriteStickerCountType:
			var premiumLimitTypeFavoriteStickerCount PremiumLimitTypeFavoriteStickerCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeFavoriteStickerCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeFavoriteStickerCount)
		case PremiumLimitTypeChatFolderCountType:
			var premiumLimitTypeChatFolderCount PremiumLimitTypeChatFolderCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeChatFolderCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeChatFolderCount)
		case PremiumLimitTypeChatFolderChosenChatCountType:
			var premiumLimitTypeChatFolderChosenChatCount PremiumLimitTypeChatFolderChosenChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeChatFolderChosenChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeChatFolderChosenChatCount)
		case PremiumLimitTypePinnedArchivedChatCountType:
			var premiumLimitTypePinnedArchivedChatCount PremiumLimitTypePinnedArchivedChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypePinnedArchivedChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypePinnedArchivedChatCount)
		case PremiumLimitTypePinnedSavedMessagesTopicCountType:
			var premiumLimitTypePinnedSavedMessagesTopicCount PremiumLimitTypePinnedSavedMessagesTopicCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypePinnedSavedMessagesTopicCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypePinnedSavedMessagesTopicCount)
		case PremiumLimitTypeCaptionLengthType:
			var premiumLimitTypeCaptionLength PremiumLimitTypeCaptionLength
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeCaptionLength)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeCaptionLength)
		case PremiumLimitTypeBioLengthType:
			var premiumLimitTypeBioLength PremiumLimitTypeBioLength
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeBioLength)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeBioLength)
		case PremiumLimitTypeChatFolderInviteLinkCountType:
			var premiumLimitTypeChatFolderInviteLinkCount PremiumLimitTypeChatFolderInviteLinkCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeChatFolderInviteLinkCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeChatFolderInviteLinkCount)
		case PremiumLimitTypeShareableChatFolderCountType:
			var premiumLimitTypeShareableChatFolderCount PremiumLimitTypeShareableChatFolderCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeShareableChatFolderCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeShareableChatFolderCount)
		case PremiumLimitTypeActiveStoryCountType:
			var premiumLimitTypeActiveStoryCount PremiumLimitTypeActiveStoryCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeActiveStoryCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeActiveStoryCount)
		case PremiumLimitTypeWeeklySentStoryCountType:
			var premiumLimitTypeWeeklySentStoryCount PremiumLimitTypeWeeklySentStoryCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeWeeklySentStoryCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeWeeklySentStoryCount)
		case PremiumLimitTypeMonthlySentStoryCountType:
			var premiumLimitTypeMonthlySentStoryCount PremiumLimitTypeMonthlySentStoryCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeMonthlySentStoryCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeMonthlySentStoryCount)
		case PremiumLimitTypeStoryCaptionLengthType:
			var premiumLimitTypeStoryCaptionLength PremiumLimitTypeStoryCaptionLength
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeStoryCaptionLength)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeStoryCaptionLength)
		case PremiumLimitTypeStorySuggestedReactionAreaCountType:
			var premiumLimitTypeStorySuggestedReactionAreaCount PremiumLimitTypeStorySuggestedReactionAreaCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeStorySuggestedReactionAreaCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeStorySuggestedReactionAreaCount)
		case PremiumLimitTypeSimilarChatCountType:
			var premiumLimitTypeSimilarChatCount PremiumLimitTypeSimilarChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumLimitTypeSimilarChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumLimitTypeSimilarChatCount)
...
type PremiumFeature interface {
	GetPremiumFeatureEnum() PremiumFeatureEnum
}

// PremiumFeatureEnum Alias for abstract PremiumFeature 'Sub-Classes', used as constant-enum here
type PremiumFeatureEnum string

// PremiumFeature enums
const (
	PremiumFeatureIncreasedLimitsType         PremiumFeatureEnum = "premiumFeatureIncreasedLimits"
	PremiumFeatureIncreasedUploadFileSizeType PremiumFeatureEnum = "premiumFeatureIncreasedUploadFileSize"
	PremiumFeatureImprovedDownloadSpeedType   PremiumFeatureEnum = "premiumFeatureImprovedDownloadSpeed"
	PremiumFeatureVoiceRecognitionType        PremiumFeatureEnum = "premiumFeatureVoiceRecognition"
	PremiumFeatureDisabledAdsType             PremiumFeatureEnum = "premiumFeatureDisabledAds"
	PremiumFeatureUniqueReactionsType         PremiumFeatureEnum = "premiumFeatureUniqueReactions"
	PremiumFeatureUniqueStickersType          PremiumFeatureEnum = "premiumFeatureUniqueStickers"
	PremiumFeatureCustomEmojiType             PremiumFeatureEnum = "premiumFeatureCustomEmoji"
	PremiumFeatureAdvancedChatManagementType  PremiumFeatureEnum = "premiumFeatureAdvancedChatManagement"
	PremiumFeatureProfileBadgeType            PremiumFeatureEnum = "premiumFeatureProfileBadge"
	PremiumFeatureEmojiStatusType             PremiumFeatureEnum = "premiumFeatureEmojiStatus"
	PremiumFeatureAnimatedProfilePhotoType    PremiumFeatureEnum = "premiumFeatureAnimatedProfilePhoto"
	PremiumFeatureForumTopicIconType          PremiumFeatureEnum = "premiumFeatureForumTopicIcon"
	PremiumFeatureAppIconsType                PremiumFeatureEnum = "premiumFeatureAppIcons"
	PremiumFeatureRealTimeChatTranslationType PremiumFeatureEnum = "premiumFeatureRealTimeChatTranslation"
	PremiumFeatureUpgradedStoriesType         PremiumFeatureEnum = "premiumFeatureUpgradedStories"
	PremiumFeatureChatBoostType               PremiumFeatureEnum = "premiumFeatureChatBoost"
	PremiumFeatureAccentColorType             PremiumFeatureEnum = "premiumFeatureAccentColor"
	PremiumFeatureBackgroundForBothType       PremiumFeatureEnum = "premiumFeatureBackgroundForBoth"
	PremiumFeatureSavedMessagesTagsType       PremiumFeatureEnum = "premiumFeatureSavedMessagesTags"
	PremiumFeatureMessagePrivacyType          PremiumFeatureEnum = "premiumFeatureMessagePrivacy"
	PremiumFeatureLastSeenTimesType           PremiumFeatureEnum = "premiumFeatureLastSeenTimes"
	PremiumFeatureBusinessType                PremiumFeatureEnum = "premiumFeatureBusiness"
	PremiumFeatureMessageEffectsType          PremiumFeatureEnum = "premiumFeatureMessageEffects"
)

func unmarshalPremiumFeature(rawMsg *json.RawMessage) (PremiumFeature, error) {
	...
	switch PremiumFeatureEnum(objMap["@type"].(string)) {
	case PremiumFeatureIncreasedLimitsType:
		var premiumFeatureIncreasedLimits PremiumFeatureIncreasedLimits
		err := json.Unmarshal(*rawMsg, &premiumFeatureIncreasedLimits)
		return &premiumFeatureIncreasedLimits, err

	case PremiumFeatureIncreasedUploadFileSizeType:
		var premiumFeatureIncreasedUploadFileSize PremiumFeatureIncreasedUploadFileSize
		err := json.Unmarshal(*rawMsg, &premiumFeatureIncreasedUploadFileSize)
		return &premiumFeatureIncreasedUploadFileSize, err

	case PremiumFeatureImprovedDownloadSpeedType:
		var premiumFeatureImprovedDownloadSpeed PremiumFeatureImprovedDownloadSpeed
		err := json.Unmarshal(*rawMsg, &premiumFeatureImprovedDownloadSpeed)
		return &premiumFeatureImprovedDownloadSpeed, err

	case PremiumFeatureVoiceRecognitionType:
		var premiumFeatureVoiceRecognition PremiumFeatureVoiceRecognition
		err := json.Unmarshal(*rawMsg, &premiumFeatureVoiceRecognition)
		return &premiumFeatureVoiceRecognition, err

	case PremiumFeatureDisabledAdsType:
		var premiumFeatureDisabledAds PremiumFeatureDisabledAds
		err := json.Unmarshal(*rawMsg, &premiumFeatureDisabledAds)
		return &premiumFeatureDisabledAds, err

	case PremiumFeatureUniqueReactionsType:
		var premiumFeatureUniqueReactions PremiumFeatureUniqueReactions
		err := json.Unmarshal(*rawMsg, &premiumFeatureUniqueReactions)
		return &premiumFeatureUniqueReactions, err

	case PremiumFeatureUniqueStickersType:
		var premiumFeatureUniqueStickers PremiumFeatureUniqueStickers
		err := json.Unmarshal(*rawMsg, &premiumFeatureUniqueStickers)
		return &premiumFeatureUniqueStickers, err

	case PremiumFeatureCustomEmojiType:
		var premiumFeatureCustomEmoji PremiumFeatureCustomEmoji
		err := json.Unmarshal(*rawMsg, &premiumFeatureCustomEmoji)
		return &premiumFeatureCustomEmoji, err

	case PremiumFeatureAdvancedChatManagementType:
		var premiumFeatureAdvancedChatManagement PremiumFeatureAdvancedChatManagement
		err := json.Unmarshal(*rawMsg, &premiumFeatureAdvancedChatManagement)
		return &premiumFeatureAdvancedChatManagement, err

	case PremiumFeatureProfileBadgeType:
		var premiumFeatureProfileBadge PremiumFeatureProfileBadge
		err := json.Unmarshal(*rawMsg, &premiumFeatureProfileBadge)
		return &premiumFeatureProfileBadge, err

	case PremiumFeatureEmojiStatusType:
		var premiumFeatureEmojiStatus PremiumFeatureEmojiStatus
		err := json.Unmarshal(*rawMsg, &premiumFeatureEmojiStatus)
		return &premiumFeatureEmojiStatus, err

	case PremiumFeatureAnimatedProfilePhotoType:
		var premiumFeatureAnimatedProfilePhoto PremiumFeatureAnimatedProfilePhoto
		err := json.Unmarshal(*rawMsg, &premiumFeatureAnimatedProfilePhoto)
		return &premiumFeatureAnimatedProfilePhoto, err

	case PremiumFeatureForumTopicIconType:
		var premiumFeatureForumTopicIcon PremiumFeatureForumTopicIcon
		err := json.Unmarshal(*rawMsg, &premiumFeatureForumTopicIcon)
		return &premiumFeatureForumTopicIcon, err

	case PremiumFeatureAppIconsType:
		var premiumFeatureAppIcons PremiumFeatureAppIcons
		err := json.Unmarshal(*rawMsg, &premiumFeatureAppIcons)
		return &premiumFeatureAppIcons, err

	case PremiumFeatureRealTimeChatTranslationType:
		var premiumFeatureRealTimeChatTranslation PremiumFeatureRealTimeChatTranslation
		err := json.Unmarshal(*rawMsg, &premiumFeatureRealTimeChatTranslation)
		return &premiumFeatureRealTimeChatTranslation, err

	case PremiumFeatureUpgradedStoriesType:
		var premiumFeatureUpgradedStories PremiumFeatureUpgradedStories
		err := json.Unmarshal(*rawMsg, &premiumFeatureUpgradedStories)
		return &premiumFeatureUpgradedStories, err

	case PremiumFeatureChatBoostType:
		var premiumFeatureChatBoost PremiumFeatureChatBoost
		err := json.Unmarshal(*rawMsg, &premiumFeatureChatBoost)
		return &premiumFeatureChatBoost, err

	case PremiumFeatureAccentColorType:
		var premiumFeatureAccentColor PremiumFeatureAccentColor
		err := json.Unmarshal(*rawMsg, &premiumFeatureAccentColor)
		return &premiumFeatureAccentColor, err

	case PremiumFeatureBackgroundForBothType:
		var premiumFeatureBackgroundForBoth PremiumFeatureBackgroundForBoth
		err := json.Unmarshal(*rawMsg, &premiumFeatureBackgroundForBoth)
		return &premiumFeatureBackgroundForBoth, err

	case PremiumFeatureSavedMessagesTagsType:
		var premiumFeatureSavedMessagesTags PremiumFeatureSavedMessagesTags
		err := json.Unmarshal(*rawMsg, &premiumFeatureSavedMessagesTags)
		return &premiumFeatureSavedMessagesTags, err

	case PremiumFeatureMessagePrivacyType:
		var premiumFeatureMessagePrivacy PremiumFeatureMessagePrivacy
		err := json.Unmarshal(*rawMsg, &premiumFeatureMessagePrivacy)
		return &premiumFeatureMessagePrivacy, err

	case PremiumFeatureLastSeenTimesType:
		var premiumFeatureLastSeenTimes PremiumFeatureLastSeenTimes
		err := json.Unmarshal(*rawMsg, &premiumFeatureLastSeenTimes)
		return &premiumFeatureLastSeenTimes, err

	case PremiumFeatureBusinessType:
		var premiumFeatureBusiness PremiumFeatureBusiness
		err := json.Unmarshal(*rawMsg, &premiumFeatureBusiness)
		return &premiumFeatureBusiness, err

	case PremiumFeatureMessageEffectsType:
		var premiumFeatureMessageEffects PremiumFeatureMessageEffects
		err := json.Unmarshal(*rawMsg, &premiumFeatureMessageEffects)
		return &premiumFeatureMessageEffects, err
...
func unmarshalPremiumFeatureSlice(rawMsg *json.RawMessage) ([]PremiumFeature, error) {
	objects := make([]PremiumFeature, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PremiumFeatureIncreasedLimitsType:
			...
			err = json.Unmarshal(obj, &premiumFeatureIncreasedLimits)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureIncreasedLimits)
		case PremiumFeatureIncreasedUploadFileSizeType:
			var premiumFeatureIncreasedUploadFileSize PremiumFeatureIncreasedUploadFileSize
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureIncreasedUploadFileSize)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureIncreasedUploadFileSize)
		case PremiumFeatureImprovedDownloadSpeedType:
			var premiumFeatureImprovedDownloadSpeed PremiumFeatureImprovedDownloadSpeed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureImprovedDownloadSpeed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureImprovedDownloadSpeed)
		case PremiumFeatureVoiceRecognitionType:
			var premiumFeatureVoiceRecognition PremiumFeatureVoiceRecognition
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureVoiceRecognition)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureVoiceRecognition)
		case PremiumFeatureDisabledAdsType:
			var premiumFeatureDisabledAds PremiumFeatureDisabledAds
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureDisabledAds)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureDisabledAds)
		case PremiumFeatureUniqueReactionsType:
			var premiumFeatureUniqueReactions PremiumFeatureUniqueReactions
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureUniqueReactions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureUniqueReactions)
		case PremiumFeatureUniqueStickersType:
			var premiumFeatureUniqueStickers PremiumFeatureUniqueStickers
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureUniqueStickers)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureUniqueStickers)
		case PremiumFeatureCustomEmojiType:
			var premiumFeatureCustomEmoji PremiumFeatureCustomEmoji
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureCustomEmoji)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureCustomEmoji)
		case PremiumFeatureAdvancedChatManagementType:
			var premiumFeatureAdvancedChatManagement PremiumFeatureAdvancedChatManagement
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureAdvancedChatManagement)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureAdvancedChatManagement)
		case PremiumFeatureProfileBadgeType:
			var premiumFeatureProfileBadge PremiumFeatureProfileBadge
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureProfileBadge)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureProfileBadge)
		case PremiumFeatureEmojiStatusType:
			var premiumFeatureEmojiStatus PremiumFeatureEmojiStatus
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureEmojiStatus)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureEmojiStatus)
		case PremiumFeatureAnimatedProfilePhotoType:
			var premiumFeatureAnimatedProfilePhoto PremiumFeatureAnimatedProfilePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureAnimatedProfilePhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureAnimatedProfilePhoto)
		case PremiumFeatureForumTopicIconType:
			var premiumFeatureForumTopicIcon PremiumFeatureForumTopicIcon
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureForumTopicIcon)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureForumTopicIcon)
		case PremiumFeatureAppIconsType:
			var premiumFeatureAppIcons PremiumFeatureAppIcons
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureAppIcons)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureAppIcons)
		case PremiumFeatureRealTimeChatTranslationType:
			var premiumFeatureRealTimeChatTranslation PremiumFeatureRealTimeChatTranslation
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureRealTimeChatTranslation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureRealTimeChatTranslation)
		case PremiumFeatureUpgradedStoriesType:
			var premiumFeatureUpgradedStories PremiumFeatureUpgradedStories
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureUpgradedStories)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureUpgradedStories)
		case PremiumFeatureChatBoostType:
			var premiumFeatureChatBoost PremiumFeatureChatBoost
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureChatBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureChatBoost)
		case PremiumFeatureAccentColorType:
			var premiumFeatureAccentColor PremiumFeatureAccentColor
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureAccentColor)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureAccentColor)
		case PremiumFeatureBackgroundForBothType:
			var premiumFeatureBackgroundForBoth PremiumFeatureBackgroundForBoth
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureBackgroundForBoth)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureBackgroundForBoth)
		case PremiumFeatureSavedMessagesTagsType:
			var premiumFeatureSavedMessagesTags PremiumFeatureSavedMessagesTags
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureSavedMessagesTags)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureSavedMessagesTags)
		case PremiumFeatureMessagePrivacyType:
			var premiumFeatureMessagePrivacy PremiumFeatureMessagePrivacy
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureMessagePrivacy)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureMessagePrivacy)
		case PremiumFeatureLastSeenTimesType:
			var premiumFeatureLastSeenTimes PremiumFeatureLastSeenTimes
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureLastSeenTimes)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureLastSeenTimes)
		case PremiumFeatureBusinessType:
			var premiumFeatureBusiness PremiumFeatureBusiness
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureBusiness)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureBusiness)
		case PremiumFeatureMessageEffectsType:
			var premiumFeatureMessageEffects PremiumFeatureMessageEffects
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumFeatureMessageEffects)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumFeatureMessageEffects)
...
type BusinessFeature interface {
	GetBusinessFeatureEnum() BusinessFeatureEnum
}

// BusinessFeatureEnum Alias for abstract BusinessFeature 'Sub-Classes', used as constant-enum here
type BusinessFeatureEnum string

// BusinessFeature enums
const (
	BusinessFeatureLocationType        BusinessFeatureEnum = "businessFeatureLocation"
	BusinessFeatureOpeningHoursType    BusinessFeatureEnum = "businessFeatureOpeningHours"
	BusinessFeatureQuickRepliesType    BusinessFeatureEnum = "businessFeatureQuickReplies"
	BusinessFeatureGreetingMessageType BusinessFeatureEnum = "businessFeatureGreetingMessage"
	BusinessFeatureAwayMessageType     BusinessFeatureEnum = "businessFeatureAwayMessage"
	BusinessFeatureAccountLinksType    BusinessFeatureEnum = "businessFeatureAccountLinks"
	BusinessFeatureStartPageType       BusinessFeatureEnum = "businessFeatureStartPage"
	BusinessFeatureBotsType            BusinessFeatureEnum = "businessFeatureBots"
	BusinessFeatureEmojiStatusType     BusinessFeatureEnum = "businessFeatureEmojiStatus"
	BusinessFeatureChatFolderTagsType  BusinessFeatureEnum = "businessFeatureChatFolderTags"
	BusinessFeatureUpgradedStoriesType BusinessFeatureEnum = "businessFeatureUpgradedStories"
)

func unmarshalBusinessFeature(rawMsg *json.RawMessage) (BusinessFeature, error) {
	...
	switch BusinessFeatureEnum(objMap["@type"].(string)) {
	case BusinessFeatureLocationType:
		var businessFeatureLocation BusinessFeatureLocation
		err := json.Unmarshal(*rawMsg, &businessFeatureLocation)
		return &businessFeatureLocation, err

	case BusinessFeatureOpeningHoursType:
		var businessFeatureOpeningHours BusinessFeatureOpeningHours
		err := json.Unmarshal(*rawMsg, &businessFeatureOpeningHours)
		return &businessFeatureOpeningHours, err

	case BusinessFeatureQuickRepliesType:
		var businessFeatureQuickReplies BusinessFeatureQuickReplies
		err := json.Unmarshal(*rawMsg, &businessFeatureQuickReplies)
		return &businessFeatureQuickReplies, err

	case BusinessFeatureGreetingMessageType:
		var businessFeatureGreetingMessage BusinessFeatureGreetingMessage
		err := json.Unmarshal(*rawMsg, &businessFeatureGreetingMessage)
		return &businessFeatureGreetingMessage, err

	case BusinessFeatureAwayMessageType:
		var businessFeatureAwayMessage BusinessFeatureAwayMessage
		err := json.Unmarshal(*rawMsg, &businessFeatureAwayMessage)
		return &businessFeatureAwayMessage, err

	case BusinessFeatureAccountLinksType:
		var businessFeatureAccountLinks BusinessFeatureAccountLinks
		err := json.Unmarshal(*rawMsg, &businessFeatureAccountLinks)
		return &businessFeatureAccountLinks, err

	case BusinessFeatureStartPageType:
		var businessFeatureStartPage BusinessFeatureStartPage
		err := json.Unmarshal(*rawMsg, &businessFeatureStartPage)
		return &businessFeatureStartPage, err

	case BusinessFeatureBotsType:
		var businessFeatureBots BusinessFeatureBots
		err := json.Unmarshal(*rawMsg, &businessFeatureBots)
		return &businessFeatureBots, err

	case BusinessFeatureEmojiStatusType:
		var businessFeatureEmojiStatus BusinessFeatureEmojiStatus
		err := json.Unmarshal(*rawMsg, &businessFeatureEmojiStatus)
		return &businessFeatureEmojiStatus, err

	case BusinessFeatureChatFolderTagsType:
		var businessFeatureChatFolderTags BusinessFeatureChatFolderTags
		err := json.Unmarshal(*rawMsg, &businessFeatureChatFolderTags)
		return &businessFeatureChatFolderTags, err

	case BusinessFeatureUpgradedStoriesType:
		var businessFeatureUpgradedStories BusinessFeatureUpgradedStories
		err := json.Unmarshal(*rawMsg, &businessFeatureUpgradedStories)
		return &businessFeatureUpgradedStories, err
...
func unmarshalBusinessFeatureSlice(rawMsg *json.RawMessage) ([]BusinessFeature, error) {
	objects := make([]BusinessFeature, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case BusinessFeatureLocationType:
			...
			err = json.Unmarshal(obj, &businessFeatureLocation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureLocation)
		case BusinessFeatureOpeningHoursType:
			var businessFeatureOpeningHours BusinessFeatureOpeningHours
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureOpeningHours)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureOpeningHours)
		case BusinessFeatureQuickRepliesType:
			var businessFeatureQuickReplies BusinessFeatureQuickReplies
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureQuickReplies)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureQuickReplies)
		case BusinessFeatureGreetingMessageType:
			var businessFeatureGreetingMessage BusinessFeatureGreetingMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureGreetingMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureGreetingMessage)
		case BusinessFeatureAwayMessageType:
			var businessFeatureAwayMessage BusinessFeatureAwayMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureAwayMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureAwayMessage)
		case BusinessFeatureAccountLinksType:
			var businessFeatureAccountLinks BusinessFeatureAccountLinks
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureAccountLinks)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureAccountLinks)
		case BusinessFeatureStartPageType:
			var businessFeatureStartPage BusinessFeatureStartPage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureStartPage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureStartPage)
		case BusinessFeatureBotsType:
			var businessFeatureBots BusinessFeatureBots
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureBots)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureBots)
		case BusinessFeatureEmojiStatusType:
			var businessFeatureEmojiStatus BusinessFeatureEmojiStatus
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureEmojiStatus)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureEmojiStatus)
		case BusinessFeatureChatFolderTagsType:
			var businessFeatureChatFolderTags BusinessFeatureChatFolderTags
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureChatFolderTags)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureChatFolderTags)
		case BusinessFeatureUpgradedStoriesType:
			var businessFeatureUpgradedStories BusinessFeatureUpgradedStories
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &businessFeatureUpgradedStories)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &businessFeatureUpgradedStories)
...
type PremiumStoryFeature interface {
	GetPremiumStoryFeatureEnum() PremiumStoryFeatureEnum
}

// PremiumStoryFeatureEnum Alias for abstract PremiumStoryFeature 'Sub-Classes', used as constant-enum here
type PremiumStoryFeatureEnum string

// PremiumStoryFeature enums
const (
	PremiumStoryFeaturePriorityOrderType            PremiumStoryFeatureEnum = "premiumStoryFeaturePriorityOrder"
	PremiumStoryFeatureStealthModeType              PremiumStoryFeatureEnum = "premiumStoryFeatureStealthMode"
	PremiumStoryFeaturePermanentViewsHistoryType    PremiumStoryFeatureEnum = "premiumStoryFeaturePermanentViewsHistory"
	PremiumStoryFeatureCustomExpirationDurationType PremiumStoryFeatureEnum = "premiumStoryFeatureCustomExpirationDuration"
	PremiumStoryFeatureSaveStoriesType              PremiumStoryFeatureEnum = "premiumStoryFeatureSaveStories"
	PremiumStoryFeatureLinksAndFormattingType       PremiumStoryFeatureEnum = "premiumStoryFeatureLinksAndFormatting"
	PremiumStoryFeatureVideoQualityType             PremiumStoryFeatureEnum = "premiumStoryFeatureVideoQuality"
)

func unmarshalPremiumStoryFeature(rawMsg *json.RawMessage) (PremiumStoryFeature, error) {
	...
	switch PremiumStoryFeatureEnum(objMap["@type"].(string)) {
	case PremiumStoryFeaturePriorityOrderType:
		var premiumStoryFeaturePriorityOrder PremiumStoryFeaturePriorityOrder
		err := json.Unmarshal(*rawMsg, &premiumStoryFeaturePriorityOrder)
		return &premiumStoryFeaturePriorityOrder, err

	case PremiumStoryFeatureStealthModeType:
		var premiumStoryFeatureStealthMode PremiumStoryFeatureStealthMode
		err := json.Unmarshal(*rawMsg, &premiumStoryFeatureStealthMode)
		return &premiumStoryFeatureStealthMode, err

	case PremiumStoryFeaturePermanentViewsHistoryType:
		var premiumStoryFeaturePermanentViewsHistory PremiumStoryFeaturePermanentViewsHistory
		err := json.Unmarshal(*rawMsg, &premiumStoryFeaturePermanentViewsHistory)
		return &premiumStoryFeaturePermanentViewsHistory, err

	case PremiumStoryFeatureCustomExpirationDurationType:
		var premiumStoryFeatureCustomExpirationDuration PremiumStoryFeatureCustomExpirationDuration
		err := json.Unmarshal(*rawMsg, &premiumStoryFeatureCustomExpirationDuration)
		return &premiumStoryFeatureCustomExpirationDuration, err

	case PremiumStoryFeatureSaveStoriesType:
		var premiumStoryFeatureSaveStories PremiumStoryFeatureSaveStories
		err := json.Unmarshal(*rawMsg, &premiumStoryFeatureSaveStories)
		return &premiumStoryFeatureSaveStories, err

	case PremiumStoryFeatureLinksAndFormattingType:
		var premiumStoryFeatureLinksAndFormatting PremiumStoryFeatureLinksAndFormatting
		err := json.Unmarshal(*rawMsg, &premiumStoryFeatureLinksAndFormatting)
		return &premiumStoryFeatureLinksAndFormatting, err

	case PremiumStoryFeatureVideoQualityType:
		var premiumStoryFeatureVideoQuality PremiumStoryFeatureVideoQuality
		err := json.Unmarshal(*rawMsg, &premiumStoryFeatureVideoQuality)
		return &premiumStoryFeatureVideoQuality, err
...
func unmarshalPremiumStoryFeatureSlice(rawMsg *json.RawMessage) ([]PremiumStoryFeature, error) {
	objects := make([]PremiumStoryFeature, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PremiumStoryFeaturePriorityOrderType:
			...
			err = json.Unmarshal(obj, &premiumStoryFeaturePriorityOrder)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeaturePriorityOrder)
		case PremiumStoryFeatureStealthModeType:
			var premiumStoryFeatureStealthMode PremiumStoryFeatureStealthMode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeatureStealthMode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeatureStealthMode)
		case PremiumStoryFeaturePermanentViewsHistoryType:
			var premiumStoryFeaturePermanentViewsHistory PremiumStoryFeaturePermanentViewsHistory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeaturePermanentViewsHistory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeaturePermanentViewsHistory)
		case PremiumStoryFeatureCustomExpirationDurationType:
			var premiumStoryFeatureCustomExpirationDuration PremiumStoryFeatureCustomExpirationDuration
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeatureCustomExpirationDuration)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeatureCustomExpirationDuration)
		case PremiumStoryFeatureSaveStoriesType:
			var premiumStoryFeatureSaveStories PremiumStoryFeatureSaveStories
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeatureSaveStories)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeatureSaveStories)
		case PremiumStoryFeatureLinksAndFormattingType:
			var premiumStoryFeatureLinksAndFormatting PremiumStoryFeatureLinksAndFormatting
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeatureLinksAndFormatting)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeatureLinksAndFormatting)
		case PremiumStoryFeatureVideoQualityType:
			var premiumStoryFeatureVideoQuality PremiumStoryFeatureVideoQuality
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumStoryFeatureVideoQuality)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumStoryFeatureVideoQuality)
...
type PremiumSource interface {
	GetPremiumSourceEnum() PremiumSourceEnum
}

// PremiumSourceEnum Alias for abstract PremiumSource 'Sub-Classes', used as constant-enum here
type PremiumSourceEnum string

// PremiumSource enums
const (
	PremiumSourceLimitExceededType   PremiumSourceEnum = "premiumSourceLimitExceeded"
	PremiumSourceFeatureType         PremiumSourceEnum = "premiumSourceFeature"
	PremiumSourceBusinessFeatureType PremiumSourceEnum = "premiumSourceBusinessFeature"
	PremiumSourceStoryFeatureType    PremiumSourceEnum = "premiumSourceStoryFeature"
	PremiumSourceLinkType            PremiumSourceEnum = "premiumSourceLink"
	PremiumSourceSettingsType        PremiumSourceEnum = "premiumSourceSettings"
)

func unmarshalPremiumSource(rawMsg *json.RawMessage) (PremiumSource, error) {
	...
	switch PremiumSourceEnum(objMap["@type"].(string)) {
	case PremiumSourceLimitExceededType:
		var premiumSourceLimitExceeded PremiumSourceLimitExceeded
		err := json.Unmarshal(*rawMsg, &premiumSourceLimitExceeded)
		return &premiumSourceLimitExceeded, err

	case PremiumSourceFeatureType:
		var premiumSourceFeature PremiumSourceFeature
		err := json.Unmarshal(*rawMsg, &premiumSourceFeature)
		return &premiumSourceFeature, err

	case PremiumSourceBusinessFeatureType:
		var premiumSourceBusinessFeature PremiumSourceBusinessFeature
		err := json.Unmarshal(*rawMsg, &premiumSourceBusinessFeature)
		return &premiumSourceBusinessFeature, err

	case PremiumSourceStoryFeatureType:
		var premiumSourceStoryFeature PremiumSourceStoryFeature
		err := json.Unmarshal(*rawMsg, &premiumSourceStoryFeature)
		return &premiumSourceStoryFeature, err

	case PremiumSourceLinkType:
		var premiumSourceLink PremiumSourceLink
		err := json.Unmarshal(*rawMsg, &premiumSourceLink)
		return &premiumSourceLink, err

	case PremiumSourceSettingsType:
		var premiumSourceSettings PremiumSourceSettings
		err := json.Unmarshal(*rawMsg, &premiumSourceSettings)
		return &premiumSourceSettings, err
...
func unmarshalPremiumSourceSlice(rawMsg *json.RawMessage) ([]PremiumSource, error) {
	objects := make([]PremiumSource, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PremiumSourceLimitExceededType:
			...
			err = json.Unmarshal(obj, &premiumSourceLimitExceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceLimitExceeded)
		case PremiumSourceFeatureType:
			var premiumSourceFeature PremiumSourceFeature
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumSourceFeature)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceFeature)
		case PremiumSourceBusinessFeatureType:
			var premiumSourceBusinessFeature PremiumSourceBusinessFeature
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumSourceBusinessFeature)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceBusinessFeature)
		case PremiumSourceStoryFeatureType:
			var premiumSourceStoryFeature PremiumSourceStoryFeature
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumSourceStoryFeature)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceStoryFeature)
		case PremiumSourceLinkType:
			var premiumSourceLink PremiumSourceLink
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumSourceLink)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceLink)
		case PremiumSourceSettingsType:
			var premiumSourceSettings PremiumSourceSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &premiumSourceSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &premiumSourceSettings)
...
type StorePaymentPurpose interface {
	GetStorePaymentPurposeEnum() StorePaymentPurposeEnum
}

// StorePaymentPurposeEnum Alias for abstract StorePaymentPurpose 'Sub-Classes', used as constant-enum here
type StorePaymentPurposeEnum string
...
const (
	...
	StorePaymentPurposeStarsType               StorePaymentPurposeEnum = "storePaymentPurposeStars"
	StorePaymentPurposeGiftedStarsType         StorePaymentPurposeEnum = "storePaymentPurposeGiftedStars"
)

func unmarshalStorePaymentPurpose(rawMsg *json.RawMessage) (StorePaymentPurpose, error) {
	...
	switch StorePaymentPurposeEnum(objMap["@type"].(string)) {
	case StorePaymentPurposePremiumSubscriptionType:
	...
	case StorePaymentPurposePremiumGiftCodesType:
		...
		err := json.Unmarshal(*rawMsg, &storePaymentPurposePremiumGiftCodes)
		return &storePaymentPurposePremiumGiftCodes, err

	case StorePaymentPurposePremiumGiveawayType:
		var storePaymentPurposePremiumGiveaway StorePaymentPurposePremiumGiveaway
		err := json.Unmarshal(*rawMsg, &storePaymentPurposePremiumGiveaway)
		return &storePaymentPurposePremiumGiveaway, err

	case StorePaymentPurposeStarGiveawayType:
		var storePaymentPurposeStarGiveaway StorePaymentPurposeStarGiveaway
		err := json.Unmarshal(*rawMsg, &storePaymentPurposeStarGiveaway)
		return &storePaymentPurposeStarGiveaway, err

	case StorePaymentPurposeStarsType:
		var storePaymentPurposeStars StorePaymentPurposeStars
		err := json.Unmarshal(*rawMsg, &storePaymentPurposeStars)
		return &storePaymentPurposeStars, err

	case StorePaymentPurposeGiftedStarsType:
		var storePaymentPurposeGiftedStars StorePaymentPurposeGiftedStars
		err := json.Unmarshal(*rawMsg, &storePaymentPurposeGiftedStars)
		return &storePaymentPurposeGiftedStars, err
...
func unmarshalStorePaymentPurposeSlice(rawMsg *json.RawMessage) ([]StorePaymentPurpose, error) {
	objects := make([]StorePaymentPurpose, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StorePaymentPurposePremiumSubscriptionType:
			...
			err = json.Unmarshal(obj, &storePaymentPurposePremiumSubscription)
			if err != nil {
				return nil, err
			}
		...
		case StorePaymentPurposePremiumGiftCodesType:
			...
			err = json.Unmarshal(obj, &storePaymentPurposePremiumGiftCodes)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storePaymentPurposePremiumGiftCodes)
		case StorePaymentPurposePremiumGiveawayType:
			var storePaymentPurposePremiumGiveaway StorePaymentPurposePremiumGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storePaymentPurposePremiumGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storePaymentPurposePremiumGiveaway)
		case StorePaymentPurposeStarGiveawayType:
			var storePaymentPurposeStarGiveaway StorePaymentPurposeStarGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storePaymentPurposeStarGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storePaymentPurposeStarGiveaway)
		case StorePaymentPurposeStarsType:
			var storePaymentPurposeStars StorePaymentPurposeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storePaymentPurposeStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storePaymentPurposeStars)
		case StorePaymentPurposeGiftedStarsType:
			var storePaymentPurposeGiftedStars StorePaymentPurposeGiftedStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storePaymentPurposeGiftedStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storePaymentPurposeGiftedStars)
...
type TelegramPaymentPurpose interface {
	GetTelegramPaymentPurposeEnum() TelegramPaymentPurposeEnum
}

// TelegramPaymentPurposeEnum Alias for abstract TelegramPaymentPurpose 'Sub-Classes', used as constant-enum here
type TelegramPaymentPurposeEnum string

// TelegramPaymentPurpose enums
const (
	TelegramPaymentPurposePremiumGiftCodesType TelegramPaymentPurposeEnum = "telegramPaymentPurposePremiumGiftCodes"
	TelegramPaymentPurposePremiumGiveawayType  TelegramPaymentPurposeEnum = "telegramPaymentPurposePremiumGiveaway"
	TelegramPaymentPurposeStarsType            TelegramPaymentPurposeEnum = "telegramPaymentPurposeStars"
	TelegramPaymentPurposeGiftedStarsType      TelegramPaymentPurposeEnum = "telegramPaymentPurposeGiftedStars"
	TelegramPaymentPurposeStarGiveawayType     TelegramPaymentPurposeEnum = "telegramPaymentPurposeStarGiveaway"
	TelegramPaymentPurposeJoinChatType         TelegramPaymentPurposeEnum = "telegramPaymentPurposeJoinChat"
)

func unmarshalTelegramPaymentPurpose(rawMsg *json.RawMessage) (TelegramPaymentPurpose, error) {
	...
	switch TelegramPaymentPurposeEnum(objMap["@type"].(string)) {
	case TelegramPaymentPurposePremiumGiftCodesType:
		var telegramPaymentPurposePremiumGiftCodes TelegramPaymentPurposePremiumGiftCodes
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposePremiumGiftCodes)
		return &telegramPaymentPurposePremiumGiftCodes, err

	case TelegramPaymentPurposePremiumGiveawayType:
		var telegramPaymentPurposePremiumGiveaway TelegramPaymentPurposePremiumGiveaway
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposePremiumGiveaway)
		return &telegramPaymentPurposePremiumGiveaway, err

	case TelegramPaymentPurposeStarsType:
		var telegramPaymentPurposeStars TelegramPaymentPurposeStars
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposeStars)
		return &telegramPaymentPurposeStars, err

	case TelegramPaymentPurposeGiftedStarsType:
		var telegramPaymentPurposeGiftedStars TelegramPaymentPurposeGiftedStars
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposeGiftedStars)
		return &telegramPaymentPurposeGiftedStars, err

	case TelegramPaymentPurposeStarGiveawayType:
		var telegramPaymentPurposeStarGiveaway TelegramPaymentPurposeStarGiveaway
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposeStarGiveaway)
		return &telegramPaymentPurposeStarGiveaway, err

	case TelegramPaymentPurposeJoinChatType:
		var telegramPaymentPurposeJoinChat TelegramPaymentPurposeJoinChat
		err := json.Unmarshal(*rawMsg, &telegramPaymentPurposeJoinChat)
		return &telegramPaymentPurposeJoinChat, err
...
func unmarshalTelegramPaymentPurposeSlice(rawMsg *json.RawMessage) ([]TelegramPaymentPurpose, error) {
	objects := make([]TelegramPaymentPurpose, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case TelegramPaymentPurposePremiumGiftCodesType:
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposePremiumGiftCodes)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposePremiumGiftCodes)
		case TelegramPaymentPurposePremiumGiveawayType:
			var telegramPaymentPurposePremiumGiveaway TelegramPaymentPurposePremiumGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposePremiumGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposePremiumGiveaway)
		case TelegramPaymentPurposeStarsType:
			var telegramPaymentPurposeStars TelegramPaymentPurposeStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposeStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposeStars)
		case TelegramPaymentPurposeGiftedStarsType:
			var telegramPaymentPurposeGiftedStars TelegramPaymentPurposeGiftedStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposeGiftedStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposeGiftedStars)
		case TelegramPaymentPurposeStarGiveawayType:
			var telegramPaymentPurposeStarGiveaway TelegramPaymentPurposeStarGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposeStarGiveaway)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposeStarGiveaway)
		case TelegramPaymentPurposeJoinChatType:
			var telegramPaymentPurposeJoinChat TelegramPaymentPurposeJoinChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &telegramPaymentPurposeJoinChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &telegramPaymentPurposeJoinChat)
...
const (
	...
	DeviceTokenHuaweiPushType             DeviceTokenEnum = "deviceTokenHuaweiPush"
)
...
func unmarshalDeviceToken(rawMsg *json.RawMessage) (DeviceToken, error) {
	...
	case DeviceTokenHuaweiPushType:
		var deviceTokenHuaweiPush DeviceTokenHuaweiPush
		err := json.Unmarshal(*rawMsg, &deviceTokenHuaweiPush)
		return &deviceTokenHuaweiPush, err
...
func unmarshalDeviceTokenSlice(rawMsg *json.RawMessage) ([]DeviceToken, error) {
	...
	for _, objMap := range objsMap {
		...
		case DeviceTokenHuaweiPushType:
			...
			err = json.Unmarshal(obj, &deviceTokenHuaweiPush)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &deviceTokenHuaweiPush)
...
const (
	...
	BackgroundTypeChatThemeType BackgroundTypeEnum = "backgroundTypeChatTheme"
)
...
func unmarshalBackgroundType(rawMsg *json.RawMessage) (BackgroundType, error) {
	...
	case BackgroundTypeChatThemeType:
		var backgroundTypeChatTheme BackgroundTypeChatTheme
		err := json.Unmarshal(*rawMsg, &backgroundTypeChatTheme)
		return &backgroundTypeChatTheme, err
...
func unmarshalBackgroundTypeSlice(rawMsg *json.RawMessage) ([]BackgroundType, error) {
	...
	for _, objMap := range objsMap {
		...
		case BackgroundTypeChatThemeType:
			...
			err = json.Unmarshal(obj, &backgroundTypeChatTheme)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &backgroundTypeChatTheme)
...
const (
	...
	InputBackgroundPreviousType InputBackgroundEnum = "inputBackgroundPrevious"
)
...
func unmarshalInputBackground(rawMsg *json.RawMessage) (InputBackground, error) {
	...
	case InputBackgroundPreviousType:
		var inputBackgroundPrevious InputBackgroundPrevious
		err := json.Unmarshal(*rawMsg, &inputBackgroundPrevious)
		return &inputBackgroundPrevious, err
...
func unmarshalInputBackgroundSlice(rawMsg *json.RawMessage) ([]InputBackground, error) {
	...
	for _, objMap := range objsMap {
		...
		case InputBackgroundPreviousType:
			...
			err = json.Unmarshal(obj, &inputBackgroundPrevious)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &inputBackgroundPrevious)
...
// CanSendStoryResult Represents result of checking whether the current user can send a story in the specific chat
type CanSendStoryResult interface {
	GetCanSendStoryResultEnum() CanSendStoryResultEnum
}

// CanSendStoryResultEnum Alias for abstract CanSendStoryResult 'Sub-Classes', used as constant-enum here
type CanSendStoryResultEnum string

// CanSendStoryResult enums
const (
	CanSendStoryResultOkType                       CanSendStoryResultEnum = "canSendStoryResultOk"
	CanSendStoryResultPremiumNeededType            CanSendStoryResultEnum = "canSendStoryResultPremiumNeeded"
	CanSendStoryResultBoostNeededType              CanSendStoryResultEnum = "canSendStoryResultBoostNeeded"
	CanSendStoryResultActiveStoryLimitExceededType CanSendStoryResultEnum = "canSendStoryResultActiveStoryLimitExceeded"
	CanSendStoryResultWeeklyLimitExceededType      CanSendStoryResultEnum = "canSendStoryResultWeeklyLimitExceeded"
	CanSendStoryResultMonthlyLimitExceededType     CanSendStoryResultEnum = "canSendStoryResultMonthlyLimitExceeded"
)

func unmarshalCanSendStoryResult(rawMsg *json.RawMessage) (CanSendStoryResult, error) {
	...
	switch CanSendStoryResultEnum(objMap["@type"].(string)) {
	case CanSendStoryResultOkType:
		var canSendStoryResultOk CanSendStoryResultOk
		err := json.Unmarshal(*rawMsg, &canSendStoryResultOk)
		return &canSendStoryResultOk, err

	case CanSendStoryResultPremiumNeededType:
		var canSendStoryResultPremiumNeeded CanSendStoryResultPremiumNeeded
		err := json.Unmarshal(*rawMsg, &canSendStoryResultPremiumNeeded)
		return &canSendStoryResultPremiumNeeded, err

	case CanSendStoryResultBoostNeededType:
		var canSendStoryResultBoostNeeded CanSendStoryResultBoostNeeded
		err := json.Unmarshal(*rawMsg, &canSendStoryResultBoostNeeded)
		return &canSendStoryResultBoostNeeded, err

	case CanSendStoryResultActiveStoryLimitExceededType:
		var canSendStoryResultActiveStoryLimitExceeded CanSendStoryResultActiveStoryLimitExceeded
		err := json.Unmarshal(*rawMsg, &canSendStoryResultActiveStoryLimitExceeded)
		return &canSendStoryResultActiveStoryLimitExceeded, err

	case CanSendStoryResultWeeklyLimitExceededType:
		var canSendStoryResultWeeklyLimitExceeded CanSendStoryResultWeeklyLimitExceeded
		err := json.Unmarshal(*rawMsg, &canSendStoryResultWeeklyLimitExceeded)
		return &canSendStoryResultWeeklyLimitExceeded, err

	case CanSendStoryResultMonthlyLimitExceededType:
		var canSendStoryResultMonthlyLimitExceeded CanSendStoryResultMonthlyLimitExceeded
		err := json.Unmarshal(*rawMsg, &canSendStoryResultMonthlyLimitExceeded)
		return &canSendStoryResultMonthlyLimitExceeded, err
...
func unmarshalCanSendStoryResultSlice(rawMsg *json.RawMessage) ([]CanSendStoryResult, error) {
	objects := make([]CanSendStoryResult, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case CanSendStoryResultOkType:
			...
			err = json.Unmarshal(obj, &canSendStoryResultOk)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultOk)
		case CanSendStoryResultPremiumNeededType:
			var canSendStoryResultPremiumNeeded CanSendStoryResultPremiumNeeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendStoryResultPremiumNeeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultPremiumNeeded)
		case CanSendStoryResultBoostNeededType:
			var canSendStoryResultBoostNeeded CanSendStoryResultBoostNeeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendStoryResultBoostNeeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultBoostNeeded)
		case CanSendStoryResultActiveStoryLimitExceededType:
			var canSendStoryResultActiveStoryLimitExceeded CanSendStoryResultActiveStoryLimitExceeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendStoryResultActiveStoryLimitExceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultActiveStoryLimitExceeded)
		case CanSendStoryResultWeeklyLimitExceededType:
			var canSendStoryResultWeeklyLimitExceeded CanSendStoryResultWeeklyLimitExceeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendStoryResultWeeklyLimitExceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultWeeklyLimitExceeded)
		case CanSendStoryResultMonthlyLimitExceededType:
			var canSendStoryResultMonthlyLimitExceeded CanSendStoryResultMonthlyLimitExceeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendStoryResultMonthlyLimitExceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendStoryResultMonthlyLimitExceeded)
...
const (
	...
	CheckChatUsernameResultUsernamePurchasableType     CheckChatUsernameResultEnum = "checkChatUsernameResultUsernamePurchasable"
	CheckChatUsernameResultPublicChatsTooManyType      CheckChatUsernameResultEnum = "checkChatUsernameResultPublicChatsTooMany"
...
func unmarshalCheckChatUsernameResult(rawMsg *json.RawMessage) (CheckChatUsernameResult, error) {
	...
	case CheckChatUsernameResultUsernamePurchasableType:
		var checkChatUsernameResultUsernamePurchasable CheckChatUsernameResultUsernamePurchasable
		err := json.Unmarshal(*rawMsg, &checkChatUsernameResultUsernamePurchasable)
		return &checkChatUsernameResultUsernamePurchasable, err

	case CheckChatUsernameResultPublicChatsTooManyType:
		var checkChatUsernameResultPublicChatsTooMany CheckChatUsernameResultPublicChatsTooMany
		err := json.Unmarshal(*rawMsg, &checkChatUsernameResultPublicChatsTooMany)
		return &checkChatUsernameResultPublicChatsTooMany, err
...
func unmarshalCheckChatUsernameResultSlice(rawMsg *json.RawMessage) ([]CheckChatUsernameResult, error) {
	...
	for _, objMap := range objsMap {
		...
		case CheckChatUsernameResultUsernamePurchasableType:
			...
			err = json.Unmarshal(obj, &checkChatUsernameResultUsernamePurchasable)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &checkChatUsernameResultUsernamePurchasable)
		case CheckChatUsernameResultPublicChatsTooManyType:
			var checkChatUsernameResultPublicChatsTooMany CheckChatUsernameResultPublicChatsTooMany
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &checkChatUsernameResultPublicChatsTooMany)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &checkChatUsernameResultPublicChatsTooMany)
		case CheckChatUsernameResultPublicGroupsUnavailableType:
			var checkChatUsernameResultPublicGroupsUnavailable CheckChatUsernameResultPublicGroupsUnavailable
			obj, err := json.Marshal(objMap)
			if err != nil {
...
const (
	...
	PushMessageContentPaidMediaType            PushMessageContentEnum = "pushMessageContentPaidMedia"
	...
	PushMessageContentChatSetBackgroundType    PushMessageContentEnum = "pushMessageContentChatSetBackground"
	...
	PushMessageContentRecurringPaymentType     PushMessageContentEnum = "pushMessageContentRecurringPayment"
	PushMessageContentSuggestProfilePhotoType  PushMessageContentEnum = "pushMessageContentSuggestProfilePhoto"
...
func unmarshalPushMessageContent(rawMsg *json.RawMessage) (PushMessageContent, error) {
	...
	case PushMessageContentPaidMediaType:
		var pushMessageContentPaidMedia PushMessageContentPaidMedia
		err := json.Unmarshal(*rawMsg, &pushMessageContentPaidMedia)
		return &pushMessageContentPaidMedia, err
	...
	case PushMessageContentPremiumGiftCodeType:
		var pushMessageContentPremiumGiftCode PushMessageContentPremiumGiftCode
		err := json.Unmarshal(*rawMsg, &pushMessageContentPremiumGiftCode)
		return &pushMessageContentPremiumGiftCode, err

	case PushMessageContentGiveawayType:
	...
	case PushMessageContentStoryType:
		var pushMessageContentStory PushMessageContentStory
		err := json.Unmarshal(*rawMsg, &pushMessageContentStory)
		return &pushMessageContentStory, err
	...
	case PushMessageContentChatSetBackgroundType:
		var pushMessageContentChatSetBackground PushMessageContentChatSetBackground
		err := json.Unmarshal(*rawMsg, &pushMessageContentChatSetBackground)
		return &pushMessageContentChatSetBackground, err
	...
	case PushMessageContentRecurringPaymentType:
		var pushMessageContentRecurringPayment PushMessageContentRecurringPayment
		err := json.Unmarshal(*rawMsg, &pushMessageContentRecurringPayment)
		return &pushMessageContentRecurringPayment, err

	case PushMessageContentSuggestProfilePhotoType:
		var pushMessageContentSuggestProfilePhoto PushMessageContentSuggestProfilePhoto
		err := json.Unmarshal(*rawMsg, &pushMessageContentSuggestProfilePhoto)
		return &pushMessageContentSuggestProfilePhoto, err
...
func unmarshalPushMessageContentSlice(rawMsg *json.RawMessage) ([]PushMessageContent, error) {
	...
	for _, objMap := range objsMap {
		...
		case PushMessageContentPaidMediaType:
			...
			err = json.Unmarshal(obj, &pushMessageContentPaidMedia)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentPaidMedia)
		case PushMessageContentPhotoType:
			var pushMessageContentPhoto PushMessageContentPhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case PushMessageContentPremiumGiftCodeType:
			...
			err = json.Unmarshal(obj, &pushMessageContentPremiumGiftCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentPremiumGiftCode)
		case PushMessageContentGiveawayType:
			var pushMessageContentGiveaway PushMessageContentGiveaway
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &pushMessageContentGiveaway)
			if err != nil {
				return nil, err
			}
		...
		case PushMessageContentStoryType:
			...
			err = json.Unmarshal(obj, &pushMessageContentStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentStory)
		case PushMessageContentTextType:
			var pushMessageContentText PushMessageContentText
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case PushMessageContentChatSetBackgroundType:
			...
			err = json.Unmarshal(obj, &pushMessageContentChatSetBackground)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentChatSetBackground)
		case PushMessageContentChatSetThemeType:
			var pushMessageContentChatSetTheme PushMessageContentChatSetTheme
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case PushMessageContentRecurringPaymentType:
			...
			err = json.Unmarshal(obj, &pushMessageContentRecurringPayment)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentRecurringPayment)
		case PushMessageContentSuggestProfilePhotoType:
			var pushMessageContentSuggestProfilePhoto PushMessageContentSuggestProfilePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &pushMessageContentSuggestProfilePhoto)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &pushMessageContentSuggestProfilePhoto)
		case PushMessageContentMessageForwardsType:
			var pushMessageContentMessageForwards PushMessageContentMessageForwards
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type StoryPrivacySettings interface {
	GetStoryPrivacySettingsEnum() StoryPrivacySettingsEnum
}

// StoryPrivacySettingsEnum Alias for abstract StoryPrivacySettings 'Sub-Classes', used as constant-enum here
type StoryPrivacySettingsEnum string

// StoryPrivacySettings enums
const (
	StoryPrivacySettingsEveryoneType      StoryPrivacySettingsEnum = "storyPrivacySettingsEveryone"
	StoryPrivacySettingsContactsType      StoryPrivacySettingsEnum = "storyPrivacySettingsContacts"
	StoryPrivacySettingsCloseFriendsType  StoryPrivacySettingsEnum = "storyPrivacySettingsCloseFriends"
	StoryPrivacySettingsSelectedUsersType StoryPrivacySettingsEnum = "storyPrivacySettingsSelectedUsers"
)

func unmarshalStoryPrivacySettings(rawMsg *json.RawMessage) (StoryPrivacySettings, error) {
	...
	switch StoryPrivacySettingsEnum(objMap["@type"].(string)) {
	case StoryPrivacySettingsEveryoneType:
		var storyPrivacySettingsEveryone StoryPrivacySettingsEveryone
		err := json.Unmarshal(*rawMsg, &storyPrivacySettingsEveryone)
		return &storyPrivacySettingsEveryone, err

	case StoryPrivacySettingsContactsType:
		var storyPrivacySettingsContacts StoryPrivacySettingsContacts
		err := json.Unmarshal(*rawMsg, &storyPrivacySettingsContacts)
		return &storyPrivacySettingsContacts, err

	case StoryPrivacySettingsCloseFriendsType:
		var storyPrivacySettingsCloseFriends StoryPrivacySettingsCloseFriends
		err := json.Unmarshal(*rawMsg, &storyPrivacySettingsCloseFriends)
		return &storyPrivacySettingsCloseFriends, err

	case StoryPrivacySettingsSelectedUsersType:
		var storyPrivacySettingsSelectedUsers StoryPrivacySettingsSelectedUsers
		err := json.Unmarshal(*rawMsg, &storyPrivacySettingsSelectedUsers)
		return &storyPrivacySettingsSelectedUsers, err
...
func unmarshalStoryPrivacySettingsSlice(rawMsg *json.RawMessage) ([]StoryPrivacySettings, error) {
	objects := make([]StoryPrivacySettings, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case StoryPrivacySettingsEveryoneType:
			...
			err = json.Unmarshal(obj, &storyPrivacySettingsEveryone)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyPrivacySettingsEveryone)
		case StoryPrivacySettingsContactsType:
			var storyPrivacySettingsContacts StoryPrivacySettingsContacts
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyPrivacySettingsContacts)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyPrivacySettingsContacts)
		case StoryPrivacySettingsCloseFriendsType:
			var storyPrivacySettingsCloseFriends StoryPrivacySettingsCloseFriends
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyPrivacySettingsCloseFriends)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyPrivacySettingsCloseFriends)
		case StoryPrivacySettingsSelectedUsersType:
			var storyPrivacySettingsSelectedUsers StoryPrivacySettingsSelectedUsers
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &storyPrivacySettingsSelectedUsers)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &storyPrivacySettingsSelectedUsers)
...
func unmarshalUserPrivacySettingRule(rawMsg *json.RawMessage) (UserPrivacySettingRule, error) {
	...
	case UserPrivacySettingRuleAllowPremiumUsersType:
		...
		return &userPrivacySettingRuleAllowPremiumUsers, err
...
func unmarshalUserPrivacySettingRuleSlice(rawMsg *json.RawMessage) ([]UserPrivacySettingRule, error) {
	...
	for _, objMap := range objsMap {
		...
		case UserPrivacySettingRuleAllowPremiumUsersType:
			...
			err = json.Unmarshal(obj, &userPrivacySettingRuleAllowPremiumUsers)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &userPrivacySettingRuleAllowPremiumUsers)
		case UserPrivacySettingRuleAllowUsersType:
			var userPrivacySettingRuleAllowUsers UserPrivacySettingRuleAllowUsers
			obj, err := json.Marshal(objMap)
			if err != nil {
...
const (
	...
	UserPrivacySettingShowBioType                               UserPrivacySettingEnum = "userPrivacySettingShowBio"
	UserPrivacySettingShowBirthdateType                         UserPrivacySettingEnum = "userPrivacySettingShowBirthdate"
...
func unmarshalUserPrivacySetting(rawMsg *json.RawMessage) (UserPrivacySetting, error) {
	...
	case UserPrivacySettingShowBioType:
		var userPrivacySettingShowBio UserPrivacySettingShowBio
		err := json.Unmarshal(*rawMsg, &userPrivacySettingShowBio)
		return &userPrivacySettingShowBio, err

	case UserPrivacySettingShowBirthdateType:
		var userPrivacySettingShowBirthdate UserPrivacySettingShowBirthdate
		err := json.Unmarshal(*rawMsg, &userPrivacySettingShowBirthdate)
		return &userPrivacySettingShowBirthdate, err
	...
	case UserPrivacySettingAllowPrivateVoiceAndVideoNoteMessagesType:
...
func unmarshalUserPrivacySettingSlice(rawMsg *json.RawMessage) ([]UserPrivacySetting, error) {
	...
	for _, objMap := range objsMap {
		...
		case UserPrivacySettingShowBioType:
			...
			err = json.Unmarshal(obj, &userPrivacySettingShowBio)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &userPrivacySettingShowBio)
		case UserPrivacySettingShowBirthdateType:
			var userPrivacySettingShowBirthdate UserPrivacySettingShowBirthdate
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &userPrivacySettingShowBirthdate)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &userPrivacySettingShowBirthdate)
		case UserPrivacySettingAllowChatInvitesType:
			var userPrivacySettingAllowChatInvites UserPrivacySettingAllowChatInvites
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UserPrivacySettingAllowPrivateVoiceAndVideoNoteMessagesType:
			...
			err = json.Unmarshal(obj, &userPrivacySettingAllowPrivateVoiceAndVideoNoteMessages)
			if err != nil {
				return nil, err
			}
...
type CanSendMessageToUserResult interface {
	GetCanSendMessageToUserResultEnum() CanSendMessageToUserResultEnum
}

// CanSendMessageToUserResultEnum Alias for abstract CanSendMessageToUserResult 'Sub-Classes', used as constant-enum here
type CanSendMessageToUserResultEnum string

// CanSendMessageToUserResult enums
const (
	CanSendMessageToUserResultOkType                    CanSendMessageToUserResultEnum = "canSendMessageToUserResultOk"
	CanSendMessageToUserResultUserIsDeletedType         CanSendMessageToUserResultEnum = "canSendMessageToUserResultUserIsDeleted"
	CanSendMessageToUserResultUserRestrictsNewChatsType CanSendMessageToUserResultEnum = "canSendMessageToUserResultUserRestrictsNewChats"
)

func unmarshalCanSendMessageToUserResult(rawMsg *json.RawMessage) (CanSendMessageToUserResult, error) {
	...
	switch CanSendMessageToUserResultEnum(objMap["@type"].(string)) {
	case CanSendMessageToUserResultOkType:
		var canSendMessageToUserResultOk CanSendMessageToUserResultOk
		err := json.Unmarshal(*rawMsg, &canSendMessageToUserResultOk)
		return &canSendMessageToUserResultOk, err

	case CanSendMessageToUserResultUserIsDeletedType:
		var canSendMessageToUserResultUserIsDeleted CanSendMessageToUserResultUserIsDeleted
		err := json.Unmarshal(*rawMsg, &canSendMessageToUserResultUserIsDeleted)
		return &canSendMessageToUserResultUserIsDeleted, err

	case CanSendMessageToUserResultUserRestrictsNewChatsType:
		var canSendMessageToUserResultUserRestrictsNewChats CanSendMessageToUserResultUserRestrictsNewChats
		err := json.Unmarshal(*rawMsg, &canSendMessageToUserResultUserRestrictsNewChats)
		return &canSendMessageToUserResultUserRestrictsNewChats, err
...
func unmarshalCanSendMessageToUserResultSlice(rawMsg *json.RawMessage) ([]CanSendMessageToUserResult, error) {
	objects := make([]CanSendMessageToUserResult, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case CanSendMessageToUserResultOkType:
			...
			err = json.Unmarshal(obj, &canSendMessageToUserResultOk)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendMessageToUserResultOk)
		case CanSendMessageToUserResultUserIsDeletedType:
			var canSendMessageToUserResultUserIsDeleted CanSendMessageToUserResultUserIsDeleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendMessageToUserResultUserIsDeleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendMessageToUserResultUserIsDeleted)
		case CanSendMessageToUserResultUserRestrictsNewChatsType:
			var canSendMessageToUserResultUserRestrictsNewChats CanSendMessageToUserResultUserRestrictsNewChats
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &canSendMessageToUserResultUserRestrictsNewChats)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &canSendMessageToUserResultUserRestrictsNewChats)
...
type SessionType interface {
	GetSessionTypeEnum() SessionTypeEnum
}

// SessionTypeEnum Alias for abstract SessionType 'Sub-Classes', used as constant-enum here
type SessionTypeEnum string

// SessionType enums
const (
	SessionTypeAndroidType SessionTypeEnum = "sessionTypeAndroid"
	SessionTypeAppleType   SessionTypeEnum = "sessionTypeApple"
	SessionTypeBraveType   SessionTypeEnum = "sessionTypeBrave"
	SessionTypeChromeType  SessionTypeEnum = "sessionTypeChrome"
	SessionTypeEdgeType    SessionTypeEnum = "sessionTypeEdge"
	SessionTypeFirefoxType SessionTypeEnum = "sessionTypeFirefox"
	SessionTypeIPadType    SessionTypeEnum = "sessionTypeIpad"
	SessionTypeIPhoneType  SessionTypeEnum = "sessionTypeIphone"
	SessionTypeLinuxType   SessionTypeEnum = "sessionTypeLinux"
	SessionTypeMacType     SessionTypeEnum = "sessionTypeMac"
	SessionTypeOperaType   SessionTypeEnum = "sessionTypeOpera"
	SessionTypeSafariType  SessionTypeEnum = "sessionTypeSafari"
	SessionTypeUbuntuType  SessionTypeEnum = "sessionTypeUbuntu"
	SessionTypeUnknownType SessionTypeEnum = "sessionTypeUnknown"
	SessionTypeVivaldiType SessionTypeEnum = "sessionTypeVivaldi"
	SessionTypeWindowsType SessionTypeEnum = "sessionTypeWindows"
	SessionTypeXboxType    SessionTypeEnum = "sessionTypeXbox"
)

func unmarshalSessionType(rawMsg *json.RawMessage) (SessionType, error) {
	...
	switch SessionTypeEnum(objMap["@type"].(string)) {
	case SessionTypeAndroidType:
		var sessionTypeAndroid SessionTypeAndroid
		err := json.Unmarshal(*rawMsg, &sessionTypeAndroid)
		return &sessionTypeAndroid, err

	case SessionTypeAppleType:
		var sessionTypeApple SessionTypeApple
		err := json.Unmarshal(*rawMsg, &sessionTypeApple)
		return &sessionTypeApple, err

	case SessionTypeBraveType:
		var sessionTypeBrave SessionTypeBrave
		err := json.Unmarshal(*rawMsg, &sessionTypeBrave)
		return &sessionTypeBrave, err

	case SessionTypeChromeType:
		var sessionTypeChrome SessionTypeChrome
		err := json.Unmarshal(*rawMsg, &sessionTypeChrome)
		return &sessionTypeChrome, err

	case SessionTypeEdgeType:
		var sessionTypeEdge SessionTypeEdge
		err := json.Unmarshal(*rawMsg, &sessionTypeEdge)
		return &sessionTypeEdge, err

	case SessionTypeFirefoxType:
		var sessionTypeFirefox SessionTypeFirefox
		err := json.Unmarshal(*rawMsg, &sessionTypeFirefox)
		return &sessionTypeFirefox, err

	case SessionTypeIPadType:
		var sessionTypeIPad SessionTypeIPad
		err := json.Unmarshal(*rawMsg, &sessionTypeIPad)
		return &sessionTypeIPad, err

	case SessionTypeIPhoneType:
		var sessionTypeIPhone SessionTypeIPhone
		err := json.Unmarshal(*rawMsg, &sessionTypeIPhone)
		return &sessionTypeIPhone, err

	case SessionTypeLinuxType:
		var sessionTypeLinux SessionTypeLinux
		err := json.Unmarshal(*rawMsg, &sessionTypeLinux)
		return &sessionTypeLinux, err

	case SessionTypeMacType:
		var sessionTypeMac SessionTypeMac
		err := json.Unmarshal(*rawMsg, &sessionTypeMac)
		return &sessionTypeMac, err

	case SessionTypeOperaType:
		var sessionTypeOpera SessionTypeOpera
		err := json.Unmarshal(*rawMsg, &sessionTypeOpera)
		return &sessionTypeOpera, err

	case SessionTypeSafariType:
		var sessionTypeSafari SessionTypeSafari
		err := json.Unmarshal(*rawMsg, &sessionTypeSafari)
		return &sessionTypeSafari, err

	case SessionTypeUbuntuType:
		var sessionTypeUbuntu SessionTypeUbuntu
		err := json.Unmarshal(*rawMsg, &sessionTypeUbuntu)
		return &sessionTypeUbuntu, err

	case SessionTypeUnknownType:
		var sessionTypeUnknown SessionTypeUnknown
		err := json.Unmarshal(*rawMsg, &sessionTypeUnknown)
		return &sessionTypeUnknown, err

	case SessionTypeVivaldiType:
		var sessionTypeVivaldi SessionTypeVivaldi
		err := json.Unmarshal(*rawMsg, &sessionTypeVivaldi)
		return &sessionTypeVivaldi, err

	case SessionTypeWindowsType:
		var sessionTypeWindows SessionTypeWindows
		err := json.Unmarshal(*rawMsg, &sessionTypeWindows)
		return &sessionTypeWindows, err

	case SessionTypeXboxType:
		var sessionTypeXbox SessionTypeXbox
		err := json.Unmarshal(*rawMsg, &sessionTypeXbox)
		return &sessionTypeXbox, err
...
func unmarshalSessionTypeSlice(rawMsg *json.RawMessage) ([]SessionType, error) {
	objects := make([]SessionType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case SessionTypeAndroidType:
			...
			err = json.Unmarshal(obj, &sessionTypeAndroid)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeAndroid)
		case SessionTypeAppleType:
			var sessionTypeApple SessionTypeApple
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeApple)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeApple)
		case SessionTypeBraveType:
			var sessionTypeBrave SessionTypeBrave
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeBrave)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeBrave)
		case SessionTypeChromeType:
			var sessionTypeChrome SessionTypeChrome
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeChrome)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeChrome)
		case SessionTypeEdgeType:
			var sessionTypeEdge SessionTypeEdge
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeEdge)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeEdge)
		case SessionTypeFirefoxType:
			var sessionTypeFirefox SessionTypeFirefox
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeFirefox)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeFirefox)
		case SessionTypeIPadType:
			var sessionTypeIPad SessionTypeIPad
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeIPad)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeIPad)
		case SessionTypeIPhoneType:
			var sessionTypeIPhone SessionTypeIPhone
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeIPhone)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeIPhone)
		case SessionTypeLinuxType:
			var sessionTypeLinux SessionTypeLinux
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeLinux)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeLinux)
		case SessionTypeMacType:
			var sessionTypeMac SessionTypeMac
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeMac)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeMac)
		case SessionTypeOperaType:
			var sessionTypeOpera SessionTypeOpera
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeOpera)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeOpera)
		case SessionTypeSafariType:
			var sessionTypeSafari SessionTypeSafari
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeSafari)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeSafari)
		case SessionTypeUbuntuType:
			var sessionTypeUbuntu SessionTypeUbuntu
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeUbuntu)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeUbuntu)
		case SessionTypeUnknownType:
			var sessionTypeUnknown SessionTypeUnknown
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeUnknown)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeUnknown)
		case SessionTypeVivaldiType:
			var sessionTypeVivaldi SessionTypeVivaldi
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeVivaldi)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeVivaldi)
		case SessionTypeWindowsType:
			var sessionTypeWindows SessionTypeWindows
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeWindows)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeWindows)
		case SessionTypeXboxType:
			var sessionTypeXbox SessionTypeXbox
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &sessionTypeXbox)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &sessionTypeXbox)
...
type ReportReason interface {
	GetReportReasonEnum() ReportReasonEnum
}

// ReportReasonEnum Alias for abstract ReportReason 'Sub-Classes', used as constant-enum here
type ReportReasonEnum string

// ReportReason enums
const (
	ReportReasonSpamType              ReportReasonEnum = "reportReasonSpam"
	ReportReasonViolenceType          ReportReasonEnum = "reportReasonViolence"
	ReportReasonPornographyType       ReportReasonEnum = "reportReasonPornography"
	ReportReasonChildAbuseType        ReportReasonEnum = "reportReasonChildAbuse"
	ReportReasonCopyrightType         ReportReasonEnum = "reportReasonCopyright"
	ReportReasonUnrelatedLocationType ReportReasonEnum = "reportReasonUnrelatedLocation"
	ReportReasonFakeType              ReportReasonEnum = "reportReasonFake"
	ReportReasonIllegalDrugsType      ReportReasonEnum = "reportReasonIllegalDrugs"
	ReportReasonPersonalDetailsType   ReportReasonEnum = "reportReasonPersonalDetails"
	ReportReasonCustomType            ReportReasonEnum = "reportReasonCustom"
)

func unmarshalReportReason(rawMsg *json.RawMessage) (ReportReason, error) {
	...
	switch ReportReasonEnum(objMap["@type"].(string)) {
	case ReportReasonSpamType:
		var reportReasonSpam ReportReasonSpam
		err := json.Unmarshal(*rawMsg, &reportReasonSpam)
		return &reportReasonSpam, err

	case ReportReasonViolenceType:
		var reportReasonViolence ReportReasonViolence
		err := json.Unmarshal(*rawMsg, &reportReasonViolence)
		return &reportReasonViolence, err

	case ReportReasonPornographyType:
		var reportReasonPornography ReportReasonPornography
		err := json.Unmarshal(*rawMsg, &reportReasonPornography)
		return &reportReasonPornography, err

	case ReportReasonChildAbuseType:
		var reportReasonChildAbuse ReportReasonChildAbuse
		err := json.Unmarshal(*rawMsg, &reportReasonChildAbuse)
		return &reportReasonChildAbuse, err

	case ReportReasonCopyrightType:
		var reportReasonCopyright ReportReasonCopyright
		err := json.Unmarshal(*rawMsg, &reportReasonCopyright)
		return &reportReasonCopyright, err

	case ReportReasonUnrelatedLocationType:
		var reportReasonUnrelatedLocation ReportReasonUnrelatedLocation
		err := json.Unmarshal(*rawMsg, &reportReasonUnrelatedLocation)
		return &reportReasonUnrelatedLocation, err

	case ReportReasonFakeType:
		var reportReasonFake ReportReasonFake
		err := json.Unmarshal(*rawMsg, &reportReasonFake)
		return &reportReasonFake, err

	case ReportReasonIllegalDrugsType:
		var reportReasonIllegalDrugs ReportReasonIllegalDrugs
		err := json.Unmarshal(*rawMsg, &reportReasonIllegalDrugs)
		return &reportReasonIllegalDrugs, err

	case ReportReasonPersonalDetailsType:
		var reportReasonPersonalDetails ReportReasonPersonalDetails
		err := json.Unmarshal(*rawMsg, &reportReasonPersonalDetails)
		return &reportReasonPersonalDetails, err

	case ReportReasonCustomType:
		var reportReasonCustom ReportReasonCustom
		err := json.Unmarshal(*rawMsg, &reportReasonCustom)
		return &reportReasonCustom, err
...
func unmarshalReportReasonSlice(rawMsg *json.RawMessage) ([]ReportReason, error) {
	objects := make([]ReportReason, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ReportReasonSpamType:
			...
			err = json.Unmarshal(obj, &reportReasonSpam)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonSpam)
		case ReportReasonViolenceType:
			var reportReasonViolence ReportReasonViolence
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonViolence)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonViolence)
		case ReportReasonPornographyType:
			var reportReasonPornography ReportReasonPornography
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonPornography)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonPornography)
		case ReportReasonChildAbuseType:
			var reportReasonChildAbuse ReportReasonChildAbuse
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonChildAbuse)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonChildAbuse)
		case ReportReasonCopyrightType:
			var reportReasonCopyright ReportReasonCopyright
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonCopyright)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonCopyright)
		case ReportReasonUnrelatedLocationType:
			var reportReasonUnrelatedLocation ReportReasonUnrelatedLocation
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonUnrelatedLocation)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonUnrelatedLocation)
		case ReportReasonFakeType:
			var reportReasonFake ReportReasonFake
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonFake)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonFake)
		case ReportReasonIllegalDrugsType:
			var reportReasonIllegalDrugs ReportReasonIllegalDrugs
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonIllegalDrugs)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonIllegalDrugs)
		case ReportReasonPersonalDetailsType:
			var reportReasonPersonalDetails ReportReasonPersonalDetails
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonPersonalDetails)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonPersonalDetails)
		case ReportReasonCustomType:
			var reportReasonCustom ReportReasonCustom
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &reportReasonCustom)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &reportReasonCustom)
...
const (
	...
	InternalLinkTypeAttachmentMenuBotType                     InternalLinkTypeEnum = "internalLinkTypeAttachmentMenuBot"
	...
	InternalLinkTypeBotAddToChannelType                       InternalLinkTypeEnum = "internalLinkTypeBotAddToChannel"
	...
	InternalLinkTypeDefaultMessageAutoDeleteTimerSettingsType InternalLinkTypeEnum = "internalLinkTypeDefaultMessageAutoDeleteTimerSettings"
	InternalLinkTypeEditProfileSettingsType                   InternalLinkTypeEnum = "internalLinkTypeEditProfileSettings"
	InternalLinkTypeGameType                                  InternalLinkTypeEnum = "internalLinkTypeGame"
	InternalLinkTypeInstantViewType                           InternalLinkTypeEnum = "internalLinkTypeInstantView"
	InternalLinkTypeInvoiceType                               InternalLinkTypeEnum = "internalLinkTypeInvoice"
	InternalLinkTypeLanguagePackType                          InternalLinkTypeEnum = "internalLinkTypeLanguagePack"
	InternalLinkTypeLanguageSettingsType                      InternalLinkTypeEnum = "internalLinkTypeLanguageSettings"
	InternalLinkTypeMainWebAppType                            InternalLinkTypeEnum = "internalLinkTypeMainWebApp"
	...
	InternalLinkTypePremiumFeaturesType                       InternalLinkTypeEnum = "internalLinkTypePremiumFeatures"
	InternalLinkTypePremiumGiftType                           InternalLinkTypeEnum = "internalLinkTypePremiumGift"
	InternalLinkTypePremiumGiftCodeType                       InternalLinkTypeEnum = "internalLinkTypePremiumGiftCode"
	InternalLinkTypePrivacyAndSecuritySettingsType            InternalLinkTypeEnum = "internalLinkTypePrivacyAndSecuritySettings"
	...
	InternalLinkTypeRestorePurchasesType                      InternalLinkTypeEnum = "internalLinkTypeRestorePurchases"
	...
	InternalLinkTypeStoryType                                 InternalLinkTypeEnum = "internalLinkTypeStory"
	...
	InternalLinkTypeWebAppType                                InternalLinkTypeEnum = "internalLinkTypeWebApp"
)
...
func unmarshalInternalLinkType(rawMsg *json.RawMessage) (InternalLinkType, error) {
	...
	case InternalLinkTypeAttachmentMenuBotType:
		var internalLinkTypeAttachmentMenuBot InternalLinkTypeAttachmentMenuBot
		err := json.Unmarshal(*rawMsg, &internalLinkTypeAttachmentMenuBot)
		return &internalLinkTypeAttachmentMenuBot, err
	...
	case InternalLinkTypeBotAddToChannelType:
		var internalLinkTypeBotAddToChannel InternalLinkTypeBotAddToChannel
		err := json.Unmarshal(*rawMsg, &internalLinkTypeBotAddToChannel)
		return &internalLinkTypeBotAddToChannel, err
	...
	case InternalLinkTypeBusinessChatType:
		var internalLinkTypeBusinessChat InternalLinkTypeBusinessChat
		err := json.Unmarshal(*rawMsg, &internalLinkTypeBusinessChat)
		return &internalLinkTypeBusinessChat, err

	case InternalLinkTypeBuyStarsType:
		var internalLinkTypeBuyStars InternalLinkTypeBuyStars
		err := json.Unmarshal(*rawMsg, &internalLinkTypeBuyStars)
		return &internalLinkTypeBuyStars, err
	...
	case InternalLinkTypeChatBoostType:
		...
		err := json.Unmarshal(*rawMsg, &internalLinkTypeChatBoost)
		return &internalLinkTypeChatBoost, err

	case InternalLinkTypeChatFolderInviteType:
		var internalLinkTypeChatFolderInvite InternalLinkTypeChatFolderInvite
		err := json.Unmarshal(*rawMsg, &internalLinkTypeChatFolderInvite)
		return &internalLinkTypeChatFolderInvite, err

	case InternalLinkTypeChatFolderSettingsType:
		var internalLinkTypeChatFolderSettings InternalLinkTypeChatFolderSettings
		err := json.Unmarshal(*rawMsg, &internalLinkTypeChatFolderSettings)
		return &internalLinkTypeChatFolderSettings, err
	...
	case InternalLinkTypeDefaultMessageAutoDeleteTimerSettingsType:
		var internalLinkTypeDefaultMessageAutoDeleteTimerSettings InternalLinkTypeDefaultMessageAutoDeleteTimerSettings
		err := json.Unmarshal(*rawMsg, &internalLinkTypeDefaultMessageAutoDeleteTimerSettings)
		return &internalLinkTypeDefaultMessageAutoDeleteTimerSettings, err

	case InternalLinkTypeEditProfileSettingsType:
		var internalLinkTypeEditProfileSettings InternalLinkTypeEditProfileSettings
		err := json.Unmarshal(*rawMsg, &internalLinkTypeEditProfileSettings)
		return &internalLinkTypeEditProfileSettings, err
	...
	case InternalLinkTypeInstantViewType:
		var internalLinkTypeInstantView InternalLinkTypeInstantView
		err := json.Unmarshal(*rawMsg, &internalLinkTypeInstantView)
		return &internalLinkTypeInstantView, err

	case InternalLinkTypeInvoiceType:
		var internalLinkTypeInvoice InternalLinkTypeInvoice
		err := json.Unmarshal(*rawMsg, &internalLinkTypeInvoice)
		return &internalLinkTypeInvoice, err
	...
	case InternalLinkTypeLanguageSettingsType:
		var internalLinkTypeLanguageSettings InternalLinkTypeLanguageSettings
		err := json.Unmarshal(*rawMsg, &internalLinkTypeLanguageSettings)
		return &internalLinkTypeLanguageSettings, err

	case InternalLinkTypeMainWebAppType:
		var internalLinkTypeMainWebApp InternalLinkTypeMainWebApp
		err := json.Unmarshal(*rawMsg, &internalLinkTypeMainWebApp)
		return &internalLinkTypeMainWebApp, err
	...
	case InternalLinkTypePremiumFeaturesType:
		var internalLinkTypePremiumFeatures InternalLinkTypePremiumFeatures
		err := json.Unmarshal(*rawMsg, &internalLinkTypePremiumFeatures)
		return &internalLinkTypePremiumFeatures, err

	case InternalLinkTypePremiumGiftType:
		var internalLinkTypePremiumGift InternalLinkTypePremiumGift
		err := json.Unmarshal(*rawMsg, &internalLinkTypePremiumGift)
		return &internalLinkTypePremiumGift, err

	case InternalLinkTypePremiumGiftCodeType:
		var internalLinkTypePremiumGiftCode InternalLinkTypePremiumGiftCode
		err := json.Unmarshal(*rawMsg, &internalLinkTypePremiumGiftCode)
		return &internalLinkTypePremiumGiftCode, err

	case InternalLinkTypePrivacyAndSecuritySettingsType:
		var internalLinkTypePrivacyAndSecuritySettings InternalLinkTypePrivacyAndSecuritySettings
		err := json.Unmarshal(*rawMsg, &internalLinkTypePrivacyAndSecuritySettings)
		return &internalLinkTypePrivacyAndSecuritySettings, err
	...
	case InternalLinkTypeRestorePurchasesType:
		var internalLinkTypeRestorePurchases InternalLinkTypeRestorePurchases
		err := json.Unmarshal(*rawMsg, &internalLinkTypeRestorePurchases)
		return &internalLinkTypeRestorePurchases, err
	...
	case InternalLinkTypeStoryType:
		var internalLinkTypeStory InternalLinkTypeStory
		err := json.Unmarshal(*rawMsg, &internalLinkTypeStory)
		return &internalLinkTypeStory, err
	...
	case InternalLinkTypeUserPhoneNumberType:
		...
		err := json.Unmarshal(*rawMsg, &internalLinkTypeUserPhoneNumber)
		return &internalLinkTypeUserPhoneNumber, err

	case InternalLinkTypeUserTokenType:
		var internalLinkTypeUserToken InternalLinkTypeUserToken
		err := json.Unmarshal(*rawMsg, &internalLinkTypeUserToken)
		return &internalLinkTypeUserToken, err
	...
	case InternalLinkTypeWebAppType:
		var internalLinkTypeWebApp InternalLinkTypeWebApp
		err := json.Unmarshal(*rawMsg, &internalLinkTypeWebApp)
		return &internalLinkTypeWebApp, err
...
func unmarshalInternalLinkTypeSlice(rawMsg *json.RawMessage) ([]InternalLinkType, error) {
	...
	for _, objMap := range objsMap {
		...
		case InternalLinkTypeAttachmentMenuBotType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeAttachmentMenuBot)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeAttachmentMenuBot)
		case InternalLinkTypeAuthenticationCodeType:
			var internalLinkTypeAuthenticationCode InternalLinkTypeAuthenticationCode
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeBotAddToChannelType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeBotAddToChannel)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeBotAddToChannel)
		case InternalLinkTypeBotStartType:
			var internalLinkTypeBotStart InternalLinkTypeBotStart
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeBusinessChatType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeBusinessChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeBusinessChat)
		case InternalLinkTypeBuyStarsType:
			var internalLinkTypeBuyStars InternalLinkTypeBuyStars
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeBuyStars)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeBuyStars)
		case InternalLinkTypeChangePhoneNumberType:
			var internalLinkTypeChangePhoneNumber InternalLinkTypeChangePhoneNumber
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeChatBoostType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeChatBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeChatBoost)
		case InternalLinkTypeChatFolderInviteType:
			var internalLinkTypeChatFolderInvite InternalLinkTypeChatFolderInvite
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeChatFolderInvite)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeChatFolderInvite)
		case InternalLinkTypeChatFolderSettingsType:
			var internalLinkTypeChatFolderSettings InternalLinkTypeChatFolderSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeChatFolderSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeChatFolderSettings)
		case InternalLinkTypeChatInviteType:
			var internalLinkTypeChatInvite InternalLinkTypeChatInvite
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeDefaultMessageAutoDeleteTimerSettingsType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeDefaultMessageAutoDeleteTimerSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeDefaultMessageAutoDeleteTimerSettings)
		case InternalLinkTypeEditProfileSettingsType:
			var internalLinkTypeEditProfileSettings InternalLinkTypeEditProfileSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeEditProfileSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeEditProfileSettings)
		case InternalLinkTypeGameType:
			var internalLinkTypeGame InternalLinkTypeGame
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeInstantViewType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeInstantView)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeInstantView)
		case InternalLinkTypeInvoiceType:
			var internalLinkTypeInvoice InternalLinkTypeInvoice
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeInvoice)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeInvoice)
		case InternalLinkTypeLanguagePackType:
			var internalLinkTypeLanguagePack InternalLinkTypeLanguagePack
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeLanguageSettingsType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeLanguageSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeLanguageSettings)
		case InternalLinkTypeMainWebAppType:
			var internalLinkTypeMainWebApp InternalLinkTypeMainWebApp
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeMainWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeMainWebApp)
		case InternalLinkTypeMessageType:
			var internalLinkTypeMessage InternalLinkTypeMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypePremiumFeaturesType:
			...
			err = json.Unmarshal(obj, &internalLinkTypePremiumFeatures)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypePremiumFeatures)
		case InternalLinkTypePremiumGiftType:
			var internalLinkTypePremiumGift InternalLinkTypePremiumGift
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypePremiumGift)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypePremiumGift)
		case InternalLinkTypePremiumGiftCodeType:
			var internalLinkTypePremiumGiftCode InternalLinkTypePremiumGiftCode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypePremiumGiftCode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypePremiumGiftCode)
		case InternalLinkTypePrivacyAndSecuritySettingsType:
			var internalLinkTypePrivacyAndSecuritySettings InternalLinkTypePrivacyAndSecuritySettings
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypePrivacyAndSecuritySettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypePrivacyAndSecuritySettings)
		case InternalLinkTypeProxyType:
			var internalLinkTypeProxy InternalLinkTypeProxy
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeRestorePurchasesType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeRestorePurchases)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeRestorePurchases)
		case InternalLinkTypeSettingsType:
			var internalLinkTypeSettings InternalLinkTypeSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeStoryType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeStory)
		case InternalLinkTypeThemeType:
			var internalLinkTypeTheme InternalLinkTypeTheme
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeUserPhoneNumberType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeUserPhoneNumber)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeUserPhoneNumber)
		case InternalLinkTypeUserTokenType:
			var internalLinkTypeUserToken InternalLinkTypeUserToken
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &internalLinkTypeUserToken)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeUserToken)
		case InternalLinkTypeVideoChatType:
			var internalLinkTypeVideoChat InternalLinkTypeVideoChat
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case InternalLinkTypeWebAppType:
			...
			err = json.Unmarshal(obj, &internalLinkTypeWebApp)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &internalLinkTypeWebApp)
...
type BlockList interface {
	GetBlockListEnum() BlockListEnum
}

// BlockListEnum Alias for abstract BlockList 'Sub-Classes', used as constant-enum here
type BlockListEnum string

// BlockList enums
const (
	BlockListMainType    BlockListEnum = "blockListMain"
	BlockListStoriesType BlockListEnum = "blockListStories"
)

func unmarshalBlockList(rawMsg *json.RawMessage) (BlockList, error) {
	...
	switch BlockListEnum(objMap["@type"].(string)) {
	case BlockListMainType:
		var blockListMain BlockListMain
		err := json.Unmarshal(*rawMsg, &blockListMain)
		return &blockListMain, err

	case BlockListStoriesType:
		var blockListStories BlockListStories
		err := json.Unmarshal(*rawMsg, &blockListStories)
		return &blockListStories, err
...
func unmarshalBlockListSlice(rawMsg *json.RawMessage) ([]BlockList, error) {
	objects := make([]BlockList, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case BlockListMainType:
			...
			err = json.Unmarshal(obj, &blockListMain)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &blockListMain)
		case BlockListStoriesType:
			var blockListStories BlockListStories
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &blockListStories)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &blockListStories)
...
func unmarshalFileType(rawMsg *json.RawMessage) (FileType, error) {
	...
	case FileTypeNotificationSoundType:
		var fileTypeNotificationSound FileTypeNotificationSound
		err := json.Unmarshal(*rawMsg, &fileTypeNotificationSound)
		return &fileTypeNotificationSound, err
	...
	case FileTypePhotoStoryType:
		var fileTypePhotoStory FileTypePhotoStory
		err := json.Unmarshal(*rawMsg, &fileTypePhotoStory)
		return &fileTypePhotoStory, err
	...
	case FileTypeVideoStoryType:
		var fileTypeVideoStory FileTypeVideoStory
		err := json.Unmarshal(*rawMsg, &fileTypeVideoStory)
		return &fileTypeVideoStory, err
...
func unmarshalFileTypeSlice(rawMsg *json.RawMessage) ([]FileType, error) {
	...
	for _, objMap := range objsMap {
		...
		case FileTypeNotificationSoundType:
			...
			err = json.Unmarshal(obj, &fileTypeNotificationSound)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &fileTypeNotificationSound)
		case FileTypePhotoType:
			var fileTypePhoto FileTypePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case FileTypePhotoStoryType:
			...
			err = json.Unmarshal(obj, &fileTypePhotoStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &fileTypePhotoStory)
		case FileTypeProfilePhotoType:
			var fileTypeProfilePhoto FileTypeProfilePhoto
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case FileTypeVideoStoryType:
			...
			err = json.Unmarshal(obj, &fileTypeVideoStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &fileTypeVideoStory)
		case FileTypeVoiceNoteType:
			var fileTypeVoiceNote FileTypeVoiceNote
			obj, err := json.Marshal(objMap)
			if err != nil {
...
type AutosaveSettingsScope interface {
	GetAutosaveSettingsScopeEnum() AutosaveSettingsScopeEnum
}

// AutosaveSettingsScopeEnum Alias for abstract AutosaveSettingsScope 'Sub-Classes', used as constant-enum here
type AutosaveSettingsScopeEnum string

// AutosaveSettingsScope enums
const (
	AutosaveSettingsScopePrivateChatsType AutosaveSettingsScopeEnum = "autosaveSettingsScopePrivateChats"
	AutosaveSettingsScopeGroupChatsType   AutosaveSettingsScopeEnum = "autosaveSettingsScopeGroupChats"
	AutosaveSettingsScopeChannelChatsType AutosaveSettingsScopeEnum = "autosaveSettingsScopeChannelChats"
	AutosaveSettingsScopeChatType         AutosaveSettingsScopeEnum = "autosaveSettingsScopeChat"
)

func unmarshalAutosaveSettingsScope(rawMsg *json.RawMessage) (AutosaveSettingsScope, error) {
	...
	switch AutosaveSettingsScopeEnum(objMap["@type"].(string)) {
	case AutosaveSettingsScopePrivateChatsType:
		var autosaveSettingsScopePrivateChats AutosaveSettingsScopePrivateChats
		err := json.Unmarshal(*rawMsg, &autosaveSettingsScopePrivateChats)
		return &autosaveSettingsScopePrivateChats, err

	case AutosaveSettingsScopeGroupChatsType:
		var autosaveSettingsScopeGroupChats AutosaveSettingsScopeGroupChats
		err := json.Unmarshal(*rawMsg, &autosaveSettingsScopeGroupChats)
		return &autosaveSettingsScopeGroupChats, err

	case AutosaveSettingsScopeChannelChatsType:
		var autosaveSettingsScopeChannelChats AutosaveSettingsScopeChannelChats
		err := json.Unmarshal(*rawMsg, &autosaveSettingsScopeChannelChats)
		return &autosaveSettingsScopeChannelChats, err

	case AutosaveSettingsScopeChatType:
		var autosaveSettingsScopeChat AutosaveSettingsScopeChat
		err := json.Unmarshal(*rawMsg, &autosaveSettingsScopeChat)
		return &autosaveSettingsScopeChat, err
...
func unmarshalAutosaveSettingsScopeSlice(rawMsg *json.RawMessage) ([]AutosaveSettingsScope, error) {
	objects := make([]AutosaveSettingsScope, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case AutosaveSettingsScopePrivateChatsType:
			...
			err = json.Unmarshal(obj, &autosaveSettingsScopePrivateChats)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &autosaveSettingsScopePrivateChats)
		case AutosaveSettingsScopeGroupChatsType:
			var autosaveSettingsScopeGroupChats AutosaveSettingsScopeGroupChats
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &autosaveSettingsScopeGroupChats)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &autosaveSettingsScopeGroupChats)
		case AutosaveSettingsScopeChannelChatsType:
			var autosaveSettingsScopeChannelChats AutosaveSettingsScopeChannelChats
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &autosaveSettingsScopeChannelChats)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &autosaveSettingsScopeChannelChats)
		case AutosaveSettingsScopeChatType:
			var autosaveSettingsScopeChat AutosaveSettingsScopeChat
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &autosaveSettingsScopeChat)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &autosaveSettingsScopeChat)
...
const (
	...
	TopChatCategoryWebAppBotsType   TopChatCategoryEnum = "topChatCategoryWebAppBots"
...
func unmarshalTopChatCategory(rawMsg *json.RawMessage) (TopChatCategory, error) {
	...
	case TopChatCategoryWebAppBotsType:
		var topChatCategoryWebAppBots TopChatCategoryWebAppBots
		err := json.Unmarshal(*rawMsg, &topChatCategoryWebAppBots)
		return &topChatCategoryWebAppBots, err
...
func unmarshalTopChatCategorySlice(rawMsg *json.RawMessage) ([]TopChatCategory, error) {
	...
	for _, objMap := range objsMap {
		...
		case TopChatCategoryWebAppBotsType:
			...
			err = json.Unmarshal(obj, &topChatCategoryWebAppBots)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &topChatCategoryWebAppBots)
		case TopChatCategoryCallsType:
			var topChatCategoryCalls TopChatCategoryCalls
			obj, err := json.Marshal(objMap)
			if err != nil {
...
const (
	...
	SuggestedActionUpgradePremiumType               SuggestedActionEnum = "suggestedActionUpgradePremium"
	SuggestedActionRestorePremiumType               SuggestedActionEnum = "suggestedActionRestorePremium"
...
func unmarshalSuggestedAction(rawMsg *json.RawMessage) (SuggestedAction, error) {
	...
	case SuggestedActionUpgradePremiumType:
		var suggestedActionUpgradePremium SuggestedActionUpgradePremium
		err := json.Unmarshal(*rawMsg, &suggestedActionUpgradePremium)
		return &suggestedActionUpgradePremium, err

	case SuggestedActionRestorePremiumType:
		var suggestedActionRestorePremium SuggestedActionRestorePremium
		err := json.Unmarshal(*rawMsg, &suggestedActionRestorePremium)
		return &suggestedActionRestorePremium, err

	case SuggestedActionSubscribeToAnnualPremiumType:
		var suggestedActionSubscribeToAnnualPremium SuggestedActionSubscribeToAnnualPremium
		err := json.Unmarshal(*rawMsg, &suggestedActionSubscribeToAnnualPremium)
		return &suggestedActionSubscribeToAnnualPremium, err

	case SuggestedActionGiftPremiumForChristmasType:
		var suggestedActionGiftPremiumForChristmas SuggestedActionGiftPremiumForChristmas
		err := json.Unmarshal(*rawMsg, &suggestedActionGiftPremiumForChristmas)
		return &suggestedActionGiftPremiumForChristmas, err

	case SuggestedActionSetBirthdateType:
	...
	case SuggestedActionExtendPremiumType:
		...
		err := json.Unmarshal(*rawMsg, &suggestedActionExtendPremium)
		return &suggestedActionExtendPremium, err

	case SuggestedActionExtendStarSubscriptionsType:
		var suggestedActionExtendStarSubscriptions SuggestedActionExtendStarSubscriptions
		err := json.Unmarshal(*rawMsg, &suggestedActionExtendStarSubscriptions)
		return &suggestedActionExtendStarSubscriptions, err
...
func unmarshalSuggestedActionSlice(rawMsg *json.RawMessage) ([]SuggestedAction, error) {
	...
	for _, objMap := range objsMap {
		...
		case SuggestedActionUpgradePremiumType:
			...
			err = json.Unmarshal(obj, &suggestedActionUpgradePremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionUpgradePremium)
		case SuggestedActionRestorePremiumType:
			var suggestedActionRestorePremium SuggestedActionRestorePremium
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &suggestedActionRestorePremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionRestorePremium)
		case SuggestedActionSubscribeToAnnualPremiumType:
			var suggestedActionSubscribeToAnnualPremium SuggestedActionSubscribeToAnnualPremium
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &suggestedActionSubscribeToAnnualPremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionSubscribeToAnnualPremium)
		case SuggestedActionGiftPremiumForChristmasType:
			var suggestedActionGiftPremiumForChristmas SuggestedActionGiftPremiumForChristmas
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &suggestedActionGiftPremiumForChristmas)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionGiftPremiumForChristmas)
		case SuggestedActionSetBirthdateType:
			var suggestedActionSetBirthdate SuggestedActionSetBirthdate
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &suggestedActionSetBirthdate)
			if err != nil {
				return nil, err
			}
		...
		case SuggestedActionExtendPremiumType:
			...
			err = json.Unmarshal(obj, &suggestedActionExtendPremium)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionExtendPremium)
		case SuggestedActionExtendStarSubscriptionsType:
			var suggestedActionExtendStarSubscriptions SuggestedActionExtendStarSubscriptions
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &suggestedActionExtendStarSubscriptions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &suggestedActionExtendStarSubscriptions)
...
type ChatStatisticsObjectType interface {
	GetChatStatisticsObjectTypeEnum() ChatStatisticsObjectTypeEnum
}

// ChatStatisticsObjectTypeEnum Alias for abstract ChatStatisticsObjectType 'Sub-Classes', used as constant-enum here
type ChatStatisticsObjectTypeEnum string

// ChatStatisticsObjectType enums
const (
	ChatStatisticsObjectTypeMessageType ChatStatisticsObjectTypeEnum = "chatStatisticsObjectTypeMessage"
	ChatStatisticsObjectTypeStoryType   ChatStatisticsObjectTypeEnum = "chatStatisticsObjectTypeStory"
)

func unmarshalChatStatisticsObjectType(rawMsg *json.RawMessage) (ChatStatisticsObjectType, error) {
	...
	switch ChatStatisticsObjectTypeEnum(objMap["@type"].(string)) {
	case ChatStatisticsObjectTypeMessageType:
		var chatStatisticsObjectTypeMessage ChatStatisticsObjectTypeMessage
		err := json.Unmarshal(*rawMsg, &chatStatisticsObjectTypeMessage)
		return &chatStatisticsObjectTypeMessage, err

	case ChatStatisticsObjectTypeStoryType:
		var chatStatisticsObjectTypeStory ChatStatisticsObjectTypeStory
		err := json.Unmarshal(*rawMsg, &chatStatisticsObjectTypeStory)
		return &chatStatisticsObjectTypeStory, err
...
func unmarshalChatStatisticsObjectTypeSlice(rawMsg *json.RawMessage) ([]ChatStatisticsObjectType, error) {
	objects := make([]ChatStatisticsObjectType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ChatStatisticsObjectTypeMessageType:
			...
			err = json.Unmarshal(obj, &chatStatisticsObjectTypeMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatStatisticsObjectTypeMessage)
		case ChatStatisticsObjectTypeStoryType:
			var chatStatisticsObjectTypeStory ChatStatisticsObjectTypeStory
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatStatisticsObjectTypeStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatStatisticsObjectTypeStory)
...
type RevenueWithdrawalState interface {
	GetRevenueWithdrawalStateEnum() RevenueWithdrawalStateEnum
}

// RevenueWithdrawalStateEnum Alias for abstract RevenueWithdrawalState 'Sub-Classes', used as constant-enum here
type RevenueWithdrawalStateEnum string

// RevenueWithdrawalState enums
const (
	RevenueWithdrawalStatePendingType   RevenueWithdrawalStateEnum = "revenueWithdrawalStatePending"
	RevenueWithdrawalStateSucceededType RevenueWithdrawalStateEnum = "revenueWithdrawalStateSucceeded"
	RevenueWithdrawalStateFailedType    RevenueWithdrawalStateEnum = "revenueWithdrawalStateFailed"
)

func unmarshalRevenueWithdrawalState(rawMsg *json.RawMessage) (RevenueWithdrawalState, error) {
	...
	switch RevenueWithdrawalStateEnum(objMap["@type"].(string)) {
	case RevenueWithdrawalStatePendingType:
		var revenueWithdrawalStatePending RevenueWithdrawalStatePending
		err := json.Unmarshal(*rawMsg, &revenueWithdrawalStatePending)
		return &revenueWithdrawalStatePending, err

	case RevenueWithdrawalStateSucceededType:
		var revenueWithdrawalStateSucceeded RevenueWithdrawalStateSucceeded
		err := json.Unmarshal(*rawMsg, &revenueWithdrawalStateSucceeded)
		return &revenueWithdrawalStateSucceeded, err

	case RevenueWithdrawalStateFailedType:
		var revenueWithdrawalStateFailed RevenueWithdrawalStateFailed
		err := json.Unmarshal(*rawMsg, &revenueWithdrawalStateFailed)
		return &revenueWithdrawalStateFailed, err
...
func unmarshalRevenueWithdrawalStateSlice(rawMsg *json.RawMessage) ([]RevenueWithdrawalState, error) {
	objects := make([]RevenueWithdrawalState, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case RevenueWithdrawalStatePendingType:
			...
			err = json.Unmarshal(obj, &revenueWithdrawalStatePending)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &revenueWithdrawalStatePending)
		case RevenueWithdrawalStateSucceededType:
			var revenueWithdrawalStateSucceeded RevenueWithdrawalStateSucceeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &revenueWithdrawalStateSucceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &revenueWithdrawalStateSucceeded)
		case RevenueWithdrawalStateFailedType:
			var revenueWithdrawalStateFailed RevenueWithdrawalStateFailed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &revenueWithdrawalStateFailed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &revenueWithdrawalStateFailed)
...
type ChatRevenueTransactionType interface {
	GetChatRevenueTransactionTypeEnum() ChatRevenueTransactionTypeEnum
}

// ChatRevenueTransactionTypeEnum Alias for abstract ChatRevenueTransactionType 'Sub-Classes', used as constant-enum here
type ChatRevenueTransactionTypeEnum string

// ChatRevenueTransactionType enums
const (
	ChatRevenueTransactionTypeEarningsType   ChatRevenueTransactionTypeEnum = "chatRevenueTransactionTypeEarnings"
	ChatRevenueTransactionTypeWithdrawalType ChatRevenueTransactionTypeEnum = "chatRevenueTransactionTypeWithdrawal"
	ChatRevenueTransactionTypeRefundType     ChatRevenueTransactionTypeEnum = "chatRevenueTransactionTypeRefund"
)

func unmarshalChatRevenueTransactionType(rawMsg *json.RawMessage) (ChatRevenueTransactionType, error) {
	...
	switch ChatRevenueTransactionTypeEnum(objMap["@type"].(string)) {
	case ChatRevenueTransactionTypeEarningsType:
		var chatRevenueTransactionTypeEarnings ChatRevenueTransactionTypeEarnings
		err := json.Unmarshal(*rawMsg, &chatRevenueTransactionTypeEarnings)
		return &chatRevenueTransactionTypeEarnings, err

	case ChatRevenueTransactionTypeWithdrawalType:
		var chatRevenueTransactionTypeWithdrawal ChatRevenueTransactionTypeWithdrawal
		err := json.Unmarshal(*rawMsg, &chatRevenueTransactionTypeWithdrawal)
		return &chatRevenueTransactionTypeWithdrawal, err

	case ChatRevenueTransactionTypeRefundType:
		var chatRevenueTransactionTypeRefund ChatRevenueTransactionTypeRefund
		err := json.Unmarshal(*rawMsg, &chatRevenueTransactionTypeRefund)
		return &chatRevenueTransactionTypeRefund, err
...
func unmarshalChatRevenueTransactionTypeSlice(rawMsg *json.RawMessage) ([]ChatRevenueTransactionType, error) {
	objects := make([]ChatRevenueTransactionType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case ChatRevenueTransactionTypeEarningsType:
			...
			err = json.Unmarshal(obj, &chatRevenueTransactionTypeEarnings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatRevenueTransactionTypeEarnings)
		case ChatRevenueTransactionTypeWithdrawalType:
			var chatRevenueTransactionTypeWithdrawal ChatRevenueTransactionTypeWithdrawal
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatRevenueTransactionTypeWithdrawal)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatRevenueTransactionTypeWithdrawal)
		case ChatRevenueTransactionTypeRefundType:
			var chatRevenueTransactionTypeRefund ChatRevenueTransactionTypeRefund
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &chatRevenueTransactionTypeRefund)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &chatRevenueTransactionTypeRefund)
...
type PhoneNumberCodeType interface {
	GetPhoneNumberCodeTypeEnum() PhoneNumberCodeTypeEnum
}

// PhoneNumberCodeTypeEnum Alias for abstract PhoneNumberCodeType 'Sub-Classes', used as constant-enum here
type PhoneNumberCodeTypeEnum string

// PhoneNumberCodeType enums
const (
	PhoneNumberCodeTypeChangeType           PhoneNumberCodeTypeEnum = "phoneNumberCodeTypeChange"
	PhoneNumberCodeTypeVerifyType           PhoneNumberCodeTypeEnum = "phoneNumberCodeTypeVerify"
	PhoneNumberCodeTypeConfirmOwnershipType PhoneNumberCodeTypeEnum = "phoneNumberCodeTypeConfirmOwnership"
)

func unmarshalPhoneNumberCodeType(rawMsg *json.RawMessage) (PhoneNumberCodeType, error) {
	...
	switch PhoneNumberCodeTypeEnum(objMap["@type"].(string)) {
	case PhoneNumberCodeTypeChangeType:
		var phoneNumberCodeTypeChange PhoneNumberCodeTypeChange
		err := json.Unmarshal(*rawMsg, &phoneNumberCodeTypeChange)
		return &phoneNumberCodeTypeChange, err

	case PhoneNumberCodeTypeVerifyType:
		var phoneNumberCodeTypeVerify PhoneNumberCodeTypeVerify
		err := json.Unmarshal(*rawMsg, &phoneNumberCodeTypeVerify)
		return &phoneNumberCodeTypeVerify, err

	case PhoneNumberCodeTypeConfirmOwnershipType:
		var phoneNumberCodeTypeConfirmOwnership PhoneNumberCodeTypeConfirmOwnership
		err := json.Unmarshal(*rawMsg, &phoneNumberCodeTypeConfirmOwnership)
		return &phoneNumberCodeTypeConfirmOwnership, err
...
func unmarshalPhoneNumberCodeTypeSlice(rawMsg *json.RawMessage) ([]PhoneNumberCodeType, error) {
	objects := make([]PhoneNumberCodeType, 0)
	if rawMsg == nil {
		return nil, nil
	}
	var objsMap []map[string]interface{}
	...
	for _, objMap := range objsMap {
		...
		case PhoneNumberCodeTypeChangeType:
			...
			err = json.Unmarshal(obj, &phoneNumberCodeTypeChange)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &phoneNumberCodeTypeChange)
		case PhoneNumberCodeTypeVerifyType:
			var phoneNumberCodeTypeVerify PhoneNumberCodeTypeVerify
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &phoneNumberCodeTypeVerify)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &phoneNumberCodeTypeVerify)
		case PhoneNumberCodeTypeConfirmOwnershipType:
			var phoneNumberCodeTypeConfirmOwnership PhoneNumberCodeTypeConfirmOwnership
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &phoneNumberCodeTypeConfirmOwnership)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &phoneNumberCodeTypeConfirmOwnership)
...
func unmarshalUpdate(rawMsg *json.RawMessage) (Update, error) {
	...
	case UpdateMessageUnreadReactionsType:
		var updateMessageUnreadReactions UpdateMessageUnreadReactions
		err := json.Unmarshal(*rawMsg, &updateMessageUnreadReactions)
		return &updateMessageUnreadReactions, err

	case UpdateMessageFactCheckType:
		var updateMessageFactCheck UpdateMessageFactCheck
		err := json.Unmarshal(*rawMsg, &updateMessageFactCheck)
		return &updateMessageFactCheck, err
	...
	case UpdateChatAccentColorsType:
		var updateChatAccentColors UpdateChatAccentColors
		err := json.Unmarshal(*rawMsg, &updateChatAccentColors)
		return &updateChatAccentColors, err
	...
	case UpdateChatAddedToListType:
		var updateChatAddedToList UpdateChatAddedToList
		err := json.Unmarshal(*rawMsg, &updateChatAddedToList)
		return &updateChatAddedToList, err

	case UpdateChatRemovedFromListType:
		var updateChatRemovedFromList UpdateChatRemovedFromList
		err := json.Unmarshal(*rawMsg, &updateChatRemovedFromList)
		return &updateChatRemovedFromList, err
	...
	case UpdateChatBusinessBotManageBarType:
		var updateChatBusinessBotManageBar UpdateChatBusinessBotManageBar
		err := json.Unmarshal(*rawMsg, &updateChatBusinessBotManageBar)
		return &updateChatBusinessBotManageBar, err

	case UpdateChatAvailableReactionsType:
		var updateChatAvailableReactions UpdateChatAvailableReactions
		err := json.Unmarshal(*rawMsg, &updateChatAvailableReactions)
		return &updateChatAvailableReactions, err
	...
	case UpdateChatEmojiStatusType:
		var updateChatEmojiStatus UpdateChatEmojiStatus
		err := json.Unmarshal(*rawMsg, &updateChatEmojiStatus)
		return &updateChatEmojiStatus, err
	...
	case UpdateChatMessageAutoDeleteTimeType:
		var updateChatMessageAutoDeleteTime UpdateChatMessageAutoDeleteTime
		err := json.Unmarshal(*rawMsg, &updateChatMessageAutoDeleteTime)
		return &updateChatMessageAutoDeleteTime, err
	...
	case UpdateChatBackgroundType:
		var updateChatBackground UpdateChatBackground
		err := json.Unmarshal(*rawMsg, &updateChatBackground)
		return &updateChatBackground, err
	...
	case UpdateChatUnreadReactionCountType:
		var updateChatUnreadReactionCount UpdateChatUnreadReactionCount
		err := json.Unmarshal(*rawMsg, &updateChatUnreadReactionCount)
		return &updateChatUnreadReactionCount, err
	...
	case UpdateChatIsTranslatableType:
		var updateChatIsTranslatable UpdateChatIsTranslatable
		err := json.Unmarshal(*rawMsg, &updateChatIsTranslatable)
		return &updateChatIsTranslatable, err
	...
	case UpdateChatViewAsTopicsType:
		var updateChatViewAsTopics UpdateChatViewAsTopics
		err := json.Unmarshal(*rawMsg, &updateChatViewAsTopics)
		return &updateChatViewAsTopics, err

	case UpdateChatBlockListType:
		var updateChatBlockList UpdateChatBlockList
		err := json.Unmarshal(*rawMsg, &updateChatBlockList)
		return &updateChatBlockList, err
	...
	case UpdateChatFoldersType:
		var updateChatFolders UpdateChatFolders
		err := json.Unmarshal(*rawMsg, &updateChatFolders)
		return &updateChatFolders, err
	...
	case UpdateSavedMessagesTopicType:
		var updateSavedMessagesTopic UpdateSavedMessagesTopic
		err := json.Unmarshal(*rawMsg, &updateSavedMessagesTopic)
		return &updateSavedMessagesTopic, err

	case UpdateSavedMessagesTopicCountType:
		var updateSavedMessagesTopicCount UpdateSavedMessagesTopicCount
		err := json.Unmarshal(*rawMsg, &updateSavedMessagesTopicCount)
		return &updateSavedMessagesTopicCount, err

	case UpdateQuickReplyShortcutType:
		var updateQuickReplyShortcut UpdateQuickReplyShortcut
		err := json.Unmarshal(*rawMsg, &updateQuickReplyShortcut)
		return &updateQuickReplyShortcut, err

	case UpdateQuickReplyShortcutDeletedType:
		var updateQuickReplyShortcutDeleted UpdateQuickReplyShortcutDeleted
		err := json.Unmarshal(*rawMsg, &updateQuickReplyShortcutDeleted)
		return &updateQuickReplyShortcutDeleted, err

	case UpdateQuickReplyShortcutsType:
		var updateQuickReplyShortcuts UpdateQuickReplyShortcuts
		err := json.Unmarshal(*rawMsg, &updateQuickReplyShortcuts)
		return &updateQuickReplyShortcuts, err

	case UpdateQuickReplyShortcutMessagesType:
		var updateQuickReplyShortcutMessages UpdateQuickReplyShortcutMessages
		err := json.Unmarshal(*rawMsg, &updateQuickReplyShortcutMessages)
		return &updateQuickReplyShortcutMessages, err

	case UpdateForumTopicInfoType:
		var updateForumTopicInfo UpdateForumTopicInfo
		err := json.Unmarshal(*rawMsg, &updateForumTopicInfo)
		return &updateForumTopicInfo, err
	...
	case UpdateReactionNotificationSettingsType:
		var updateReactionNotificationSettings UpdateReactionNotificationSettings
		err := json.Unmarshal(*rawMsg, &updateReactionNotificationSettings)
		return &updateReactionNotificationSettings, err
	...
	case UpdateFileDownloadsType:
		var updateFileDownloads UpdateFileDownloads
		err := json.Unmarshal(*rawMsg, &updateFileDownloads)
		return &updateFileDownloads, err

	case UpdateFileAddedToDownloadsType:
		var updateFileAddedToDownloads UpdateFileAddedToDownloads
		err := json.Unmarshal(*rawMsg, &updateFileAddedToDownloads)
		return &updateFileAddedToDownloads, err

	case UpdateFileDownloadType:
		var updateFileDownload UpdateFileDownload
		err := json.Unmarshal(*rawMsg, &updateFileDownload)
		return &updateFileDownload, err

	case UpdateFileRemovedFromDownloadsType:
		var updateFileRemovedFromDownloads UpdateFileRemovedFromDownloads
		err := json.Unmarshal(*rawMsg, &updateFileRemovedFromDownloads)
		return &updateFileRemovedFromDownloads, err

	case UpdateApplicationVerificationRequiredType:
		var updateApplicationVerificationRequired UpdateApplicationVerificationRequired
	...
	case UpdateStoryType:
		var updateStory UpdateStory
		err := json.Unmarshal(*rawMsg, &updateStory)
		return &updateStory, err

	case UpdateStoryDeletedType:
		var updateStoryDeleted UpdateStoryDeleted
		err := json.Unmarshal(*rawMsg, &updateStoryDeleted)
		return &updateStoryDeleted, err

	case UpdateStorySendSucceededType:
		var updateStorySendSucceeded UpdateStorySendSucceeded
		err := json.Unmarshal(*rawMsg, &updateStorySendSucceeded)
		return &updateStorySendSucceeded, err

	case UpdateStorySendFailedType:
		var updateStorySendFailed UpdateStorySendFailed
		err := json.Unmarshal(*rawMsg, &updateStorySendFailed)
		return &updateStorySendFailed, err

	case UpdateChatActiveStoriesType:
		var updateChatActiveStories UpdateChatActiveStories
		err := json.Unmarshal(*rawMsg, &updateChatActiveStories)
		return &updateChatActiveStories, err

	case UpdateStoryListChatCountType:
		var updateStoryListChatCount UpdateStoryListChatCount
		err := json.Unmarshal(*rawMsg, &updateStoryListChatCount)
		return &updateStoryListChatCount, err

	case UpdateStoryStealthModeType:
		var updateStoryStealthMode UpdateStoryStealthMode
		err := json.Unmarshal(*rawMsg, &updateStoryStealthMode)
		return &updateStoryStealthMode, err
	...
	case UpdateSavedNotificationSoundsType:
		var updateSavedNotificationSounds UpdateSavedNotificationSounds
		err := json.Unmarshal(*rawMsg, &updateSavedNotificationSounds)
		return &updateSavedNotificationSounds, err

	case UpdateDefaultBackgroundType:
		var updateDefaultBackground UpdateDefaultBackground
		err := json.Unmarshal(*rawMsg, &updateDefaultBackground)
		return &updateDefaultBackground, err
	...
	case UpdateAccentColorsType:
		var updateAccentColors UpdateAccentColors
		err := json.Unmarshal(*rawMsg, &updateAccentColors)
		return &updateAccentColors, err

	case UpdateProfileAccentColorsType:
		var updateProfileAccentColors UpdateProfileAccentColors
		err := json.Unmarshal(*rawMsg, &updateProfileAccentColors)
		return &updateProfileAccentColors, err
	...
	case UpdateUnconfirmedSessionType:
		...
		return &updateUnconfirmedSession, err

	case UpdateAttachmentMenuBotsType:
		var updateAttachmentMenuBots UpdateAttachmentMenuBots
		err := json.Unmarshal(*rawMsg, &updateAttachmentMenuBots)
		return &updateAttachmentMenuBots, err

	case UpdateWebAppMessageSentType:
		var updateWebAppMessageSent UpdateWebAppMessageSent
		err := json.Unmarshal(*rawMsg, &updateWebAppMessageSent)
		return &updateWebAppMessageSent, err

	case UpdateActiveEmojiReactionsType:
		var updateActiveEmojiReactions UpdateActiveEmojiReactions
		err := json.Unmarshal(*rawMsg, &updateActiveEmojiReactions)
		return &updateActiveEmojiReactions, err

	case UpdateAvailableMessageEffectsType:
		var updateAvailableMessageEffects UpdateAvailableMessageEffects
		err := json.Unmarshal(*rawMsg, &updateAvailableMessageEffects)
		return &updateAvailableMessageEffects, err
	...
	case UpdateSavedMessagesTagsType:
		...
		err := json.Unmarshal(*rawMsg, &updateSavedMessagesTags)
		return &updateSavedMessagesTags, err

	case UpdateActiveLiveLocationMessagesType:
		var updateActiveLiveLocationMessages UpdateActiveLiveLocationMessages
		err := json.Unmarshal(*rawMsg, &updateActiveLiveLocationMessages)
		return &updateActiveLiveLocationMessages, err

	case UpdateOwnedStarCountType:
		var updateOwnedStarCount UpdateOwnedStarCount
		err := json.Unmarshal(*rawMsg, &updateOwnedStarCount)
		return &updateOwnedStarCount, err

	case UpdateChatRevenueAmountType:
		var updateChatRevenueAmount UpdateChatRevenueAmount
		err := json.Unmarshal(*rawMsg, &updateChatRevenueAmount)
		return &updateChatRevenueAmount, err

	case UpdateStarRevenueStatusType:
		var updateStarRevenueStatus UpdateStarRevenueStatus
		err := json.Unmarshal(*rawMsg, &updateStarRevenueStatus)
		return &updateStarRevenueStatus, err

	case UpdateSpeechRecognitionTrialType:
		var updateSpeechRecognitionTrial UpdateSpeechRecognitionTrial
		err := json.Unmarshal(*rawMsg, &updateSpeechRecognitionTrial)
		return &updateSpeechRecognitionTrial, err
	...
	case UpdateSpeedLimitNotificationType:
		var updateSpeedLimitNotification UpdateSpeedLimitNotification
		err := json.Unmarshal(*rawMsg, &updateSpeedLimitNotification)
		return &updateSpeedLimitNotification, err

	case UpdateContactCloseBirthdaysType:
		var updateContactCloseBirthdays UpdateContactCloseBirthdays
		err := json.Unmarshal(*rawMsg, &updateContactCloseBirthdays)
		return &updateContactCloseBirthdays, err

	case UpdateAutosaveSettingsType:
		var updateAutosaveSettings UpdateAutosaveSettings
		err := json.Unmarshal(*rawMsg, &updateAutosaveSettings)
		return &updateAutosaveSettings, err

	case UpdateBusinessConnectionType:
		var updateBusinessConnection UpdateBusinessConnection
		err := json.Unmarshal(*rawMsg, &updateBusinessConnection)
		return &updateBusinessConnection, err

	case UpdateNewBusinessMessageType:
		var updateNewBusinessMessage UpdateNewBusinessMessage
		err := json.Unmarshal(*rawMsg, &updateNewBusinessMessage)
		return &updateNewBusinessMessage, err

	case UpdateBusinessMessageEditedType:
		var updateBusinessMessageEdited UpdateBusinessMessageEdited
		err := json.Unmarshal(*rawMsg, &updateBusinessMessageEdited)
		return &updateBusinessMessageEdited, err

	case UpdateBusinessMessagesDeletedType:
		var updateBusinessMessagesDeleted UpdateBusinessMessagesDeleted
		err := json.Unmarshal(*rawMsg, &updateBusinessMessagesDeleted)
		return &updateBusinessMessagesDeleted, err
	...
	case UpdateNewBusinessCallbackQueryType:
		var updateNewBusinessCallbackQuery UpdateNewBusinessCallbackQuery
		err := json.Unmarshal(*rawMsg, &updateNewBusinessCallbackQuery)
		return &updateNewBusinessCallbackQuery, err
	...
	case UpdateChatBoostType:
		var updateChatBoost UpdateChatBoost
		err := json.Unmarshal(*rawMsg, &updateChatBoost)
		return &updateChatBoost, err

	case UpdateMessageReactionType:
		var updateMessageReaction UpdateMessageReaction
		err := json.Unmarshal(*rawMsg, &updateMessageReaction)
		return &updateMessageReaction, err

	case UpdateMessageReactionsType:
		var updateMessageReactions UpdateMessageReactions
		err := json.Unmarshal(*rawMsg, &updateMessageReactions)
		return &updateMessageReactions, err

	case UpdatePaidMediaPurchasedType:
		var updatePaidMediaPurchased UpdatePaidMediaPurchased
		err := json.Unmarshal(*rawMsg, &updatePaidMediaPurchased)
		return &updatePaidMediaPurchased, err
...
func unmarshalUpdateSlice(rawMsg *json.RawMessage) ([]Update, error) {
	...
	for _, objMap := range objsMap {
		...
		case UpdateMessageUnreadReactionsType:
			...
			err = json.Unmarshal(obj, &updateMessageUnreadReactions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateMessageUnreadReactions)
		case UpdateMessageFactCheckType:
			var updateMessageFactCheck UpdateMessageFactCheck
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateMessageFactCheck)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateMessageFactCheck)
		case UpdateMessageLiveLocationViewedType:
			var updateMessageLiveLocationViewed UpdateMessageLiveLocationViewed
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatAccentColorsType:
			...
			err = json.Unmarshal(obj, &updateChatAccentColors)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatAccentColors)
		case UpdateChatPermissionsType:
			var updateChatPermissions UpdateChatPermissions
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatAddedToListType:
			...
			err = json.Unmarshal(obj, &updateChatAddedToList)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatAddedToList)
		case UpdateChatRemovedFromListType:
			var updateChatRemovedFromList UpdateChatRemovedFromList
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateChatRemovedFromList)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatRemovedFromList)
		case UpdateChatReadInboxType:
			var updateChatReadInbox UpdateChatReadInbox
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatBusinessBotManageBarType:
			...
			err = json.Unmarshal(obj, &updateChatBusinessBotManageBar)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatBusinessBotManageBar)
		case UpdateChatAvailableReactionsType:
			var updateChatAvailableReactions UpdateChatAvailableReactions
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateChatAvailableReactions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatAvailableReactions)
		case UpdateChatDraftMessageType:
			var updateChatDraftMessage UpdateChatDraftMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatEmojiStatusType:
			...
			err = json.Unmarshal(obj, &updateChatEmojiStatus)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatEmojiStatus)
		case UpdateChatMessageSenderType:
			var updateChatMessageSender UpdateChatMessageSender
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatMessageAutoDeleteTimeType:
			...
			err = json.Unmarshal(obj, &updateChatMessageAutoDeleteTime)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatMessageAutoDeleteTime)
		case UpdateChatNotificationSettingsType:
			var updateChatNotificationSettings UpdateChatNotificationSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatBackgroundType:
			...
			err = json.Unmarshal(obj, &updateChatBackground)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatBackground)
		case UpdateChatThemeType:
			var updateChatTheme UpdateChatTheme
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatUnreadReactionCountType:
			...
			err = json.Unmarshal(obj, &updateChatUnreadReactionCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatUnreadReactionCount)
		case UpdateChatVideoChatType:
			var updateChatVideoChat UpdateChatVideoChat
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatIsTranslatableType:
			...
			err = json.Unmarshal(obj, &updateChatIsTranslatable)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatIsTranslatable)
		case UpdateChatIsMarkedAsUnreadType:
			var updateChatIsMarkedAsUnread UpdateChatIsMarkedAsUnread
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatViewAsTopicsType:
			...
			err = json.Unmarshal(obj, &updateChatViewAsTopics)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatViewAsTopics)
		case UpdateChatBlockListType:
			var updateChatBlockList UpdateChatBlockList
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateChatBlockList)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatBlockList)
		case UpdateChatHasScheduledMessagesType:
			var updateChatHasScheduledMessages UpdateChatHasScheduledMessages
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatFoldersType:
			...
			err = json.Unmarshal(obj, &updateChatFolders)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatFolders)
		case UpdateChatOnlineMemberCountType:
			var updateChatOnlineMemberCount UpdateChatOnlineMemberCount
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateSavedMessagesTopicType:
			...
			err = json.Unmarshal(obj, &updateSavedMessagesTopic)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSavedMessagesTopic)
		case UpdateSavedMessagesTopicCountType:
			var updateSavedMessagesTopicCount UpdateSavedMessagesTopicCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateSavedMessagesTopicCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSavedMessagesTopicCount)
		case UpdateQuickReplyShortcutType:
			var updateQuickReplyShortcut UpdateQuickReplyShortcut
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateQuickReplyShortcut)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateQuickReplyShortcut)
		case UpdateQuickReplyShortcutDeletedType:
			var updateQuickReplyShortcutDeleted UpdateQuickReplyShortcutDeleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateQuickReplyShortcutDeleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateQuickReplyShortcutDeleted)
		case UpdateQuickReplyShortcutsType:
			var updateQuickReplyShortcuts UpdateQuickReplyShortcuts
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateQuickReplyShortcuts)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateQuickReplyShortcuts)
		case UpdateQuickReplyShortcutMessagesType:
			var updateQuickReplyShortcutMessages UpdateQuickReplyShortcutMessages
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateQuickReplyShortcutMessages)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateQuickReplyShortcutMessages)
		case UpdateForumTopicInfoType:
			var updateForumTopicInfo UpdateForumTopicInfo
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateForumTopicInfo)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateForumTopicInfo)
		case UpdateScopeNotificationSettingsType:
			var updateScopeNotificationSettings UpdateScopeNotificationSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateReactionNotificationSettingsType:
			...
			err = json.Unmarshal(obj, &updateReactionNotificationSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateReactionNotificationSettings)
		case UpdateNotificationType:
			var updateNotification UpdateNotification
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateFileDownloadsType:
			...
			err = json.Unmarshal(obj, &updateFileDownloads)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateFileDownloads)
		case UpdateFileAddedToDownloadsType:
			var updateFileAddedToDownloads UpdateFileAddedToDownloads
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateFileAddedToDownloads)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateFileAddedToDownloads)
		case UpdateFileDownloadType:
			var updateFileDownload UpdateFileDownload
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateFileDownload)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateFileDownload)
		case UpdateFileRemovedFromDownloadsType:
			var updateFileRemovedFromDownloads UpdateFileRemovedFromDownloads
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateFileRemovedFromDownloads)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateFileRemovedFromDownloads)
		case UpdateApplicationVerificationRequiredType:
			var updateApplicationVerificationRequired UpdateApplicationVerificationRequired
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateApplicationVerificationRequired)
			if err != nil {
				return nil, err
			}
		...
		case UpdateStoryType:
			...
			err = json.Unmarshal(obj, &updateStory)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStory)
		case UpdateStoryDeletedType:
			var updateStoryDeleted UpdateStoryDeleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStoryDeleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStoryDeleted)
		case UpdateStorySendSucceededType:
			var updateStorySendSucceeded UpdateStorySendSucceeded
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStorySendSucceeded)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStorySendSucceeded)
		case UpdateStorySendFailedType:
			var updateStorySendFailed UpdateStorySendFailed
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStorySendFailed)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStorySendFailed)
		case UpdateChatActiveStoriesType:
			var updateChatActiveStories UpdateChatActiveStories
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateChatActiveStories)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatActiveStories)
		case UpdateStoryListChatCountType:
			var updateStoryListChatCount UpdateStoryListChatCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStoryListChatCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStoryListChatCount)
		case UpdateStoryStealthModeType:
			var updateStoryStealthMode UpdateStoryStealthMode
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStoryStealthMode)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStoryStealthMode)
		case UpdateOptionType:
			var updateOption UpdateOption
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateSavedNotificationSoundsType:
			...
			err = json.Unmarshal(obj, &updateSavedNotificationSounds)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSavedNotificationSounds)
		case UpdateDefaultBackgroundType:
			var updateDefaultBackground UpdateDefaultBackground
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateDefaultBackground)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateDefaultBackground)
		case UpdateChatThemesType:
			var updateChatThemes UpdateChatThemes
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateAccentColorsType:
			...
			err = json.Unmarshal(obj, &updateAccentColors)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateAccentColors)
		case UpdateProfileAccentColorsType:
			var updateProfileAccentColors UpdateProfileAccentColors
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateProfileAccentColors)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateProfileAccentColors)
		case UpdateLanguagePackStringsType:
			var updateLanguagePackStrings UpdateLanguagePackStrings
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateUnconfirmedSessionType:
			...
			err = json.Unmarshal(obj, &updateUnconfirmedSession)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateUnconfirmedSession)
		case UpdateAttachmentMenuBotsType:
			var updateAttachmentMenuBots UpdateAttachmentMenuBots
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateAttachmentMenuBots)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateAttachmentMenuBots)
		case UpdateWebAppMessageSentType:
			var updateWebAppMessageSent UpdateWebAppMessageSent
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateWebAppMessageSent)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateWebAppMessageSent)
		case UpdateActiveEmojiReactionsType:
			var updateActiveEmojiReactions UpdateActiveEmojiReactions
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateActiveEmojiReactions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateActiveEmojiReactions)
		case UpdateAvailableMessageEffectsType:
			var updateAvailableMessageEffects UpdateAvailableMessageEffects
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateAvailableMessageEffects)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateAvailableMessageEffects)
		case UpdateDefaultReactionTypeType:
			var updateDefaultReactionType UpdateDefaultReactionType
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateDefaultReactionType)
			if err != nil {
				return nil, err
			}
		...
		case UpdateSavedMessagesTagsType:
			...
			err = json.Unmarshal(obj, &updateSavedMessagesTags)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSavedMessagesTags)
		case UpdateActiveLiveLocationMessagesType:
			var updateActiveLiveLocationMessages UpdateActiveLiveLocationMessages
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateActiveLiveLocationMessages)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateActiveLiveLocationMessages)
		case UpdateOwnedStarCountType:
			var updateOwnedStarCount UpdateOwnedStarCount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateOwnedStarCount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateOwnedStarCount)
		case UpdateChatRevenueAmountType:
			var updateChatRevenueAmount UpdateChatRevenueAmount
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateChatRevenueAmount)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatRevenueAmount)
		case UpdateStarRevenueStatusType:
			var updateStarRevenueStatus UpdateStarRevenueStatus
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateStarRevenueStatus)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateStarRevenueStatus)
		case UpdateSpeechRecognitionTrialType:
			var updateSpeechRecognitionTrial UpdateSpeechRecognitionTrial
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateSpeechRecognitionTrial)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSpeechRecognitionTrial)
		case UpdateDiceEmojisType:
			var updateDiceEmojis UpdateDiceEmojis
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateSpeedLimitNotificationType:
			...
			err = json.Unmarshal(obj, &updateSpeedLimitNotification)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateSpeedLimitNotification)
		case UpdateContactCloseBirthdaysType:
			var updateContactCloseBirthdays UpdateContactCloseBirthdays
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateContactCloseBirthdays)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateContactCloseBirthdays)
		case UpdateAutosaveSettingsType:
			var updateAutosaveSettings UpdateAutosaveSettings
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateAutosaveSettings)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateAutosaveSettings)
		case UpdateBusinessConnectionType:
			var updateBusinessConnection UpdateBusinessConnection
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateBusinessConnection)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateBusinessConnection)
		case UpdateNewBusinessMessageType:
			var updateNewBusinessMessage UpdateNewBusinessMessage
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateNewBusinessMessage)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateNewBusinessMessage)
		case UpdateBusinessMessageEditedType:
			var updateBusinessMessageEdited UpdateBusinessMessageEdited
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateBusinessMessageEdited)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateBusinessMessageEdited)
		case UpdateBusinessMessagesDeletedType:
			var updateBusinessMessagesDeleted UpdateBusinessMessagesDeleted
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateBusinessMessagesDeleted)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateBusinessMessagesDeleted)
		case UpdateNewInlineQueryType:
			var updateNewInlineQuery UpdateNewInlineQuery
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateNewBusinessCallbackQueryType:
			...
			err = json.Unmarshal(obj, &updateNewBusinessCallbackQuery)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateNewBusinessCallbackQuery)
		case UpdateNewShippingQueryType:
			var updateNewShippingQuery UpdateNewShippingQuery
			obj, err := json.Marshal(objMap)
			if err != nil {
		...
		case UpdateChatBoostType:
			...
			err = json.Unmarshal(obj, &updateChatBoost)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateChatBoost)
		case UpdateMessageReactionType:
			var updateMessageReaction UpdateMessageReaction
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateMessageReaction)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateMessageReaction)
		case UpdateMessageReactionsType:
			var updateMessageReactions UpdateMessageReactions
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updateMessageReactions)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updateMessageReactions)
		case UpdatePaidMediaPurchasedType:
			var updatePaidMediaPurchased UpdatePaidMediaPurchased
			obj, err := json.Marshal(objMap)
			if err != nil {
			...
			err = json.Unmarshal(obj, &updatePaidMediaPurchased)
			if err != nil {
				return nil, err
			}

			objects = append(objects, &updatePaidMediaPurchased)
