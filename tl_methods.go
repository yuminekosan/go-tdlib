...
type TDLibFunctions interface {
	...
	GetChatSimilarChatCount(chatID int64, returnLocal bool) (*Count, error)

	OpenChatSimilarChat(chatID int64, openedChatID int64) (*Ok, error)

	GetBotSimilarBots(botUserID int64) (*Users, error)

	GetBotSimilarBotCount(botUserID int64, returnLocal bool) (*Count, error)

	OpenBotSimilarBot(botUserID int64, openedBotUserID int64) (*Ok, error)

	GetTopChats(category TopChatCategory, limit int32) (*Chats, error)

	RemoveTopChat(category TopChatCategory, chatID int64) (*Ok, error)

	SearchRecentlyFoundChats(query string, limit int32) (*Chats, error)
	...
	SearchMessages(chatList ChatList, query string, offset string, limit int32, filter SearchMessagesFilter, chatTypeFilter SearchMessagesChatTypeFilter, minDate int32, maxDate int32) (*FoundMessages, error)
	...
	SearchPublicStoriesByTag(storySenderChatID int64, tag string, offset string, limit int32) (*FoundStories, error)
	...
	ClickChatSponsoredMessage(chatID int64, messageID int64, isMediaClick bool, fromFullscreen bool) (*Ok, error)
	...
	SendMessage(chatID int64, messageThreadID int64, replyTo InputMessageReplyTo, options *MessageSendOptions, replyMarkup ReplyMarkup, inputMessageContent InputMessageContent) (*Message, error)

	SendMessageAlbum(chatID int64, messageThreadID int64, replyTo InputMessageReplyTo, options *MessageSendOptions, inputMessageContents []InputMessageContent) (*Messages, error)

	SendBotStartMessage(botUserID int64, chatID int64, parameter string) (*Message, error)

	SendInlineQueryResultMessage(chatID int64, messageThreadID int64, replyTo InputMessageReplyTo, options *MessageSendOptions, queryID *JSONInt64, resultID string, hideViaBot bool) (*Message, error)
	...
	GetChatAvailablePaidMessageReactionSenders(chatID int64) (*MessageSenders, error)

	AddPendingPaidMessageReaction(chatID int64, messageID int64, starCount int64, typeParam PaidReactionType) (*Ok, error)
	...
	SetPaidMessageReactionType(chatID int64, messageID int64, typeParam PaidReactionType) (*Ok, error)
	...
	GetPollVoters(chatID int64, messageID int64, optionID int32, offset int32, limit int32) (*MessageSenders, error)
	...
	ShareUsersWithBot(chatID int64, messageID int64, buttonID int32, sharedUserIDs []int64, onlyCheck bool) (*Ok, error)
	...
	SavePreparedInlineMessage(userID int64, resultParam InputInlineQueryResult, chatTypes *TargetChatTypes) (*PreparedInlineMessageID, error)

	GetPreparedInlineMessage(botUserID int64, preparedMessageID string) (*PreparedInlineMessage, error)
	...
	GetWebAppPlaceholder(botUserID int64) (*Outline, error)

	GetWebAppLinkURL(chatID int64, botUserID int64, webAppShortName string, startParameter string, allowWriteAccess bool, parameters *WebAppOpenParameters) (*HttpURL, error)

	GetMainWebApp(chatID int64, botUserID int64, startParameter string, parameters *WebAppOpenParameters) (*MainWebApp, error)

	GetWebAppURL(botUserID int64, uRL string, parameters *WebAppOpenParameters) (*HttpURL, error)

	SendWebAppData(botUserID int64, buttonText string, data string) (*Ok, error)

	OpenWebApp(chatID int64, botUserID int64, uRL string, messageThreadID int64, replyTo InputMessageReplyTo, parameters *WebAppOpenParameters) (*WebAppInfo, error)
	...
	CheckWebAppFileDownload(botUserID int64, fileName string, uRL string) (*Ok, error)
	...
	GetChatFolder(chatFolderID int32) (*ChatFolder, error)

	CreateChatFolder(folder *ChatFolder) (*ChatFolderInfo, error)

	EditChatFolder(chatFolderID int32, folder *ChatFolder) (*ChatFolderInfo, error)

	DeleteChatFolder(chatFolderID int32, leaveChatIDs []int64) (*Ok, error)

	GetChatFolderChatsToLeave(chatFolderID int32) (*Chats, error)
	...
	GetChatFolderDefaultIconName(folder *ChatFolder) (*ChatFolderIcon, error)

	GetChatsForChatFolderInviteLink(chatFolderID int32) (*Chats, error)

	CreateChatFolderInviteLink(chatFolderID int32, name string, chatIDs []int64) (*ChatFolderInviteLink, error)

	GetChatFolderInviteLinks(chatFolderID int32) (*ChatFolderInviteLinks, error)

	EditChatFolderInviteLink(chatFolderID int32, inviteLink string, name string, chatIDs []int64) (*ChatFolderInviteLink, error)

	DeleteChatFolderInviteLink(chatFolderID int32, inviteLink string) (*Ok, error)

	CheckChatFolderInviteLink(inviteLink string) (*ChatFolderInviteLinkInfo, error)

	AddChatFolderByInviteLink(inviteLink string, chatIDs []int64) (*Ok, error)

	GetChatFolderNewChats(chatFolderID int32) (*Chats, error)

	ProcessChatFolderNewChats(chatFolderID int32, addedChatIDs []int64) (*Ok, error)

	GetArchiveChatListSettings() (*ArchiveChatListSettings, error)

	SetArchiveChatListSettings(settings *ArchiveChatListSettings) (*Ok, error)

	SetChatTitle(chatID int64, title string) (*Ok, error)

	SetChatPhoto(chatID int64, photo InputChatPhoto) (*Ok, error)

	SetChatAccentColor(chatID int64, accentColorID int32, backgroundCustomEmojiID *JSONInt64) (*Ok, error)

	SetChatProfileAccentColor(chatID int64, profileAccentColorID int32, profileBackgroundCustomEmojiID *JSONInt64) (*Ok, error)

	SetChatMessageAutoDeleteTime(chatID int64, messageAutoDeleteTime int32) (*Ok, error)

	SetChatEmojiStatus(chatID int64, emojiStatus *EmojiStatus) (*Ok, error)

	SetChatPermissions(chatID int64, permissions *ChatPermissions) (*Ok, error)

	SetChatBackground(chatID int64, background InputBackground, typeParam BackgroundType, darkThemeDimming int32, onlyForSelf bool) (*Ok, error)

	DeleteChatBackground(chatID int64, restorePrevious bool) (*Ok, error)
	...
	ToggleChatViewAsTopics(chatID int64, viewAsTopics bool) (*Ok, error)
	...
	GetStoryNotificationSettingsExceptions() (*Chats, error)

	LoadActiveStories(storyList StoryList) (*Ok, error)

	SetChatActiveStoriesList(chatID int64, storyList StoryList) (*Ok, error)
	...
	CloseStory(storySenderChatID int64, storyID int32) (*Ok, error)

	GetStoryAvailableReactions(rowSize int32) (*AvailableReactions, error)

	SetStoryReaction(storySenderChatID int64, storyID int32, reactionType ReactionType, updateRecentReactions bool) (*Ok, error)

	GetStoryInteractions(storyID int32, query string, onlyContacts bool, preferForwards bool, preferWithReaction bool, offset string, limit int32) (*StoryInteractions, error)

	GetChatStoryInteractions(storySenderChatID int64, storyID int32, reactionType ReactionType, preferForwards bool, offset string, limit int32) (*StoryInteractions, error)

	ReportStory(storySenderChatID int64, storyID int32, optionID []byte, text string) (ReportStoryResult, error)

	ActivateStoryStealthMode() (*Ok, error)
	...
	GetChatBoostStatus(chatID int64) (*ChatBoostStatus, error)

	BoostChat(chatID int64, slotIDs []int32) (*ChatBoostSlots, error)

	GetChatBoostLink(chatID int64) (*ChatBoostLink, error)

	GetChatBoostLinkInfo(uRL string) (*ChatBoostLinkInfo, error)

	GetChatBoosts(chatID int64, onlyGiftCodes bool, offset string, limit int32) (*FoundChatBoosts, error)

	GetUserChatBoosts(chatID int64, userID int64) (*FoundChatBoosts, error)
	...
	GetThemedEmojiStatuses() (*EmojiStatusCustomEmojis, error)

	GetRecentEmojiStatuses() (*EmojiStatuses, error)

	GetUpgradedGiftEmojiStatuses() (*EmojiStatuses, error)

	GetDefaultEmojiStatuses() (*EmojiStatusCustomEmojis, error)

	ClearRecentEmojiStatuses() (*Ok, error)

	GetThemedChatEmojiStatuses() (*EmojiStatusCustomEmojis, error)

	GetDefaultChatEmojiStatuses() (*EmojiStatusCustomEmojis, error)

	GetDisallowedChatEmojiStatuses() (*EmojiStatusCustomEmojis, error)
	...
	CreateCall(userID int64, protocol *CallProtocol, isVideo bool, groupCallID int32) (*CallID, error)
	...
	CreateGroupCall(callID int32) (*Ok, error)
	...
	SetMessageSenderBlockList(senderID MessageSender, blockList BlockList) (*Ok, error)

	BlockMessageSenderFromReplies(messageID int64, deleteMessage bool, deleteAllMessages bool, reportSpam bool) (*Ok, error)

	GetBlockedMessageSenders(blockList BlockList, offset int32, limit int32) (*MessageSenders, error)
	...
	SetCloseFriends(userIDs []int64) (*Ok, error)

	GetCloseFriends() (*Users, error)
	...
	ToggleBotCanManageEmojiStatus(botUserID int64, canManageEmojiStatus bool) (*Ok, error)

	SetUserEmojiStatus(userID int64, emojiStatus *EmojiStatus) (*Ok, error)
	...
	GetStickerOutline(stickerFileID int32, forAnimatedEmoji bool, forClickedAnimatedEmojiMessage bool) (*Outline, error)
	...
	SearchStickers(stickerType StickerType, emojis string, query string, inputLanguageCodes []string, offset int32, limit int32) (*Stickers, error)
	...
	SearchStickerSet(name string, ignoreCache bool) (*StickerSet, error)

	SearchInstalledStickerSets(stickerType StickerType, query string, limit int32) (*StickerSets, error)

	SearchStickerSets(stickerType StickerType, query string) (*StickerSets, error)
	...
	GetDefaultBackgroundCustomEmojiStickers() (*Stickers, error)
	...
	SetAccentColor(accentColorID int32, backgroundCustomEmojiID *JSONInt64) (*Ok, error)

	SetProfileAccentColor(profileAccentColorID int32, profileBackgroundCustomEmojiID *JSONInt64) (*Ok, error)
	...
	CanBotSendMessages(botUserID int64) (*Ok, error)
	...
	GetBotName(botUserID int64, languageCode string) (*Text, error)

	SetBotProfilePhoto(botUserID int64, photo InputChatPhoto) (*Ok, error)

	ToggleBotUsernameIsActive(botUserID int64, username string, isActive bool) (*Ok, error)

	ReorderBotActiveUsernames(botUserID int64, usernames []string) (*Ok, error)

	SetBotInfoDescription(botUserID int64, languageCode string, description string) (*Ok, error)

	GetBotInfoDescription(botUserID int64, languageCode string) (*Text, error)

	SetBotInfoShortDescription(botUserID int64, languageCode string, shortDescription string) (*Ok, error)

	GetBotInfoShortDescription(botUserID int64, languageCode string) (*Text, error)

	SetMessageSenderBotVerification(botUserID int64, verifiedID MessageSender, customDescription string) (*Ok, error)

	RemoveMessageSenderBotVerification(botUserID int64, verifiedID MessageSender) (*Ok, error)
	...
	ConfirmSession(sessionID *JSONInt64) (*Ok, error)
	...
	GetAvailableGifts() (*Gifts, error)

	SendGift(giftID *JSONInt64, ownerID MessageSender, text *FormattedText, isPrivate bool, payForUpgrade bool) (*Ok, error)

	SellGift(receivedGiftID string) (*Ok, error)

	ToggleGiftIsSaved(receivedGiftID string, isSaved bool) (*Ok, error)

	ToggleChatGiftNotifications(chatID int64, areEnabled bool) (*Ok, error)

	GetGiftUpgradePreview(giftID *JSONInt64) (*GiftUpgradePreview, error)

	UpgradeGift(receivedGiftID string, keepOriginalDetails bool, starCount int64) (*UpgradeGiftResult, error)

	TransferGift(receivedGiftID string, newOwnerID MessageSender, starCount int64) (*Ok, error)

	GetReceivedGifts(ownerID MessageSender, excludeUnsaved bool, excludeSaved bool, excludeUnlimited bool, excludeLimited bool, excludeUpgraded bool, sortByPrice bool, offset string, limit int32) (*ReceivedGifts, error)

	GetReceivedGift(receivedGiftID string) (*ReceivedGift, error)

	GetUpgradedGift(name string) (*UpgradedGift, error)

	GetUpgradedGiftWithdrawalURL(receivedGiftID string, password string) (*HttpURL, error)

	CreateInvoiceLink(businessConnectionID string, invoice InputMessageContent) (*HttpURL, error)
	...
	SetDefaultBackground(background InputBackground, typeParam BackgroundType, forDarkTheme bool) (*Background, error)

	DeleteDefaultBackground(forDarkTheme bool) (*Ok, error)

	GetInstalledBackgrounds(forDarkTheme bool) (*Backgrounds, error)

	RemoveInstalledBackground(backgroundID *JSONInt64) (*Ok, error)

	ResetInstalledBackgrounds() (*Ok, error)
	...
	ReportChat(chatID int64, optionID []byte, messageIDs []int64, text string) (ReportChatResult, error)
	...
	GetMessagePublicForwards(chatID int64, messageID int64, offset string, limit int32) (*PublicForwards, error)

	GetStoryStatistics(chatID int64, storyID int32, isDark bool) (*StoryStatistics, error)
	...
	GetPremiumInfoSticker(monthCount int32) (*Sticker, error)
	...
	GetPremiumGiftCodePaymentOptions(boostedChatID int64) (*PremiumGiftCodePaymentOptions, error)

	CheckPremiumGiftCode(code string) (*PremiumGiftCodeInfo, error)
	...
	EditUserStarSubscription(userID int64, telegramPaymentChargeID string, isCanceled bool) (*Ok, error)

	ReuseStarSubscription(subscriptionID string) (*Ok, error)

	SetChatAffiliateProgram(chatID int64, parameters *AffiliateProgramParameters) (*Ok, error)

	SearchChatAffiliateProgram(username string, referrer string) (*Chat, error)

	SearchAffiliatePrograms(affiliate AffiliateType, sortOrder AffiliateProgramSortOrder, offset string, limit int32) (*FoundAffiliatePrograms, error)

	ConnectAffiliateProgram(affiliate AffiliateType, botUserID int64) (*ConnectedAffiliateProgram, error)

	DisconnectAffiliateProgram(affiliate AffiliateType, uRL string) (*ConnectedAffiliateProgram, error)

	GetConnectedAffiliateProgram(affiliate AffiliateType, botUserID int64) (*ConnectedAffiliateProgram, error)

	GetConnectedAffiliatePrograms(affiliate AffiliateType, offset string, limit int32) (*ConnectedAffiliatePrograms, error)

	GetBusinessFeatures(source BusinessFeature) (*BusinessFeatures, error)

	AcceptTermsOfService(termsOfServiceID string) (*Ok, error)

	SearchStringsByPrefix(strings []string, query string, limit int32, returnNoneForEmptyQuery bool) (*FoundPositions, error)
...
// GetMessageLocally Returns information about a message, if it is available without sending network request. Returns a 404 error if message isn't available locally. This is an offline request
// @param chatID Identifier of the chat the message belongs to
// @param messageID Identifier of the message to get
...
func (client *ClientImpl) GetChatSimilarChatCount(chatID int64, returnLocal bool) (*Count, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetBotSimilarBots(botUserID int64) (*Users, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetBotSimilarBotCount(botUserID int64, returnLocal bool) (*Count, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) OpenBotSimilarBot(botUserID int64, openedBotUserID int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param query Query to search for
// @param limit The maximum number of chats to be returned
func (client *ClientImpl) SearchRecentlyFoundChats(query string, limit int32) (*Chats, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SearchMessages(chatList ChatList, query string, offset string, limit int32, filter SearchMessagesFilter, chatTypeFilter SearchMessagesChatTypeFilter, minDate int32, maxDate int32) (*FoundMessages, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":            "searchMessages",
		"chat_list":        chatList,
		"query":            query,
...
// @param storySenderChatID Identifier of the chat that posted the stories to search for; pass 0 to search stories in all chats
// @param tag Hashtag or cashtag to search for
// @param offset Offset of the first entry to return as received from the previous request; use empty string to get the first chunk of results
...
func (client *ClientImpl) SearchPublicStoriesByTag(storySenderChatID int64, tag string, offset string, limit int32) (*FoundStories, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ClickChatSponsoredMessage(chatID int64, messageID int64, isMediaClick bool, fromFullscreen bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SendMessage(chatID int64, messageThreadID int64, replyTo InputMessageReplyTo, options *MessageSendOptions, replyMarkup ReplyMarkup, inputMessageContent InputMessageContent) (*Message, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                 "sendMessage",
		"chat_id":               chatID,
		"message_thread_id":     messageThreadID,
...
func (client *ClientImpl) SendInlineQueryResultMessage(chatID int64, messageThreadID int64, replyTo InputMessageReplyTo, options *MessageSendOptions, queryID *JSONInt64, resultID string, hideViaBot bool) (*Message, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param options Options to be used to send the messages; pass null to use default options
// @param sendCopy Pass true to copy content of the messages without reference to the original sender. Always true if the messages are forwarded to a secret chat or are local. Use messageProperties.can_be_saved and messageProperties.can_be_copied_to_secret_chat to check whether the message is suitable
// @param removeCaption Pass true to remove media captions of message copies. Ignored if send_copy is false
func (client *ClientImpl) ForwardMessages(chatID int64, messageThreadID int64, fromChatID int64, messageIDs []int64, options *MessageSendOptions, sendCopy bool, removeCaption bool) (*Messages, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ResendMessages(chatID int64, messageIDs []int64, quote *InputTextQuote) (*Messages, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":       "resendMessages",
		"chat_id":     chatID,
		"message_ids": messageIDs,
...
func (client *ClientImpl) AddLocalMessage(chatID int64, senderID MessageSender, replyTo InputMessageReplyTo, disableNotification bool, inputMessageContent InputMessageContent) (*Message, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// EditMessageMedia Edits the media content of a message, including message caption. If only the caption needs to be edited, use editMessageCaption instead. The type of message content in an album can't be changed with exception of replacing a photo with a video or vice versa. Returns the edited message after the edit is completed on the server side
// @param chatID The chat the message belongs to
...
// @param chatID Chat identifier
func (client *ClientImpl) GetChatAvailablePaidMessageReactionSenders(chatID int64) (*MessageSenders, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param typeParam Type of the paid reaction; pass null if the user didn't choose reaction type explicitly, for example, the reaction is set from the message bubble
func (client *ClientImpl) AddPendingPaidMessageReaction(chatID int64, messageID int64, starCount int64, typeParam PaidReactionType) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param chatID Identifier of the chat to which the message belongs
// @param messageID Identifier of the message
// @param typeParam New type of the paid reaction
func (client *ClientImpl) SetPaidMessageReactionType(chatID int64, messageID int64, typeParam PaidReactionType) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetMessageReactions(chatID int64, messageID int64, reactionTypes []ReactionType, isBig bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SearchQuote(text *FormattedText, quote *FormattedText, quotePosition int32) (*FoundPosition, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":          "searchQuote",
		"text":           text,
		"quote":          quote,
	...
	var foundPosition FoundPosition
	err = json.Unmarshal(result.Raw, &foundPosition)
	return &foundPosition, err
...
func (client *ClientImpl) GetPollVoters(chatID int64, messageID int64, optionID int32, offset int32, limit int32) (*MessageSenders, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":      "getPollVoters",
		"chat_id":    chatID,
		"message_id": messageID,
...
func (client *ClientImpl) ShareUsersWithBot(chatID int64, messageID int64, buttonID int32, sharedUserIDs []int64, onlyCheck bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param resultParam The description of the message
// @param chatTypes Types of the chats to which the message can be sent
func (client *ClientImpl) SavePreparedInlineMessage(userID int64, resultParam InputInlineQueryResult, chatTypes *TargetChatTypes) (*PreparedInlineMessageID, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var preparedInlineMessageID PreparedInlineMessageID
	err = json.Unmarshal(result.Raw, &preparedInlineMessageID)
	return &preparedInlineMessageID, err
...
func (client *ClientImpl) GetPreparedInlineMessage(botUserID int64, preparedMessageID string) (*PreparedInlineMessage, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	err = json.Unmarshal(result.Raw, &preparedInlineMessage)
...
// GetWebAppPlaceholder Returns a default placeholder for Web Apps of a bot; this is an offline request. Returns a 404 error if the placeholder isn't known
// @param botUserID Identifier of the target bot
func (client *ClientImpl) GetWebAppPlaceholder(botUserID int64) (*Outline, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var outline Outline
	err = json.Unmarshal(result.Raw, &outline)
	return &outline, err
...
func (client *ClientImpl) GetWebAppLinkURL(chatID int64, botUserID int64, webAppShortName string, startParameter string, allowWriteAccess bool, parameters *WebAppOpenParameters) (*HttpURL, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param parameters Parameters to use to open the Web App
func (client *ClientImpl) GetMainWebApp(chatID int64, botUserID int64, startParameter string, parameters *WebAppOpenParameters) (*MainWebApp, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":           "getMainWebApp",
		"chat_id":         chatID,
		"bot_user_id":     botUserID,
...
// @param parameters Parameters to use to open the Web App
func (client *ClientImpl) GetWebAppURL(botUserID int64, uRL string, parameters *WebAppOpenParameters) (*HttpURL, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":       "getWebAppUrl",
		"bot_user_id": botUserID,
		"url":         uRL,
...
// @param parameters Parameters to use to open the Web App
func (client *ClientImpl) OpenWebApp(chatID int64, botUserID int64, uRL string, messageThreadID int64, replyTo InputMessageReplyTo, parameters *WebAppOpenParameters) (*WebAppInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":             "openWebApp",
		"chat_id":           chatID,
		"bot_user_id":       botUserID,
...
func (client *ClientImpl) CheckWebAppFileDownload(botUserID int64, fileName string, uRL string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetInternalLinkType(link string) (InternalLinkType, error) {
	...
	case InternalLinkTypeChatAffiliateProgramType:
		var internalLinkType InternalLinkTypeChatAffiliateProgram
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err

	case InternalLinkTypeChatBoostType:
		var internalLinkType InternalLinkTypeChatBoost
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err

	case InternalLinkTypeChatFolderInviteType:
		var internalLinkType InternalLinkTypeChatFolderInvite
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err

	case InternalLinkTypeChatFolderSettingsType:
		var internalLinkType InternalLinkTypeChatFolderSettings
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err
	...
	case InternalLinkTypePremiumGiftType:
		var internalLinkType InternalLinkTypePremiumGift
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err

	case InternalLinkTypePremiumGiftCodeType:
		var internalLinkType InternalLinkTypePremiumGiftCode
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err
	...
	case InternalLinkTypeStoryType:
		var internalLinkType InternalLinkTypeStory
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err
	...
	case InternalLinkTypeUpgradedGiftType:
		var internalLinkType InternalLinkTypeUpgradedGift
		err = json.Unmarshal(result.Raw, &internalLinkType)
		return &internalLinkType, err
...
func (client *ClientImpl) GetChatFolder(chatFolderID int32) (*ChatFolder, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":          "getChatFolder",
	...
	var chatFolderDummy ChatFolder
	err = json.Unmarshal(result.Raw, &chatFolderDummy)
	return &chatFolderDummy, err
...
func (client *ClientImpl) CreateChatFolder(folder *ChatFolder) (*ChatFolderInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatFolderInfo ChatFolderInfo
	err = json.Unmarshal(result.Raw, &chatFolderInfo)
	return &chatFolderInfo, err
...
func (client *ClientImpl) EditChatFolder(chatFolderID int32, folder *ChatFolder) (*ChatFolderInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":          "editChatFolder",
		"chat_folder_id": chatFolderID,
		"folder":         folder,
...
func (client *ClientImpl) DeleteChatFolder(chatFolderID int32, leaveChatIDs []int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param chatFolderID Chat folder identifier
func (client *ClientImpl) GetChatFolderChatsToLeave(chatFolderID int32) (*Chats, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param folder The new chat folder
func (client *ClientImpl) GetChatFolderChatCount(folder *ChatFolder) (*Count, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ReorderChatFolders(chatFolderIDs []int32, mainChatListPosition int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetRecommendedChatFolders() (*RecommendedChatFolders, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var recommendedChatFolders RecommendedChatFolders
	err = json.Unmarshal(result.Raw, &recommendedChatFolders)
	return &recommendedChatFolders, err

}

// GetChatFolderDefaultIconName Returns default icon name for a folder. Can be called synchronously
// @param folder Chat folder
func (client *ClientImpl) GetChatFolderDefaultIconName(folder *ChatFolder) (*ChatFolderIcon, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	err = json.Unmarshal(result.Raw, &chatFolderIcon)
	return &chatFolderIcon, err
...
// @param chatFolderID Chat folder identifier
func (client *ClientImpl) GetChatsForChatFolderInviteLink(chatFolderID int32) (*Chats, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) CreateChatFolderInviteLink(chatFolderID int32, name string, chatIDs []int64) (*ChatFolderInviteLink, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatFolderInviteLink ChatFolderInviteLink
	err = json.Unmarshal(result.Raw, &chatFolderInviteLink)
	return &chatFolderInviteLink, err

}

// GetChatFolderInviteLinks Returns invite links created by the current user for a shareable chat folder
// @param chatFolderID Chat folder identifier
func (client *ClientImpl) GetChatFolderInviteLinks(chatFolderID int32) (*ChatFolderInviteLinks, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatFolderInviteLinks ChatFolderInviteLinks
	err = json.Unmarshal(result.Raw, &chatFolderInviteLinks)
	return &chatFolderInviteLinks, err
...
func (client *ClientImpl) EditChatFolderInviteLink(chatFolderID int32, inviteLink string, name string, chatIDs []int64) (*ChatFolderInviteLink, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) DeleteChatFolderInviteLink(chatFolderID int32, inviteLink string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) CheckChatFolderInviteLink(inviteLink string) (*ChatFolderInviteLinkInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatFolderInviteLinkInfo ChatFolderInviteLinkInfo
	err = json.Unmarshal(result.Raw, &chatFolderInviteLinkInfo)
	return &chatFolderInviteLinkInfo, err
...
func (client *ClientImpl) AddChatFolderByInviteLink(inviteLink string, chatIDs []int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param chatFolderID Chat folder identifier
func (client *ClientImpl) GetChatFolderNewChats(chatFolderID int32) (*Chats, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ProcessChatFolderNewChats(chatFolderID int32, addedChatIDs []int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetArchiveChatListSettings() (*ArchiveChatListSettings, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var archiveChatListSettings ArchiveChatListSettings
	err = json.Unmarshal(result.Raw, &archiveChatListSettings)
	return &archiveChatListSettings, err

}

// SetArchiveChatListSettings Changes settings for automatic moving of chats to and from the Archive chat lists
// @param settings New settings
func (client *ClientImpl) SetArchiveChatListSettings(settings *ArchiveChatListSettings) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetChatEmojiStatus(chatID int64, emojiStatus *EmojiStatus) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetChatBackground(chatID int64, background InputBackground, typeParam BackgroundType, darkThemeDimming int32, onlyForSelf bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) DeleteChatBackground(chatID int64, restorePrevious bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ReadChatList(chatList ChatList) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":     "readChatList",
		"chat_list": chatList,
	})
...
func (client *ClientImpl) GetStory(storySenderChatID int64, storyID int32, onlyLocal bool) (*Story, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "getStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
	...
	var storyDummy Story
	err = json.Unmarshal(result.Raw, &storyDummy)
	return &storyDummy, err
...
func (client *ClientImpl) CanSendStory(chatID int64) (CanSendStoryResult, error) {
	...
	switch CanSendStoryResultEnum(result.Data["@type"].(string)) {

	case CanSendStoryResultOkType:
		var canSendStoryResult CanSendStoryResultOk
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err

	case CanSendStoryResultPremiumNeededType:
		var canSendStoryResult CanSendStoryResultPremiumNeeded
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err

	case CanSendStoryResultBoostNeededType:
		var canSendStoryResult CanSendStoryResultBoostNeeded
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err

	case CanSendStoryResultActiveStoryLimitExceededType:
		var canSendStoryResult CanSendStoryResultActiveStoryLimitExceeded
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err

	case CanSendStoryResultWeeklyLimitExceededType:
		var canSendStoryResult CanSendStoryResultWeeklyLimitExceeded
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err

	case CanSendStoryResultMonthlyLimitExceededType:
		var canSendStoryResult CanSendStoryResultMonthlyLimitExceeded
		err = json.Unmarshal(result.Raw, &canSendStoryResult)
		return &canSendStoryResult, err
...
func (client *ClientImpl) EditStory(storySenderChatID int64, storyID int32, content InputStoryContent, areas *InputStoryAreas, caption *FormattedText) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "editStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
...
func (client *ClientImpl) DeleteStory(storySenderChatID int64, storyID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "deleteStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
...
func (client *ClientImpl) LoadActiveStories(storyList StoryList) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetChatActiveStoriesList(chatID int64, storyList StoryList) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param chatID Chat identifier
func (client *ClientImpl) GetChatActiveStories(chatID int64) (*ChatActiveStories, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatActiveStories ChatActiveStories
	err = json.Unmarshal(result.Raw, &chatActiveStories)
	return &chatActiveStories, err
...
// @param limit The maximum number of stories to be returned. For optimal performance, the number of returned stories is chosen by TDLib and can be smaller than the specified limit
func (client *ClientImpl) GetChatArchivedStories(chatID int64, fromStoryID int32, limit int32) (*Stories, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) OpenStory(storySenderChatID int64, storyID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "openStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
...
// @param storyID The identifier of the story
func (client *ClientImpl) CloseStory(storySenderChatID int64, storyID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "closeStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
...
// @param rowSize Number of reaction per row, 5-25
func (client *ClientImpl) GetStoryAvailableReactions(rowSize int32) (*AvailableReactions, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetStoryInteractions(storyID int32, query string, onlyContacts bool, preferForwards bool, preferWithReaction bool, offset string, limit int32) (*StoryInteractions, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var storyInteractions StoryInteractions
	err = json.Unmarshal(result.Raw, &storyInteractions)
	return &storyInteractions, err
...
// @param offset Offset of the first entry to return as received from the previous request; use empty string to get the first chunk of results
// @param limit The maximum number of story interactions to return
func (client *ClientImpl) GetChatStoryInteractions(storySenderChatID int64, storyID int32, reactionType ReactionType, preferForwards bool, offset string, limit int32) (*StoryInteractions, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ReportStory(storySenderChatID int64, storyID int32, optionID []byte, text string) (ReportStoryResult, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "reportStory",
		"story_sender_chat_id": storySenderChatID,
		"story_id":             storyID,
	...
	switch ReportStoryResultEnum(result.Data["@type"].(string)) {

	case ReportStoryResultOkType:
		var reportStoryResult ReportStoryResultOk
		err = json.Unmarshal(result.Raw, &reportStoryResult)
		return &reportStoryResult, err

	case ReportStoryResultOptionRequiredType:
		var reportStoryResult ReportStoryResultOptionRequired
		err = json.Unmarshal(result.Raw, &reportStoryResult)
		return &reportStoryResult, err

	case ReportStoryResultTextRequiredType:
		var reportStoryResult ReportStoryResultTextRequired
		err = json.Unmarshal(result.Raw, &reportStoryResult)
		return &reportStoryResult, err
...
func (client *ClientImpl) ActivateStoryStealthMode() (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// GetStoryPublicForwards Returns forwards of a story as a message to public chats and reposts by public channels. Can be used only if the story is posted on behalf of the current user or story.can_get_statistics == true. For optimal performance, the number of returned messages and stories is chosen by TDLib
// @param storySenderChatID The identifier of the sender of the story
// @param storyID The identifier of the story
// @param offset Offset of the first entry to return as received from the previous request; use empty string to get the first chunk of results
...
func (client *ClientImpl) GetStoryPublicForwards(storySenderChatID int64, storyID int32, offset string, limit int32) (*PublicForwards, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var publicForwards PublicForwards
	err = json.Unmarshal(result.Raw, &publicForwards)
	return &publicForwards, err
...
func (client *ClientImpl) GetChatBoostLevelFeatures(isChannel bool, level int32) (*ChatBoostLevelFeatures, error) {
	...
	var chatBoostLevelFeatures ChatBoostLevelFeatures
	err = json.Unmarshal(result.Raw, &chatBoostLevelFeatures)
	return &chatBoostLevelFeatures, err
...
func (client *ClientImpl) GetChatBoostFeatures(isChannel bool) (*ChatBoostFeatures, error) {
	...
	var chatBoostFeatures ChatBoostFeatures
	err = json.Unmarshal(result.Raw, &chatBoostFeatures)
	return &chatBoostFeatures, err

}

// GetAvailableChatBoostSlots Returns the list of available chat boost slots for the current user
func (client *ClientImpl) GetAvailableChatBoostSlots() (*ChatBoostSlots, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatBoostSlots ChatBoostSlots
	err = json.Unmarshal(result.Raw, &chatBoostSlots)
	return &chatBoostSlots, err
...
func (client *ClientImpl) GetChatBoostStatus(chatID int64) (*ChatBoostStatus, error) {
	...
	var chatBoostStatus ChatBoostStatus
	err = json.Unmarshal(result.Raw, &chatBoostStatus)
	return &chatBoostStatus, err
...
func (client *ClientImpl) BoostChat(chatID int64, slotIDs []int32) (*ChatBoostSlots, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":    "boostChat",
		"chat_id":  chatID,
		"slot_ids": slotIDs,
...
func (client *ClientImpl) GetChatBoostLink(chatID int64) (*ChatBoostLink, error) {
	...
	var chatBoostLink ChatBoostLink
	err = json.Unmarshal(result.Raw, &chatBoostLink)
	return &chatBoostLink, err
...
func (client *ClientImpl) GetChatBoostLinkInfo(uRL string) (*ChatBoostLinkInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var chatBoostLinkInfo ChatBoostLinkInfo
	err = json.Unmarshal(result.Raw, &chatBoostLinkInfo)
	return &chatBoostLinkInfo, err
...
func (client *ClientImpl) GetChatBoosts(chatID int64, onlyGiftCodes bool, offset string, limit int32) (*FoundChatBoosts, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":           "getChatBoosts",
		"chat_id":         chatID,
	...
	var foundChatBoosts FoundChatBoosts
	err = json.Unmarshal(result.Raw, &foundChatBoosts)
	return &foundChatBoosts, err
...
func (client *ClientImpl) GetThemedEmojiStatuses() (*EmojiStatusCustomEmojis, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var emojiStatusCustomEmojis EmojiStatusCustomEmojis
	err = json.Unmarshal(result.Raw, &emojiStatusCustomEmojis)
	return &emojiStatusCustomEmojis, err
...
func (client *ClientImpl) GetUpgradedGiftEmojiStatuses() (*EmojiStatuses, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetDefaultEmojiStatuses() (*EmojiStatusCustomEmojis, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetThemedChatEmojiStatuses() (*EmojiStatusCustomEmojis, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetDefaultChatEmojiStatuses() (*EmojiStatusCustomEmojis, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// GetDisallowedChatEmojiStatuses Returns the list of emoji statuses, which can't be used as chat emoji status, even they are from a sticker set with is_allowed_as_chat_emoji_status == true
func (client *ClientImpl) GetDisallowedChatEmojiStatuses() (*EmojiStatusCustomEmojis, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// SetApplicationVerificationToken Application or reCAPTCHA verification has been completed. Can be called before authorization
...
func (client *ClientImpl) CreateCall(userID int64, protocol *CallProtocol, isVideo bool, groupCallID int32) (*CallID, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":         "createCall",
		"user_id":       userID,
		"protocol":      protocol,
...
// CreateGroupCall Creates a group call from a one-to-one call
// @param callID Call identifier
func (client *ClientImpl) CreateGroupCall(callID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// GetVideoChatRtmpURL Returns RTMP URL for streaming to the chat; requires can_manage_video_chats administrator right
// @param chatID Chat identifier
...
// ToggleGroupCallEnabledStartNotification Toggles whether the current user will receive a notification when the group call starts; scheduled group calls only
// @param groupCallID Group call identifier
...
func (client *ClientImpl) SetMessageSenderBlockList(senderID MessageSender, blockList BlockList) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetBlockedMessageSenders(blockList BlockList, offset int32, limit int32) (*MessageSenders, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetCloseFriends(userIDs []int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetCloseFriends() (*Users, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ToggleBotCanManageEmojiStatus(botUserID int64, canManageEmojiStatus bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetUserEmojiStatus(userID int64, emojiStatus *EmojiStatus) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// GetStickerOutline Returns outline of a sticker; this is an offline request. Returns a 404 error if the outline isn't known
...
func (client *ClientImpl) GetStickerOutline(stickerFileID int32, forAnimatedEmoji bool, forClickedAnimatedEmojiMessage bool) (*Outline, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetAllStickerEmojis(stickerType StickerType, query string, chatID int64, returnOnlyMainEmoji bool) (*Emojis, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SearchStickers(stickerType StickerType, emojis string, query string, inputLanguageCodes []string, offset int32, limit int32) (*Stickers, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                "searchStickers",
		"sticker_type":         stickerType,
		"emojis":               emojis,
...
func (client *ClientImpl) SearchStickerSet(name string, ignoreCache bool) (*StickerSet, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param stickerType Type of the sticker sets to return
// @param query Query to search for
func (client *ClientImpl) SearchStickerSets(stickerType StickerType, query string) (*StickerSets, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetDefaultBackgroundCustomEmojiStickers() (*Stickers, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetOwnedBots() (*Users, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type": "getOwnedBots",
	})
...
func (client *ClientImpl) SetAccentColor(accentColorID int32, backgroundCustomEmojiID *JSONInt64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                      "setAccentColor",
		"accent_color_id":            accentColorID,
		"background_custom_emoji_id": backgroundCustomEmojiID,
...
func (client *ClientImpl) SetProfileAccentColor(profileAccentColorID int32, profileBackgroundCustomEmojiID *JSONInt64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param botUserID Identifier of the target bot
func (client *ClientImpl) CanBotSendMessages(botUserID int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param botUserID Identifier of the target bot
func (client *ClientImpl) AllowBotToSendMessages(botUserID int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SendWebAppCustomRequest(botUserID int64, method string, parameters string) (*CustomRequestResult, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetBotName(botUserID int64, languageCode string, name string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":         "setBotName",
		"bot_user_id":   botUserID,
		"language_code": languageCode,
...
// @param botUserID Identifier of the target bot
// @param languageCode A two-letter ISO 639-1 language code or an empty string
func (client *ClientImpl) GetBotName(botUserID int64, languageCode string) (*Text, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":         "getBotName",
		"bot_user_id":   botUserID,
		"language_code": languageCode,
...
func (client *ClientImpl) SetBotProfilePhoto(botUserID int64, photo InputChatPhoto) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param username The username to change
// @param isActive Pass true to activate the username; pass false to disable it
func (client *ClientImpl) ToggleBotUsernameIsActive(botUserID int64, username string, isActive bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param botUserID Identifier of the target bot
// @param usernames The new order of active usernames. All currently active usernames must be specified
func (client *ClientImpl) ReorderBotActiveUsernames(botUserID int64, usernames []string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetBotInfoDescription(botUserID int64, languageCode string, description string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param botUserID Identifier of the target bot
// @param languageCode A two-letter ISO 639-1 language code or an empty string
func (client *ClientImpl) GetBotInfoDescription(botUserID int64, languageCode string) (*Text, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetBotInfoShortDescription(botUserID int64, languageCode string, shortDescription string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param botUserID Identifier of the target bot
// @param languageCode A two-letter ISO 639-1 language code or an empty string
func (client *ClientImpl) GetBotInfoShortDescription(botUserID int64, languageCode string) (*Text, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetMessageSenderBotVerification(botUserID int64, verifiedID MessageSender, customDescription string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) RemoveMessageSenderBotVerification(botUserID int64, verifiedID MessageSender) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param sessionID Session identifier
func (client *ClientImpl) ConfirmSession(sessionID *JSONInt64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":      "confirmSession",
		"session_id": sessionID,
	})
...
func (client *ClientImpl) GetAvailableGifts() (*Gifts, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var gifts Gifts
	err = json.Unmarshal(result.Raw, &gifts)
	return &gifts, err
...
func (client *ClientImpl) SendGift(giftID *JSONInt64, ownerID MessageSender, text *FormattedText, isPrivate bool, payForUpgrade bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":           "sendGift",
		"gift_id":         giftID,
		"owner_id":        ownerID,
...
func (client *ClientImpl) SellGift(receivedGiftID string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":            "sellGift",
...
// ToggleGiftIsSaved Toggles whether a gift is shown on the current user's or the channel's profile page; requires can_post_messages administrator right in the chat
// @param receivedGiftID Identifier of the gift
...
func (client *ClientImpl) ToggleGiftIsSaved(receivedGiftID string, isSaved bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ToggleChatGiftNotifications(chatID int64, areEnabled bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetGiftUpgradePreview(giftID *JSONInt64) (*GiftUpgradePreview, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var giftUpgradePreview GiftUpgradePreview
	err = json.Unmarshal(result.Raw, &giftUpgradePreview)
	return &giftUpgradePreview, err
...
// @param starCount The amount of Telegram Stars required to pay for the upgrade. It the gift has prepaid_upgrade_star_count > 0, then pass 0, otherwise, pass gift.upgrade_star_count
func (client *ClientImpl) UpgradeGift(receivedGiftID string, keepOriginalDetails bool, starCount int64) (*UpgradeGiftResult, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":                 "upgradeGift",
		"received_gift_id":      receivedGiftID,
	...
	var upgradeGiftResult UpgradeGiftResult
	err = json.Unmarshal(result.Raw, &upgradeGiftResult)
	return &upgradeGiftResult, err

}

// TransferGift Sends an upgraded gift to another user or a channel chat
// @param receivedGiftID Identifier of the gift
...
func (client *ClientImpl) TransferGift(receivedGiftID string, newOwnerID MessageSender, starCount int64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":            "transferGift",
		"received_gift_id": receivedGiftID,
...
func (client *ClientImpl) GetReceivedGifts(ownerID MessageSender, excludeUnsaved bool, excludeSaved bool, excludeUnlimited bool, excludeLimited bool, excludeUpgraded bool, sortByPrice bool, offset string, limit int32) (*ReceivedGifts, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var receivedGifts ReceivedGifts
	err = json.Unmarshal(result.Raw, &receivedGifts)
	return &receivedGifts, err

}

// GetReceivedGift Returns information about a received gift
// @param receivedGiftID Identifier of the gift
func (client *ClientImpl) GetReceivedGift(receivedGiftID string) (*ReceivedGift, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var receivedGiftDummy ReceivedGift
	err = json.Unmarshal(result.Raw, &receivedGiftDummy)
	return &receivedGiftDummy, err

}

// GetUpgradedGift Returns information about an upgraded gift by its name
// @param name Unique name of the upgraded gift
func (client *ClientImpl) GetUpgradedGift(name string) (*UpgradedGift, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var upgradedGift UpgradedGift
	err = json.Unmarshal(result.Raw, &upgradedGift)
	return &upgradedGift, err
...
// @param receivedGiftID Identifier of the gift
// @param password The 2-step verification password of the current user
func (client *ClientImpl) GetUpgradedGiftWithdrawalURL(receivedGiftID string, password string) (*HttpURL, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) CreateInvoiceLink(businessConnectionID string, invoice InputMessageContent) (*HttpURL, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param typeParam Background type; backgroundTypeChatTheme isn't supported
...
// @param typeParam Background type; pass null to use the default type of the remote background; backgroundTypeChatTheme isn't supported
// @param forDarkTheme Pass true if the background is set for a dark theme
func (client *ClientImpl) SetDefaultBackground(background InputBackground, typeParam BackgroundType, forDarkTheme bool) (*Background, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) DeleteDefaultBackground(forDarkTheme bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetInstalledBackgrounds(forDarkTheme bool) (*Backgrounds, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) RemoveInstalledBackground(backgroundID *JSONInt64) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ResetInstalledBackgrounds() (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) ReportChat(chatID int64, optionID []byte, messageIDs []int64, text string) (ReportChatResult, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":       "reportChat",
		"chat_id":     chatID,
		"option_id":   optionID,
	...
	switch ReportChatResultEnum(result.Data["@type"].(string)) {

	case ReportChatResultOkType:
		var reportChatResult ReportChatResultOk
		err = json.Unmarshal(result.Raw, &reportChatResult)
		return &reportChatResult, err

	case ReportChatResultOptionRequiredType:
		var reportChatResult ReportChatResultOptionRequired
		err = json.Unmarshal(result.Raw, &reportChatResult)
		return &reportChatResult, err

	case ReportChatResultTextRequiredType:
		var reportChatResult ReportChatResultTextRequired
		err = json.Unmarshal(result.Raw, &reportChatResult)
		return &reportChatResult, err

	case ReportChatResultMessagesRequiredType:
		var reportChatResult ReportChatResultMessagesRequired
		err = json.Unmarshal(result.Raw, &reportChatResult)
		return &reportChatResult, err
...
func (client *ClientImpl) ReportChatPhoto(chatID int64, fileID int32, reason ReportReason, text string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// GetChatRevenueStatistics Returns detailed revenue statistics about a chat. Currently, this method can be used only for channels if supergroupFullInfo.can_get_revenue_statistics == true or bots if userFullInfo.bot_info.can_get_revenue_statistics == true
// @param chatID Chat identifier
...
// GetChatRevenueTransactions Returns the list of revenue transactions for a chat. Currently, this method can be used only for channels if supergroupFullInfo.can_get_revenue_statistics == true or bots if userFullInfo.bot_info.can_get_revenue_statistics == true
// @param chatID Chat identifier
...
// @param offset Offset of the first entry to return as received from the previous request; use empty string to get the first chunk of results
// @param limit The maximum number of messages and stories to be returned; must be positive and can't be greater than 100. For optimal performance, the number of returned objects is chosen by TDLib and can be smaller than the specified limit
func (client *ClientImpl) GetMessagePublicForwards(chatID int64, messageID int64, offset string, limit int32) (*PublicForwards, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param storyID Story identifier
// @param isDark Pass true if a dark theme is used by the application
func (client *ClientImpl) GetStoryStatistics(chatID int64, storyID int32, isDark bool) (*StoryStatistics, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var storyStatistics StoryStatistics
	err = json.Unmarshal(result.Raw, &storyStatistics)
	return &storyStatistics, err
...
func (client *ClientImpl) GetPremiumInfoSticker(monthCount int32) (*Sticker, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetPremiumGiftCodePaymentOptions(boostedChatID int64) (*PremiumGiftCodePaymentOptions, error) {
	...
	var premiumGiftCodePaymentOptions PremiumGiftCodePaymentOptions
	err = json.Unmarshal(result.Raw, &premiumGiftCodePaymentOptions)
	return &premiumGiftCodePaymentOptions, err

}

// CheckPremiumGiftCode Return information about a Telegram Premium gift code
// @param code The code to check
func (client *ClientImpl) CheckPremiumGiftCode(code string) (*PremiumGiftCodeInfo, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var premiumGiftCodeInfo PremiumGiftCodeInfo
	err = json.Unmarshal(result.Raw, &premiumGiftCodeInfo)
	return &premiumGiftCodeInfo, err

}

// ApplyPremiumGiftCode Applies a Telegram Premium gift code
// @param code The code to apply
func (client *ClientImpl) ApplyPremiumGiftCode(code string) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) EditUserStarSubscription(userID int64, telegramPaymentChargeID string, isCanceled bool) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SetChatAffiliateProgram(chatID int64, parameters *AffiliateProgramParameters) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SearchChatAffiliateProgram(username string, referrer string) (*Chat, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) SearchAffiliatePrograms(affiliate AffiliateType, sortOrder AffiliateProgramSortOrder, offset string, limit int32) (*FoundAffiliatePrograms, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var foundAffiliatePrograms FoundAffiliatePrograms
	err = json.Unmarshal(result.Raw, &foundAffiliatePrograms)
	return &foundAffiliatePrograms, err
...
func (client *ClientImpl) ConnectAffiliateProgram(affiliate AffiliateType, botUserID int64) (*ConnectedAffiliateProgram, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var connectedAffiliateProgram ConnectedAffiliateProgram
	err = json.Unmarshal(result.Raw, &connectedAffiliateProgram)
	return &connectedAffiliateProgram, err
...
func (client *ClientImpl) DisconnectAffiliateProgram(affiliate AffiliateType, uRL string) (*ConnectedAffiliateProgram, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *ClientImpl) GetConnectedAffiliateProgram(affiliate AffiliateType, botUserID int64) (*ConnectedAffiliateProgram, error) {
	result, err := client.SendAndCatch(UpdateData{
...
// @param offset Offset of the first affiliate program to return as received from the previous request; use empty string to get the first chunk of results
// @param limit The maximum number of affiliate programs to return
func (client *ClientImpl) GetConnectedAffiliatePrograms(affiliate AffiliateType, offset string, limit int32) (*ConnectedAffiliatePrograms, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	var connectedAffiliatePrograms ConnectedAffiliatePrograms
	err = json.Unmarshal(result.Raw, &connectedAffiliatePrograms)
	return &connectedAffiliatePrograms, err
...
func (client *ClientImpl) SearchStringsByPrefix(strings []string, query string, limit int32, returnNoneForEmptyQuery bool) (*FoundPositions, error) {
	result, err := client.SendAndCatch(UpdateData{
	...
	err = json.Unmarshal(result.Raw, &foundPositions)
	return &foundPositions, err
...
func (client *ClientImpl) TestUseUpdate() (Update, error) {
	...
	case UpdateVideoPublishedType:
		var update UpdateVideoPublished
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateChatAccentColorsType:
		var update UpdateChatAccentColors
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateChatEmojiStatusType:
		var update UpdateChatEmojiStatus
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateChatBackgroundType:
		var update UpdateChatBackground
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateChatViewAsTopicsType:
		var update UpdateChatViewAsTopics
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateChatBlockListType:
		var update UpdateChatBlockList
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateApplicationRecaptchaVerificationRequiredType:
		var update UpdateApplicationRecaptchaVerificationRequired
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateStoryType:
		var update UpdateStory
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateStoryDeletedType:
		var update UpdateStoryDeleted
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateStorySendSucceededType:
		var update UpdateStorySendSucceeded
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateStorySendFailedType:
		var update UpdateStorySendFailed
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateChatActiveStoriesType:
		var update UpdateChatActiveStories
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateStoryListChatCountType:
		var update UpdateStoryListChatCount
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateStoryStealthModeType:
		var update UpdateStoryStealthMode
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateDefaultBackgroundType:
		var update UpdateDefaultBackground
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateAccentColorsType:
		var update UpdateAccentColors
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateProfileAccentColorsType:
		var update UpdateProfileAccentColors
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateUnconfirmedSessionType:
		var update UpdateUnconfirmedSession
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateDefaultPaidReactionTypeType:
		var update UpdateDefaultPaidReactionType
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateSpeechRecognitionTrialType:
		var update UpdateSpeechRecognitionTrial
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
	...
	case UpdateChatBoostType:
		var update UpdateChatBoost
		err = json.Unmarshal(result.Raw, &update)
		return &update, err

	case UpdateMessageReactionType:
		var update UpdateMessageReaction
		err = json.Unmarshal(result.Raw, &update)
		return &update, err
